...
<br>
      ...
      <td  align="left" valign="top" class="ewTableHeader">FINGER PRINT</td>
			<td  align="left" valign="top" class="ewTableHeader">CABANG</td>
			<td  align="left" valign="top" class="ewTableHeader">DEPARTEMEN</td>
			<td  align="left" valign="top" class="ewTableHeader">JABATAN</td><tr>
		      <?PHP if ($jum <= 0) { ?>
			<tr><td colspan="9" bgcolor="pink" align="center">Data Tidak Ditemukan... </td></tr>
				<? } else ?>
...
function doPaging(hal)
{
    ...
    frm.action='list_surat_peringatan.php?q='+kode_cabang_encoded;
    frm.submit();
}
