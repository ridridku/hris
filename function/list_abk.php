...
<form action="list_abk.php" method="POST" name="frm" >
...
<a href="#" OnClick="JavaScript:Ajax('ajax_input','kasus_abk/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
function GetPengaduan(kode_wni,nama,alamat,tlp,alamat_ln,tlp_ln) {
	 ...
	 window.opener.document.getElementById('alamat_ln').value=alamat_ln;
	 window.opener.document.getElementById('tlp_ln').value=tlp_ln;
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_abk.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_abk.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_abk.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_abk.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_abk.php?get_jenis_sektor=1&no_prop='+prop_id);
