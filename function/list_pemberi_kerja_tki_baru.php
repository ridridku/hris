...
// END TAMBAHAN UNTUK AJAX WNI */
 ...
 tbl_wni left  join  tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_wni.kode_perwakilan
 ...
 left  join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten = tbl_wni.id_kabupaten where tbl_wni.kode_perwakilan='$kode_perwakilan' and (kode_sumber=3 or kode_sumber=4)";
...
<div id="ajax_input"> 
<form action="list_pemberi_kerja_tki_baru.php" method="POST" name="frm">
...
<a href="#" OnClick="JavaScript:Ajax('ajax_input','pemberi_kerja_tki/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
function doPaging(hal) {
  frm.action="list_pemberi_kerja_tki_baru.php";
  frm.submit();
}
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_pemberi_kerja_tki_baru.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_pemberi_kerja_tki_baru.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_pemberi_kerja_tki_baru.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_pemberi_kerja_tki_baru.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_pemberi_kerja_tki_baru.php?get_jenis_sektor=1&no_prop='+prop_id);
