...
<FORM NAME="frmCreate" METHOD="POST" ACTION="adopsi/engine.php">
		<TABLE id="table-add-box">
				...
				<TR>
					...
					<TD><div id="ajax_cek_id"><INPUT TYPE="text" NAME="kode_wni" size="35" OnChange="JavaScript:Ajax('ajax_cek_id','adopsi/cek.php?kode_wni='+frmCreate.kode_wni.value+'&id='+frmCreate.id.value)"> 					
					</div>
			...
			<TR>
				...
				<TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_adopsi.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
