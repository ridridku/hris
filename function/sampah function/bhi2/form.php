...
<FORM NAME="frmCreate" METHOD="POST" ACTION="bhi2/engine.php">
             ...
             <TR>
				...
				<TR>
				 ...
				 <TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_bhi.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
