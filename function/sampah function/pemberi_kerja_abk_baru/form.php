...
<FORM NAME="frmCreate" METHOD="POST" ACTION="pemberi_kerja_abk_baru/engine.php">
		<TABLE id="table-add-box">
			...
			<TR>
				...
				<TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_pemberi_kerja_abk_baru.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
