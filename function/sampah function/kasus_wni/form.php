...
<FORM NAME="frmCreate" METHOD="POST" ACTION="kasus_wni/engine.php">
		<TABLE id="table-add-box">
				...
				<TR>
					...
					<TD><div id="ajax_cek_id"><INPUT TYPE="text" NAME="kode_wni" size="35" OnChange="JavaScript:Ajax('ajax_cek_id','kasus_wni/cek.php?kode_wni='+frmCreate.kode_wni.value+'&id='+frmCreate.id.value)"> 					
					</div>
			...
			<TR>
					...
					<TD>   
					 ...
					 <select name="kode_jenis" > 
						<option value="">[Pilih Jenis WNI]</option> 
									...
									while(!$rs_kec->EOF):   ?>
									     <option value="<?=$rs_kec->fields['kode_jenis_wni'];?>"><?=$rs_kec->fields['nama_jenis_wni'];?></option> 
									 <? 
									$rs_kec->MoveNext();
									endwhile;
									?>
				...
				<TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_wni2.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
				 
					<TR><td  colspan="2"> <font color="#ff0000"> Keterangan * Wajib Diisi</font></td>
					 <input type="hidden" name="kode_klasifikasi_wni" value="1"> 
					</tr>
			</TABLE>
