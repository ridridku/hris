...
<FORM NAME="frmCreate" METHOD="POST" ACTION="kasus_tki/engine.php">
		<TABLE id="table-add-box">
			...
			<TR>
				...
				<TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_tki.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
