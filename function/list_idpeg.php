...
<form action="list_idpeg.php" method="POST" name="frm">
				...
				<? for ($i=0;$i<count($list_arr_satuan);$i++) { 
				   $j = $i+1;	
				   	$nama=str_replace("'","",$list_arr_satuan[$i]['r_pegawai__nama']);
                                        ...
                                        $idpeg=str_replace("'","",$list_arr_satuan[$i]['r_pnpt__id_pegawai']); 
				?>
				
				<tr align="center" 
                                    onclick="GetPengaduan('<?=$list_arr_satuan[$i]['r_pegawai__nama'];?>',
                                                '<?=$list_arr_satuan[$i]['r_pnpt__nip'];?>','<?=$list_arr_satuan[$i]['r_jabatan__ket'];?>','<?=$idpeg;?>');"  
...
<script>
function GetPengaduan(r_pegawai__nama,r_pnpt__nip,r_jabatan__ket,idpeg) {
         ...
         window.opener.document.getElementById('r_jabatan__ket').value=r_jabatan__ket;
          window.opener.document.getElementById('idpeg').value=idpeg;
