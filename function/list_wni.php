...
<img src="icon_find.gif" border="0">&nbsp;cari
 ...
 <a href="#" OnClick="JavaScript:Ajax('ajax_input','wni_relaas/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
<br>
		...
		<td align="center">
			...
			<tr> 
			<td  align="left" valign="top" class="ewTableHeader">NAMA PEGAWAI</td>
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_wni.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_wni.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni.php?get_jenis_sektor=1&no_prop='+prop_id);
