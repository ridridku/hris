...
<img src="icon_find.gif" border="0">&nbsp;cari
 ...
 <a href="#" OnClick="JavaScript:Ajax('ajax_input','bhi/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
function GetPengaduan(kode_wni,nama, pemilik,alamat, nama_bh) {
    ...
    window.opener.document.getElementById('kode_wni').value=kode_wni;
	    window.opener.document.getElementById('nama').value=nama;
		    window.opener.document.getElementById('pemilik').value=pemilik;
			   window.opener.document.getElementById('alamat_ln_bh').value=alamat;
			    window.opener.document.getElementById('nama_bh').value=nama_bh;
