...
<form action="list_surat_cuti2.php" method="POST" name="frm">
...
<script>
function GetPengaduan(r_pegawai__nama,no_mutasi) {
         
         window.opener.document.getElementById('atasan_nama').value=r_pegawai__nama;
         window.opener.document.getElementById('mutasi_atasan').value=no_mutasi;
         window.close();
...
function doPaging(hal) {
  frm.action="list_surat_cuti2.php";
  frm.submit();
}
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_surat_cuti2.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_surat_cuti2.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_surat_cuti2.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_surat_cuti2.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_surat_cuti2.php?get_jenis_sektor=1&no_prop='+prop_id);
