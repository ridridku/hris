...
$sql="SELECT
  ...
  A.r_pnpt__shift,
  B.r_pegawai__nama,
  B.r_pegawai__nama_jalan,
  B.r_pegawai__tlp_kantor,
 cabang,B.r_pegawai__jk,
		...
		<td align="center">
			...
			<td  align="left" valign="top" class="ewTableHeader">TELEPON</td>
		      ...
		      <?PHP if ($jum <= 0) { ?>
				...
				<tr align="center" 
                                    onclick="GetPengaduan('<?=$list_arr_satuan[$i]['r_pegawai__nama'];?>','<?=$list_arr_satuan[$i]['r_pnpt__nip'];?>','<?=$list_arr_satuan[$i]['cabang'];?>');"  
