...
$sql="select count(kode_kasus) as jml_kasus , nama_kasus from v_kasus_rekap inner join tbl_wni on v_kasus_rekap.kode_wni = tbl_wni.kode_wni   where v_kasus_rekap.kode_perwakilan='$kode_perwakilan' ";
...
<tr><td colspan="5" align="center" class="judul"><strong>DAFTAR KASUS PERWAKILAN <?=$nm_perwakilan?> </strong></td></tr>
