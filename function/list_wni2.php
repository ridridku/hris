...
$sql="select * , nm_perwakilan , nama_jenis_wni as nama_jenis ,tbl_wni.nama as nama  , tbl_wni.alamat as alamat_ind , tbl_wni.tlp as tlp from
 ...
 left  join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten = tbl_wni.id_kabupaten where tbl_wni.kode_perwakilan='$kode_perwakilan' and kode_sumber=1 ";
...
<img src="icon_find.gif" border="0">&nbsp;cari
 ...
 <a href="#" OnClick="JavaScript:Ajax('ajax_input','kasus_wni/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni2.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_wni2.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_wni2.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni2.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_wni2.php?get_jenis_sektor=1&no_prop='+prop_id);
