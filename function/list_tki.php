...
<a href="#" OnClick="JavaScript:Ajax('ajax_input','kasus_tki/form.php?kode_perwakilan=<?=$kode_perwakilan?>')">
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_tki.php?get_prop=1&no_prop='+prop_id);
...
if (prop_id != '') {
	http.open('get', 'list_tki.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id);
...
//alert(prop_id+'  -- '+kab_id);
if (prop_id != '') {
	http.open('get', 'list_tki.php?get_kec=1&no_prop='+prop_id+'&no_kab='+kab_id+'&no_kec='+kec_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_tki.php?get_jenis=1&no_prop='+prop_id);
...
//alert(prop_id);
if (prop_id != '') {
	http.open('get', 'list_tki.php?get_jenis_sektor=1&no_prop='+prop_id);
