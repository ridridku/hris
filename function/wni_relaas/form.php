...
<FORM NAME="frmCreate" METHOD="POST" ACTION="wni_relaas/engine.php">
		<TABLE id="table-add-box">
			...
			<TR>
				...
				<TR><td height="40"></td>
					...
					<input type="button" value="BATAL" name="BATAL" onclick="window.location='list_wni.php?kode_perwakilan=<?=$kode_perwakilan?>';"> 
					</TD>
				</TR>
