...
left  join   tbl_mast_negara  on tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara where kode_kawasan='$kode_kawasan'  ";
...
$sql_pw="select upper(nama_kawasan) as nama_kawasan  from tbl_mast_kawasan where kode_kawasan='$kode_kawasan'";
...
<tr><td colspan="5" align="center" class="judul"><strong>DAFTAR KASUS KAWASAN <?=$nama_kawasan?> </strong></td></tr>
