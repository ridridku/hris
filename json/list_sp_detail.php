...
// END TAMBAHAN UNTUK AJAX WNI */
                                ...
                                $sql="SELECT 
                                            ...
                                            FROM
                                              ...
                                              AND r_cabang__id= '$kode_cabang_cari'";
		      ...
		      <?PHP if ($jum <= 0) { ?>
				   ...
				   $j = $i+1;	
				   	$nama=str_replace("'","",$list_arr_satuan[$i]['r_pegawai__nama']);
                                        ...
                                        $t_sp__jenis=str_replace("'","",$list_arr_satuan[$i]['t_sp__jenis']);
                                         $t_sp__no=str_replace("'","",$list_arr_satuan[$i]['t_sp__no']);
				...
				<tr align="center" 
                                    onclick="GetPengaduan('<?=$list_arr_satuan[$i]['r_pegawai__nama'];?>',
                                                '<?=$list_arr_satuan[$i]['r_pnpt__nip'];?>','<?=$list_arr_satuan[$i]['t_sp__no'];?>');"  
...
<script>
function GetPengaduan(r_pegawai__nama,r_pnpt__nip,t_sp__no) {
         ...
         window.opener.document.getElementById('t_sp__no').value=t_sp__no;
         window.close();
