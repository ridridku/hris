...
if($kunci2=='tmw2016')
{
    ...
    $sql="SELECT  * from  r_resign A  where A.r_resign__date_updated>= '".$periode2."'";;
...
while($arr=$rs2->FetchRow()){
	...
	$arrTmp["r_resign__regretted"]=$arr["r_resign__regretted"];
	$arrTmp["r_resign__date_created"]=$arr["r_resign__date_created"];
	$arrTmp["r_resign__date_updated"]=$arr["r_resign__date_updated"];
	$arrTmp["r_resign__user_created"]=$arr["r_resign__user_created"];
	$arrTmp["r_resign__user_updated"]=$arr["r_resign__user_updated"];
				$hasil[$i]=$arrTmp;
				$i++;
}
