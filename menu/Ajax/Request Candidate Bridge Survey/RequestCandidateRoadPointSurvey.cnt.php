 ...
 * @package Content
 */
class RequestCandidateRoadPointSurveyContent extends ContentInterface
{
  public function RequestCandidateRoadPointSurveyContent(){
  ...
  public function Show(ValidatorInterface $v){
	...
	while($R = $db->FetchObject($rsl)){
		...
		$m = new RequestCandidateBridgePointSurveyMenu();
		$m->IdPoint = $R->id;
