 ...
 * @package Content
 */
class RequestCandidateBridgeProvinceSurveyContent extends ContentInterface
{
  public function RequestCandidateBridgeProvinceSurveyContent(){
  ...
  public function Show(ValidatorInterface $v){
	...
	while($R = $db->FetchObject($rsl)){
		...
		$m = new RequestCandidateRoadPointSurveyMenu();
		$m->IdPropinsi = $R->id;
