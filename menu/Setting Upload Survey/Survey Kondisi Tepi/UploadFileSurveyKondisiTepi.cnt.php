 ...
 * @package Content
 */
class UploadFileSurveyKondisiTepiContent extends ContentInterface
{
  public function UploadFileSurveyKondisiTepiContent(){
  ...
  public function Show(ValidatorInterface $v){
	...
	$r = $Gui->MakeSubTitle();
	$r->TextToDisplay = 'Upload Excell Kondisi Tepi Jalan';
	$f->AddRowElement($r);
	...
	$f->Action = new UploadFileSurveyKondisiTepiHandlerMenu();
