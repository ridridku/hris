...
require_once Framework::ThisFolder(__FILE__) . 'SearchMasterSatuanKerja.rmd.php';

class SearchMasterSatuanKerjaContent extends CommonGridContent{
	public function SearchMasterSatuanKerjaContent(){
		CommonGridContent::CommonGridContent();
	}
	public function MakeRowModifier(){return new SearchMasterSatuanKerjaRowModifier();}
