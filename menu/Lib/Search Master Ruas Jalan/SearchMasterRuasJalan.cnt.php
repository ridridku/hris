...
require_once Framework::ThisFolder(__FILE__) . 'SearchMasterRuasJalan.rmd.php';

class SearchMasterRuasJalanContent extends CommonGridContent{

	public function SearchMasterRuasJalanContent(){
		CommonGridContent::CommonGridContent();
	}

	public function MakeRowModifier(){return new SearchMasterRuasJalanRowModifier();}
