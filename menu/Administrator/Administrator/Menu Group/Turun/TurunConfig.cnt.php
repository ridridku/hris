...
class TurunConfigContent extends ContentInterface
{
  public function TurunConfigContent(){
  ...
  public function Show(ValidatorInterface $v){
	...
	$CekIndex ="
	   ...
	   WHERE 
			...
			sys_menu_group.id__sys_parent = '".$Par->ParentId."' AND
	...
	$Indeks_ke ="
		SELECT 
			   ...
			   WHERE 
					...
					sys_menu_group.id__sys_group = '".$Par->IdGroup."' 
	";
	$rsl = $Conn->Execute($Indeks_ke);
	$Indeks = $Conn->FetchObject($rsl);	
	if(($Indeks->OrderIndex < $Rec->Jumlah) && ($Indeks->OrderIndex != NULL)){
