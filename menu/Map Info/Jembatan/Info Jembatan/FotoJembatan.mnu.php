<?
class FotoJembatanMenu extends MenuInterface{
	public $Rect = array();
	public $FileName = NULL;
	public $ImgId = NULL;
  	public function FotoJembatanMenu(){MenuInterface::MenuInterface();} 
  	...
  	public function OnSetKey($key = array()){
		if(
			$key['svy_drp_image.id_mst_bridge'] != NULL && 
			...
			$this->FileName =  
				UPLOAD_DIR . 'Jembatan/' .
				$key['svy_drp_image.id_mst_bridge'] .'-'. 
