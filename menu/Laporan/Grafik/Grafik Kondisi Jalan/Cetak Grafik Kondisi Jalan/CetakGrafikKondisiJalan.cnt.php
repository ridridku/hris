...
class CetakGrafikKondisiJalanContent extends ContentInterface
{
  public function CetakGrafikKondisiJalanContent(){
  ...
  public function Show(ValidatorInterface $v){
	...
	$m  = new CetakGrafikKondisiJalanHandlerMenu();
	$m->IdPropinsi = $p->IdPropinsi;
	$m->IdRuasJalan = $p->IdRuasJalan;
	$m->Waktu =  $p->Waktu;
	
	
	$m->Next = new CetakGrafikKondisiJalanMenu();
