...
<table  border=0 cellspacing=5 cellpadding=0 align="center" style="background-color:#FFFFFF;border:3px solid balck;" width="95%">
 ...
 <tr>
    <td ><table width="70%" border=0 cellspacing=5 cellpadding=0 style="border:3px solid black;">
      <tr>
...
<input type="button" name="t3d" value="Print" onClick="
	var elm = document.getElementById('control_1');
	var parenElm = elm.parentNode;
	parenElm.removeChild(elm);
	var elm = document.getElementById('control_2');
	var parenElm = elm.parentNode;
	parenElm.removeChild(elm);
	HideThis(this);
