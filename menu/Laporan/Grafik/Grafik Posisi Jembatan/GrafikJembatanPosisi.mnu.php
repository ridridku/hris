...
class GrafikJembatanPosisiMenu extends CommonGridMenu{
	public $IdPropinsi = NULL;
	public $IdRuasJalan = NULL;
	public $Time =  NULL;
	public $Cetak = NULL;
	public function GrafikJembatanPosisiMenu(){CommonGridMenu::CommonGridMenu();}
  	public function Name(){return 'Grafik Posisi Jembatan';}
