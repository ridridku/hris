...
class LaporanDataPerkerasanJalanMenu extends CommonGridMenu{
	public $IdPropinsi = NULL;
	public $IdRuasJalan =  NULL;
	public $Time = NULL;
	public $Post = NULL;
	public $OffSet = NULL;
	public function LaporanDataPerkerasanJalanMenu(){CommonGridMenu::CommonGridMenu();}
  	public function Name(){return 'Perkerasan';}
