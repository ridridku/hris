...
class GridDataSurveyVideoJalanMenu extends CommonGridMenu{
	public $IdPropinsi = NULL;
	public $IdRuasJalan =  NULL;
	public $Time = NULL;
	public $Post = NULL;
	public $OffSet = NULL;
	public function GridDataSurveyVideoJalanMenu(){CommonGridMenu::CommonGridMenu();}
  	public function Name(){return 'Video';}
