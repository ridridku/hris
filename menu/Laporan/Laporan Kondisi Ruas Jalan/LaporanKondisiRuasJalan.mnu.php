...
class LaporanKondisiRuasJalanMenu extends CommonGridMenu{
	public $IdPropinsi = NULL;
	public $IdRuasJalan =  NULL;
	public $Time = NULL;
	public $Post = NULL;
	public $OffSet = NULL;
	public function LaporanKondisiRuasJalanMenu(){CommonGridMenu::CommonGridMenu();}
  	public function Name(){return 'Kondisi Ruas Jalan';}
