...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->LAPORAN REKAP KARYAWAN TERKENA SP</td>
 </tr>
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
    ...
    <td class=xl27 width=20 style='width:25pt'>JABATAN</td>
    <td class=xl27 width=20 style='width:50pt'>TGL KELUAR SP</td>
    <td class=xl27 width=20 style='width:50pt'>TGL BERAKHIR SP</td> 
    <td class=xl27 width=20 style='width:25pt'>STATUS</td>
      <td class=xl27 width=120 style='width:25pt'>JENIS</td>
