...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 <tr height=27 style='height:20.25pt'>
  <td colspan=14 height=27 class=xl33 style='height:20.25pt;
  ...
  </v:shape><![endif]-->LAPORAN REKAP LEMBUR KARYAWAN</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td colspan=14 height=17 class=xl34 style='height:12.75pt'>&nbsp;</td>
 </tr>
 
EOH;

$content .= "<tr height=21 style='height:15.75pt'>
  <td colspan=14 height=21 class=xl36 style='height:15.75pt'>CABANG  : ".$nm_perwakilan."</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td colspan=14 height=21 class=xl36 style='height:15.75pt'>Periode : Tahun: ".$tahun." Bulan :".$bulan."</td>
 </tr>";

$content .= <<<EOH
 <tr height=18  style='height:13.5pt'>
        <td colspan=14 class=xl25 style='height:13.5pt'>&nbsp;</td>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
    ...
    <td class=xl27 width=109 style='width:50pt'>Jabatan</td>
    <td class=xl27 width=98 style='width:50pt'>Nama Atasan</td> 
    <td class=xl27 width=57 style='width:25pt'>Tgl Lembur</td>
    <td class=xl27 width=57 style='width:25pt'>Lama Lembur</td>
    <td class=xl27 width=57 style='width:25pt'>Biaya Lembur</td>
    <td class=xl27 width=57 style='width:25pt'>Job Desc</td>
    <td class=xl27 width=57 style='width:25pt'>Evaluasi</td>
    <td class=xl27 width=57 style='width:25pt'>Status</td>
