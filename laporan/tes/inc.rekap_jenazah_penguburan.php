...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Penguburan Jenazah</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->LAPORAN REKAP PENGUBURAN JENAZAH </td>
 </tr>
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl27 width=54 style='width:30pt'>Jumlah</td>
...
function print_content($cols1,$cols2,$cols3) {
