...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Penyampaian dokumen pengadilan</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 <col class=xl24 width=45 style='mso-width-source:userset;mso-width-alt:8000;
 width:34pt'>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->LAPORAN PENYAMPAIAN DOKUMEN PENGADILAN </td>
 </tr>
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl26 width=54 style='height:15.75pt;width:20pt'>ASAL PN/PT/PA</td>
  <td class=xl27 width=54 style='width:30pt'>No Surat Pengadilan</td>
  <td class=xl27 width=54 style='width:30pt'>Kode Terpanggil</td>
  ...
  <td class=xl27 width=54 style='width:25pt'>Tanggal Surat Balasan</td>
   <td class=xl27 width=54 style='width:25pt'>No. Surat Relaas</td>
