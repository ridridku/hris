...
function print_header($tahun,$nama_bulan) {
...
@page
	{mso-header-data:"&LSistem Informasi WNI?TKI
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl26 width=54 style='height:15.75pt;width:20pt'>Perwakilan</td>
...
function print_content($cols1,$cols2) {
