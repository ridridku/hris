...
@page
	{mso-header-data:"&LSistem Informasi Perlindungan WNI/TKI dan BHI";
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Lepas Kewarganegaraan</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->LAPORAN MELEPAS KEWARGANEGARAAN</td>
 </tr>
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl27 width=54 style='width:30pt'>Tanggal Lahir</td>
  <td class=xl27 width=54 style='width:25pt'>Negara</td>
  <td class=xl27 width=54 style='width:50pt'>Asal Kepindahan</td>
