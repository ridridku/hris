...
function print_header($nm_kawasan) {
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Rekap Penyerahan Asuransi</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 width:290pt'>
 <col class=xl24 width=300 style='mso-width-source:userset;mso-width-alt:8500;
 width:150pt'>
 <col class=xl24 width=300 style='mso-width-source:userset;mso-width-alt:8500;
 width:150pt'>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->REKAP PENYERAHAN ASURANSI</td>
 </tr>
...
$content .= "<tr height=21 style='height:15.75pt'>
  <td colspan=8 height=21 class=xl36 style='height:15.75pt'>Kawasan  : ".$nm_kawasan."</td>
 </tr>";
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl27 width=54 style='width:30pt'>Jumlah Orang</td>
   <td class=xl27 width=54 style='width:30pt'>Jumlah Ekuivalent Rupiah</td>
 </tr>
EOH;
...
<tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl27>Jumlah Orang</td>
  <td class=xl27>Jumlah Ekuivalent Rupiah</td>
 </tr>";

return $content;	
}
 
function print_content($cols1,$cols2,$cols3,$cols4) {
...
function print_content2($cols1,$cols2,$cols3,$cols4) {
