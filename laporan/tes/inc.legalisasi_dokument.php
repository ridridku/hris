...
@page
	{mso-header-data:"&LPelayanan Dan Perlindungan TKI/WNI Kementerian Luar Negeri Republik Indonesia";
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Legaliasasi Dokumen</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 width:34pt'>
 <col class=xl24 width=387 style='mso-width-source:userset;mso-width-alt:8500;
 width:290pt'>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->LAPORAN LEGALISASI DOKUMENT</td>
 </tr>
...
$content .= <<<EOH
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl27 width=54 style='width:50pt'>Tanggal Stempel</td>
  <td class=xl27 width=54 style='width:50pt'>Jenis Dokumen</td> 
 </tr>
EOH;
...
$content = " <tr height=18 style='height:13.5pt'>
  ...
  <td class=xl29 align=right >".$cols6."</td> </tr>";
