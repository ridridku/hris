...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Rekap Relaas Luar Negeri</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=975 style='border-collapse:
 ...
 width:34pt'>
 <col class=xl24 width=387 style='mso-width-source:userset;mso-width-alt:18000;
 width:290pt'>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  </v:shape><![endif]-->REKAP RELAAS LUAR NEGERI </td>
 </tr>
