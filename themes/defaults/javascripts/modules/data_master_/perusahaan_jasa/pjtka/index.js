...
with (theForm){
	if (kode_pjtka.value == "") 
		{ 
			alert ("Silahkan isi field kode pjtka !"); 
			kode_pjtka.focus();
			return false; 
		}
	else if (nama_pjtka.value == "") 
		{ 
			alert ("Silahkan isi field nama pjtka !"); 
			nama_pjtka.focus();
			return false; 
		}
		...
		{ 
			alert ("Silahkan isi field tlp !"); 
			tlp.focus();
			return false; 
		}
		else if (kode_perwakilan.value == "") 
		{ 
			alert ("Silahkan isi field perwakilan !"); 
