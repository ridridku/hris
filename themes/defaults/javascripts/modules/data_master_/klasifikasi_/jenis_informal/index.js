...
with (theForm){
	if (kode_jenis_informal.value == "") 
		{ 
			alert ("Silahkan isi field kode informal !"); 
			kode_jenis_informal.focus();
			return false; 
		}
	else if (nama_informal.value == "") 
		{ 
			alert ("Silahkan isi field nama informal !"); 
			nama_informal.focus();
			return false; 
		}
	else
