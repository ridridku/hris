...
with (theForm){
	if (kode_pengaduan.value == "") 
		{ 
			alert ("Silahkan isi field kode pengaduan !"); 
			kode_pengaduan.focus();
			return false; 
		}
	else if (nama_pengaduan.value == "") 
		{ 
			alert ("Silahkan isi field nama pengaduan !"); 
			nama_pengaduan.focus();
			return false; 
		}
	else
		{
