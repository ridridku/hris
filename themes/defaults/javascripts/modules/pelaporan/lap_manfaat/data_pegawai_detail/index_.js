...
// window.open('http://localhost/hris/function/list_cari_pegawai_detail.php?kode_cabang_cari='+kode_cabang_cari+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
  window.open('../../../../function/list_cari_pegawai_detail.php?kode_cabang_cari='+kode_cabang_cari+'&kode_subcab_cari='+kode_subcab_cari+'&departemen_cari='+departemen_cari+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
