...
if (jaminan_id.value == "") 
                { 
                        alert ("Silahkan Isi No Jaminan id!"); 
                        jaminan_id.focus();
                        return false; 
                }
                ...
                { 
                        alert ("Isi Tgl penyerahan"); 
                        tgl.focus();
                        return false; 
                }              
 else if (jenis_jaminan.value == "") 
                { 
                        alert ("Pilih Jenis Jaminan"); 
                        jenis_jaminan.focus();
                        return false; 
                }       
                
else if (no_jaminan.value == "") 
                { 
                        alert ("Isi No Jaminan"); 
                        no_jaminan.focus();
                        return false; 
                }               
