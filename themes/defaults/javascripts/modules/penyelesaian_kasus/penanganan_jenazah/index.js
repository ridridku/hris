...
with (theForm){
           ...
           if   (no_berita_meninggal.value == "")
		{
			alert ("Silahkan isi No.Berita !");
			no_berita_meninggal.focus();
			return false;
		}


     
	 else if (kode_pilihan_meninggal.value == "")
		{
			alert ("Silahkan isi lokasi pemakaman !");
			kode_pilihan_meninggal.focus();
			return false;

          }


           else if (tgl_meninggal.value == "")
		{
			alert ("Silahkan pilih tanggal meninggal !");
			tgl_meninggal.focus();
			return false;
