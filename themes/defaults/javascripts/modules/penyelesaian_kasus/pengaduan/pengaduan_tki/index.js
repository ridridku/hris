...
//-->
 ...
 function goPengaduan() {
			...
			window.open('../../../../function/list_tki.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 			}
 ...
 function goKerja() {
			...
			window.open('../../../../function/list_pemberi_kerja.php?kode_wni='+kode_wni+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 			}
