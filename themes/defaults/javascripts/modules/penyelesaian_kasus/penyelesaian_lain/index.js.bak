...
with (theForm){
	...
	else if (no_bast.value == "") 
		{ 
			alert ("Silahkan isi no bast !"); 
			jenis_asuransi.focus();
			return false; 
		}
		
	 else if (jenis_asuransi.value == "") 
		{ 
			alert ("Silahkan isi jenis hak !"); 
			jenis_asuransi.focus();
			return false; 
		}
		...
		{ 
			alert ("Silahkan Isi valas !"); 
			valas.focus();
			return false; 
		}

	 else if (ekuivalent_rp.value == "") 
		{ 
			alert ("Silahkan isi ekuivalent rp !"); 
			ekuivalent_rp.focus();
			return false;
