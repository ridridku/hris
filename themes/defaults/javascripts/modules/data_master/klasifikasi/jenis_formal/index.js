...
with (theForm){
	if (kode_jenis_formal.value == "") 
		{ 
			alert ("Silahkan isi field kode formal !"); 
			kode_jenis_formal.focus();
			return false; 
		}
	else if (nama_formal.value == "") 
		{ 
			alert ("Silahkan isi field nama formal !"); 
			nama_formal.focus();
			return false; 
		}

		else if (kode_sektor.value == "") 
		{ 
			alert ("Silahkan isi field Kode Sektor !"); 
			kode_sektor.focus();
			return false; 
		}
