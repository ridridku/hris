...
with (theForm){
	if (kode_jenis_pelayanan.value == "") 
		{ 
			alert ("Silahkan isi field kode jenis pelayanan !"); 
			kode_jenis_pelayanan.focus();
			return false; 
		}
	else if (nama_jenis_pelayanan.value == "") 
		{ 
			alert ("Silahkan isi field nama jenis pelayanan !"); 
			nama_jenis_pelayanan.focus();
			return false; 
		}
	else
		{
