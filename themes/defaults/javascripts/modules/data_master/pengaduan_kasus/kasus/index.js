...
with (theForm){
	if (kode_kasus.value == "") 
		{ 
			alert ("Silahkan isi field kode kasus !"); 
			kode_kasus.focus();
			return false; 
		}
	else if (nama_kasus.value == "") 
		{ 
			alert ("Silahkan isi field nama kasus !"); 
			nama_kasus.focus();
			return false; 
		}
	else
 ...
 function cari_kab(prop_id)
{
 //alert(prop_id);
	if (prop_id==1) { //hukum
	 frmCreate.pil_kasus.disabled=false;
	   
	} else if (prop_id==2) {
	 frmCreate.pil_kasus.disabled=true;
