...
with (theForm){
		...
		{
			alert ("Silahkan isi kode perwakilan!");
			kode_perwakilan.focus();
			return false;
		}
	 else if (kode_wni.value == "")
		{
			alert ("Silahkan isi nama wni / TKI !");
			kode_wni.focus();
			return false;
...
if(http.readyState == 4)
 ...
 function goJenazah() {
			...
			window.open('../../../function/list_pemberi_kerja_tki_baru.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
 			}
