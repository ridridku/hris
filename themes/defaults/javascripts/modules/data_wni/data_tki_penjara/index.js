...
if (prop_id != '') {
 ...
 function goJenazah() {
			...
			window.open('../../../function/list_tki_penampungan.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=600,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
 			}
