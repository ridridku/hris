...
with (theForm){
 ...
 if (r_shift__ket.value == "") 
		{ 
			alert ("Silahkan Isi Nama Shift!"); 
			sp_no.focus();
			return false; 
		}
 else if (r_shift__jam_masuk.value == "") 
		{ 
			alert ("Silahkan Isi Jam Masuk !"); 
			kode_cabang.focus();
			return false; 
		}               
 else if (r_shift__jam_pulang.value == "") 
		{ 
			alert ("Silahkan Isi Jam Pulang!"); 
			sp_nama.focus();
			return false; 
		}
 else if (r_shift__jml_jam.value == "") 
		{ 
			alert ("Silahkan Isi Total jam Kerja!"); 
			sp_nip.focus();
			return false; 
		}
