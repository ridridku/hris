...
with (theForm){
		  ...
		  if (kode_perwakilan_asing.value == "") 
		{ 
			alert ("Silahkan pilih perwakilan asing !"); 
			kode_perwakilan.focus();
			return false; 
		}

	else if (nama_terpanggil.value == "") 
		{ 
			alert ("Silahkan isi nama terpanggil !"); 
			nama.focus();
			return false; 
		}				
		...
		{ 
		 ...
		 else if (no_surat_diplomatik.value == "") 
		{ 
			alert ("Silahkan isi no surat diplomatik realease !"); 
...
//-->
 ...
 function goPengaduan() {
		...
		{
			window.open('../../../function/list_wni.php?kode_perwakilan_asing='+kode_perwakilan_asing+'&kode_jenis_panggil='+kode_jenis_panggil+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 

		} else if (kode_jenis_panggil==2) {	 //BHI
			window.open('../../../function/list_bhi.php?kode_perwakilan_asing='+kode_perwakilan_asing+'&kode_jenis_panggil='+kode_jenis_panggil+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 		}	
