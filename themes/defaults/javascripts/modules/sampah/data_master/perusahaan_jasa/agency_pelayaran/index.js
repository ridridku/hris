...
with (theForm){
	...
	else if (nama_agency.value == "") 
		{ 
			alert ("Silahkan isi field nama agency !"); 
			nama_agency.focus();
			return false; 
		}
		else if (alamat_agency.value == "") 
		{ 
			alert ("Silahkan isi field alamat agency !"); 
			alamat_agency.focus();
			return false; 
		}
		else if (tlp_agency.value == "") 
		{ 
			alert ("Silahkan isi field telp agency !"); 
			tlp_agency.focus();
			return false; 
		}
	else
