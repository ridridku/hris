...
with (theForm){
	if (kode_negara.value == "") 
		{ 
			alert ("Silahkan isi field kode negara !"); 
			kode_negara.focus();
			return false; 
		}
	else if (nama_negara.value == "") 
		{ 
			alert ("Silahkan isi field nama negara !"); 
			nama_negara.focus();
			return false; 
		}
        else if (kode_kawasan.value == "") 
		{ 
			alert ("Silahkan isi field kode kawasan !"); 
			kode_kawasan.focus();
			return false; 
		}
	else
