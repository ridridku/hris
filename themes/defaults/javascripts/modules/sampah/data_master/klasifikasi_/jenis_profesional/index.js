...
with (theForm){
	if (kode_jenis_prof.value == "") 
		{ 
			alert ("Silahkan isi field kode profesional !"); 
			kode_jenis_prof.focus();
			return false; 
		}
	else if (nama_prof.value == "") 
		{ 
			alert ("Silahkan isi field nama profesional !"); 
			nama_prof.focus();
			return false; 
		}
	else
