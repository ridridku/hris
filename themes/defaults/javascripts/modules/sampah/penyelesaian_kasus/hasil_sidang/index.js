...
with (theForm){
	 ...
	 else if (tgl_sidang.value == "") 
		{ 
			alert ("Silahkan isi tanggal sidang !"); 
			tgl_sidang.focus();
			return false; 
		}

	else if (pengacara_pendamping.value == "") 
		{ 
			alert ("Silahkan isi Pengacara pendamping !"); 
			pengacara_pendamping.focus();
			return false; 
		}				
	else if (vonis.value == "") 
		{ 
			alert ("Silahkan Isi vonis !"); 
			vonis.focus();
			return false; 
		}
...
//-->
 ...
 function goPengaduan() {
			...
			window.open('../../../function/list_pengaduan2.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 			}
