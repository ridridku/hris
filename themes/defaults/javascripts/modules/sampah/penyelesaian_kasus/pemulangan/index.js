...
with (theForm){
		  ...
		  if (no_sk_pemulangan.value == "")
		{
			alert ("Silahkan isi No.BAST !");
			no_sk_pemulangan.focus();
			return false;
		}

	 else if (tgl_sk.value == "")
		{
			alert ("Silahkan pilih Tanggal BAST !");
			tgl_sk.focus();
			return false;
		}


		 else if (tgl_pemulangan.value == "")
		{
			alert ("Silahkan pilih Tanggal Pemulangan !");
			tgl_pemulangan.focus();
			return false;
		}


		 else if (tgl_tiba.value == "")
		{
			alert ("Silahkan pilih Tanggal Tiba !");
			tgl_sk.focus();
			return false;
		}


	else if (petugas.value == "")
		{
			alert ("Silahkan isi Petugas !");
			petugas.focus();
			return false;
		}
	else if (diserahkan.value == "")
		{
			alert ("Silahkan Isi pihak yang menerima !");
			diserahkan.focus();
			return false;
		}
	 ...
	 else if (flight.value == "")
		{
          ...
          else if (entry_point.value == "")
		{
			alert ("Silahkan isi entry point !");
			entry_point.focus();
			return false;
...
//-->
 ...
 function goPemulangan() {
			//document.frm.KodeEselon1.value='';
			//document.frm.NamaEselon1.value='';
			 kode_perwakilan= document.frmCreate.kode_perwakilan.value;
			window.open('../../../function/list_pengaduan.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
 			}
