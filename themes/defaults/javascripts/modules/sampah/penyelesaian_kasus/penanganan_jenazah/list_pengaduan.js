...
//-->
 ...
 function goDep() {
			...
			window.open('../../../function/List_Departemen.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
