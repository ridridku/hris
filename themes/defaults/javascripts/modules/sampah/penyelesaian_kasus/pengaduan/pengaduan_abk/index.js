...
with(theForm){
 ...
 function goPengaduan() {
			...
			window.open('../../../../function/list_abk.php?kode_perwakilan='+kode_perwakilan+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 			}
 ...
 function goKerja() {
			 ...
			 kode_wni= document.frmCreate.kode_wni.value;
			window.open('../../../../function/list_pemberi_kerja_abk2.php?kode_wni='+kode_wni+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0') 
 			}
...
function addRowToTable()
{
	...
	"<select ID=\"anggota_nik_"+iteration+"\" class=\"inputtext\" NAME=\"kode_kasus_"+iteration+"\" onchange=\"cari_nama(this.value,'"+iteration+"');\" style=width:150px>" +
	"<OPTION value=\"\"></OPTION> "+
