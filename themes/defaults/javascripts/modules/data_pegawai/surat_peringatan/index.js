...
with (theForm){
    ...
    else if (sp_tgl_exp.value == "")
            {
                    alert ("Silahkan Isi Tanggal Expired!");
                    sp_tgl_exp.focus();
                    return false;
            }
    ...
    else if (sp_pelanggaran.value == "")
            {
                    alert ("Silahkan Isi Pertimbangan ");
                    sp_pelanggaran.focus();
                    return false;
            }
...
kode_cabang= document.frmCreate.kode_cabang.value;
 ...
 if(kode_cabang =='')
    ...
    }else
    {
 			...
 			window.open('../../../function/list_surat_peringatan.php?q='+kode_cabang_encoded+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
                    }
}
function goCarikaryawan2() {
 ...
 if(kode_cabang =='')
    ...
    {
  var kode_cabang_encoded = base64_encode(kode_cabang);
	kode_cabang= document.frmCreate.kode_cabang.value;window.open('../../../function/list_surat_peringatan2.php?q='+kode_cabang_encoded+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
    }
 }
