...
with (theForm){
	 ...
	 if (no_mdrp.value == "")
		{
			alert ("Silahkan Isi No Fomulir MDRP Yang Diajukan!");
			no_mdrp.focus();
			return false;
		}
 else if (kode_cabang.value == "")
		{
			alert ("Silahkan Pilih Cabang Asal!");
			kode_cabang.focus();
			return false;
		}
 ...
 else if (cabang_baru.value == "")
		{
			alert ("Silahkan Pilih Cabang baru!");
			cabang_baru.focus();
			return false;
		}
 else if (subcabang_baru.value == "")
		{
			alert ("Silahkan Pilih Sub Cabang baru!");
			subcabang_baru.focus();
			return false;
		}
                
else if (dep_baru.value == "")
		{
			alert ("Silahkan Pilih Departemen baru!");
			dep_baru.focus();
			return false;
		}
else if (subdep_baru.value == "")
		{
			alert ("Silahkan Pilih Sub Departemen baru!");
			subdep_baru.focus();
			return false;
		}
	else
...
function cari_subcab(abc)
{

if (abc != '') {
	http.open('get','index.php?get_subcab=1&no_subcab='+abc);
	http.onreadystatechange = handlechoice_mdrp;
	http.send(null);
	}
}

function handlechoice_mdrp(){
...
function goCarikaryawan() 
{
    ...
    
    {
 	...
 	window.open('../../../function/list_pegawai_mdrp.php?q='+kode_cabang_encoded+'',null,'height=500,width=550,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')
    }
