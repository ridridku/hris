...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pelepasan Kewarganegaraan</td></tr>
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD>Kode Lepas</TD>
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="kode_lepas" value="(OTOMATIS OLEH SISTEM)" size="35" readOnly class="text_disabled">
						<!--{else}-->
					<INPUT TYPE="text" NAME="kode_lepas" value="<!--{$EDIT_KODE_LEPAS}-->" size="35" readOnly class="text_disabled">
						<!--{/if}-->
					</TD>
				</TR>
              	...
              	<TR>
               	...
               	<TR>
					...
					<TD>
						...
						<INPUT TYPE="hidden" NAME="jk"  id="jk" size="35" value="<!--{$EDIT_JK}-->" >
						<input name="ButtonDepartemen" type="button" class="button" style="cursor: hand;" onclick="goLepas()" value=" ... " />
					</TD>
				</TR>

               	<TR>
					<TD>Pindah Ke Negara</TD>
					<TD>
						    <select name="kode_negara">
							<option value="">[Pilih Negara] </option>
							<!--{section name=x loop=$DATA_NEGARA}-->
							<!--{if  ($DATA_NEGARA[x].kode_negara) ==  ($EDIT_KODE_NEGARA)}-->
							<option value="<!--{$DATA_NEGARA[x].kode_negara}-->" selected > <!--{$DATA_NEGARA[x].nama_negara}--></option>
							<!--{else}-->
							<option value="<!--{$DATA_NEGARA[x].kode_negara}-->"  > <!--{$DATA_NEGARA[x].nama_negara}--> </option>
							<!--{/if}-->
							<!--{/section}-->
							</select>
                 	...
                 	<TR>
					<TD>Tanggal Lepas Kewarganegaraan</TD>
					<TD>
					<!--{if $EDIT_VAL==0}-->

							 <input type="text" name="tgl_lepas_wn" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_lepas_wn,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_lepas_wn" value="<!--{$EDIT_TGL_LEPAS_WN}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_lepas_wn,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->
					</TD>
				</TR>
                ...
                <TR>
					<TD>Alamat  </TD>
					<TD><textarea cols="50" rows="3" name="alamat_tujuan"><!--{$EDIT_ALAMAT_TUJUAN}--></textarea> </TD>
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar   Pelepasan Kewarganegaraan</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left">Negara Tujuan</TH>
											<th class="tdatahead" align="left">Alamat</TH>
                                           	<th class="tdatahead" align="left">Tanggal Lepas Kewarganegaraan</TH>
            ...
            <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nama}--> </TD>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].alamat_tujuan}--> </TD>
                                            <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_lepas_wn}--> </TD>

                                            <TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_lepas=<!--{$DATA_TB[x].kode_lepas}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_lepas=<!--{$DATA_TB[x].kode_lepas}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
...
<INPUT TYPE="hidden" name="kode_negara_cari" value="<!--{$KODE_NEGARA_CARI}-->">
