...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data WNI Yang Menikah Dengan Warga Negara Asing</td></tr>
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD>Kode Nikah</TD>
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="kode_nikah" value="(OTOMATIS OLEH SISTEM)" size="35" readOnly class="text_disabled">
						<!--{else}-->
					<INPUT TYPE="text" NAME="kode_nikah" value="<!--{$EDIT_KODE_NIKAH}-->" size="35" readOnly class="text_disabled">
						<!--{/if}-->
					</TD>
				</TR>
				...
				<TR>
               	...
               	<TR>
					...
					<TD>
						...
						<input name="ButtonDepartemen" type="button" class="button" style="cursor: hand;" onclick="goMenikah()" value=" ... " />
					</TD>
				</TR>
                ...
                <TR>
					...
					<!--{if $EDIT_VAL==0}-->
							 ...
							 <input type="text" name="tgl_nikah" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_nikah,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_nikah" value="<!--{$EDIT_TGL_NIKAH}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_nikah,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->
					</TD>
				</TR>
				...
				<TR>
					<TD>Nama WNA</TD>
					<TD><INPUT TYPE="text" NAME="nama_wna" value="<!--{$EDIT_NAMA_WNA}-->" size="35"></TD>
				</TR>
	...
	<!--{/if}-->	
							<TR>
								<TD>Nama WNA</TD>
								<TD><INPUT TYPE="text" NAME="nama_wna_cari" size="30"></TD>
							</TR>
							<TR>
								<TD>Nama WNI </TD>
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data Pernikahan Dengan Warga Negara Asing</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Menikah Dengan Warga Negara Asing</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead" align="left">No</TH>
											<th class="tdatahead" align="left">Perwakilan</TH>
											<th class="tdatahead" align="left">Tanggal Menikah</TH>
											<th class="tdatahead" align="left">Nama WNI</TH>
											<th class="tdatahead" align="left">Nama WNA</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_nikah}--> </TD>
			                                ...
			                                <TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_nikah=<!--{$DATA_TB[x].kode_nikah}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_nikah=<!--{$DATA_TB[x].kode_nikah}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
...
<INPUT TYPE="hidden" name="nama_wna_cari" value="<!--{$NAMA_WNA_CARI}-->">
