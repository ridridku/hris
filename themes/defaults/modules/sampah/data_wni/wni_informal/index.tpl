...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data TKI Informal</td></tr> 
		</table>
...
<TR>
					<TD>Jenis Informal <font color="#ff0000">*</font></TD>
					<TD>
				 
					<select name="kode_jenis_wni" > 
						<option value="">[Pilih Jenis Informal]</option>
						<!--{section name=x loop=$DATA_JNS_WNI}-->
						<!--{if trim($DATA_JNS_WNI[x].kode_jenis_informal) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_informal}-->" selected > <!--{$DATA_JNS_WNI[x].nama_informal}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_informal}-->"  > <!--{$DATA_JNS_WNI[x].nama_informal}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>										
				 </TD>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar TKI Informal</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
	<tr>
