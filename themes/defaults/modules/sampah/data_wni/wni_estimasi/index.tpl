...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Estimasi Jumlah WNI</td></tr>
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
				 ...
				 <TR>
								...
								<select name="tahun">
								<option value=""></option>
								<option value="2005" <!--{if ($EDIT_TAHUN==2005)}-->  selected <!--{/if}--> >2005</option>
								<option value="2006" <!--{if ($TEDIT_TAHUN==2006)}-->  selected <!--{/if}--> >2006</option>
								<option value="2007" <!--{if ($TEDIT_TAHUN==2007)}-->  selected <!--{/if}--> >2007</option>
								 <option value="2008" <!--{if ($TEDIT_TAHUN==2008)}-->  selected <!--{/if}--> >2008</option>

								<option value="2009" <!--{if ($EDIT_TAHUN==2009)}-->  selected <!--{/if}--> >2009</option>
								<option value="2010"  <!--{if ($EDIT_TAHUN==2010)}-->  selected <!--{/if}--> >2010</option>
								<option value="2011"  <!--{if ($EDIT_TAHUN==2011)}-->  selected <!--{/if}--> >2011</option>
								<option value="2012"  <!--{if ($EDIT_TAHUN==2012)}-->  selected <!--{/if}-->>2012</option>
								<option value="2013"  <!--{if ($EDIT_TAHUN==2013)}-->  selected <!--{/if}-->>2013</option>
								<option value="2014"  <!--{if ($EDIT_TAHUN==2014)}-->  selected <!--{/if}-->>2014</option>
								<option value="2015"  <!--{if ($EDIT_TAHUN==2015)}-->  selected <!--{/if}-->>2015</option>
								<option value="2016"  <!--{if ($EDIT_TAHUN==2016)}-->  selected <!--{/if}-->>2016</option>
								<option value="2017"  <!--{if ($EDIT_TAHUN==2017)}-->  selected <!--{/if}-->>2017</option>
								<option value="2018"  <!--{if ($EDIT_TAHUN==2018)}-->  selected <!--{/if}-->>2018</option>
								<option value="2019"  <!--{if ($EDIT_TAHUN==2019)}-->  selected <!--{/if}-->>2019</option>
								<option value="2020"  <!--{if ($EDIT_TAHUN==2020)}-->  selected <!--{/if}-->>2020</option>
								</select>
				...
				<TR>
					<TD>Jumlah</TD>
					<TD><INPUT TYPE="text" NAME="jml" value="<!--{$EDIT_JML}-->" size="20"> Orang
					</TD>
				</TR>
				...
				<TR>
					...
					<textarea name="keterangan" rows="4" cols="45"><!--{$EDIT_KETERANGAN}--></textarea> 
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Estimasi Jumlah WNI</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											 <th class="tdatahead" align="left">No</TH>                                      
											 <th class="tdatahead" align="left">Perwakilan</TH>
											 <th class="tdatahead" align="left">Jumlah WNI</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
					 <td width="17" class="tdatacontent-first-col"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
                                            ...
                                            <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jml}--> </TD>
