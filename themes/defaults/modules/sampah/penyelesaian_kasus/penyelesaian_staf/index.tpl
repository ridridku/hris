...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Penyelesaian Kasus Staf Lokal</td></tr> 
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> Form Tamabh/Ubah Data</td></tr>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD>Kode Penyelesaian</TD>
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="kode_penyelesaian" value="(OTOMATIS OLEH SISTEM)" size="35" readOnly class="text_disabled">
				 
					<!--{else}-->
					<INPUT TYPE="text" NAME="kode_penyelesaian" value="<!--{$KODE_PENYELESAIAN}-->" size="35" readOnly class="text_disabled">
					<!--{/if}-->
					</TD>			
				</TR>
					...
					<TD><select name="kode_jenis_pw"   onchange="cari_kab(this.value);"> 
						...
						<option value="1" <!--{if $KODE_JENIS_PW==1}--> selected  <!--{/if}--> >Kedutaan Besar Asing  </option>
						<option value="2" <!--{if $KODE_JENIS_PW==2}--> selected  <!--{/if}-->  > Organisasi Dunia</option>
			...
			<TR>
					<TD>Penyelesaian</TD>
					<TD> 
						 <textarea cols="50" rows="3" name="penyelesaian"><!--{$PENYELESAIAN}--></textarea> 
					</TD>	
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Data Penyelesaian Kasus Staf Lokal</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left">Nama Lokal Staf</TH>
											<th class="tdatahead" align="left">Penyelesaian</TH>
											<th class="tdatahead" align="left">Tanggal Penyelesaian</TH>
											<th class="tdatahead" align="left">Kasus</TH>	
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].penyelesaian}--> </TD>
											...
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_penyelesaian=<!--{$DATA_TB[x].kode_penyelesaian}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_penyelesaian=<!--{$DATA_TB[x].kode_penyelesaian}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
