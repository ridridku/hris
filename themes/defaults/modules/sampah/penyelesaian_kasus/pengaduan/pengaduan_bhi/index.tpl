...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pengaduan Kasus BHI</td></tr> 
		</table>
		...
		<INPUT TYPE="hidden" NAME="kode_form_pengaduan_hidden" id="kode_form_pengaduan_hidden" size="35" value="<!--{$KODE_FORM_PENGADUAN}-->"  > 
			...
			<TR>
					<TD>Pemilik</TD>
					<TD>
						 <INPUT TYPE="text" NAME="pemilik"  readonly  id="pemilik"  size="35" value="<!--{$PEMILIK}-->">  
					</TD>	
				</TR>
			 ...
			 <TR>
					<TD>Alamat</TD>
					<TD>
						 <INPUT TYPE="text" NAME="alamat_ln_bh"  readonly  id="alamat_ln_bh"  size="35" value="<!--{$ALAMAT_LN_BH}-->">  
					</TD>	
			 </TR>
			...
			<TR>
					<TD>Badan Hukum</TD>
					<TD>
						 <INPUT TYPE="text" NAME="nama_bh"  readonly  id="nama_bh"  size="35" value="<!--{$NAMA_BH}-->">  
					</TD>	
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar  Pengaduan/Kasus BHI</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left" rowspan="2">Nama BHI</TH>
											<th class="tdatahead" align="left" rowspan="2">Pemilik</TH>
											<th class="tdatahead" align="left" rowspan="2">Badan Hukum</TH>
											<th class="tdatahead" align="left" rowspan="2">Kasus</TH> <th class="tdatahead" rowspan="2" COLSPAN="2"><!--{$ACTION}--></th>
		  ...
		  <tr>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<!--{if ($DATA_TB[x].jenis_bh==1)}--> Badan Hukum Milik Swasta <!--{/if}--> 
											<!--{if ($DATA_TB[x].jenis_bh==2)}--> Badan Hukum Milik Negara <!--{/if}-->
											</TD>
										  
											<TD class="tdatacontent" nowrap> 
												<!--{section name=y loop=$DATA_TB2}-->
													<!--{if ($DATA_TB2[y].kode_form_pengaduan==$DATA_TB[x].kode_form_pengaduan) and ($DATA_TB2[y].kode_bhi==$DATA_TB[x].kode_bhi)}-->													
