...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle">Pencarian Data</span></a>
			...
			<TR>
			 ...
			 <TR>
			  ...
			  <TR>
				  ...
				  <select name="kat_adopsi" OnChange="JavaScript:Ajax('ajax_input_adopsi','<!--{$HREF_HOME_PATH_AJAX}-->/form_adopsi.php?jenis_adopsi='+frmCreate.kat_adopsi.value)"  >
							 <OPTION value="0" <!--{if $KAT_ADOPSI==''}-->  SELECTED <!--{/if}-->> </OPTION>
							 <option value="1" <!--{if $KAT_ADOPSI==1}-->  SELECTED <!--{/if}-->>Adopsi</option>
					 ...
					 <TR>
						 <TD colspan="2"> 
						 <div id="ajax_input_adopsi">				 
						 &nbsp;
						  <!--{if $KAT_ADOPSI==1}-->
						 
					 <TABLE id="table-add-box"  bordercolor="#FFFFFF" border=0>
	 
					 <TR>
						<TD width="31%"><font color="#330099"> Tanggal Adopsi </font> </TD>
						<TD>
								 <input type="text" name="tgl_adopsi"   value="<!--{$TGL_ADOPSI}-->" >
								 <img src="calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_adopsi,'yyyy-mm-dd',this)" 
								 class="imgLink" align="absmiddle" title="Show Calendar List">					 
						</TD>
					</TR>	 

					<TR>
						<TD><font color="#330099"> Nama Orang Tua</font> </TD>
						<TD><INPUT TYPE="text" NAME="nama_calon_ota" size="35" value="<!--{$NAMA_CALON_OTA}-->"></TD>
					</TR>
					 <TR>
						<TD><font color="#330099"> Alamat  Orang Tua</font></TD>
						<TD><textarea cols="50" rows="3" name="alamat_cota"><!--{$ALAMAT_COTA}--></textarea> </TD>
					</TR>
					  <TR>
						<TD><font color="#330099"> Telepon   Orang Tua</font></TD>
						<TD><INPUT TYPE="text" NAME="tlp_cota" size="35" value="<!--{$TLP_COTA}-->" > 
					 ...
					 </div> <INPUT TYPE="hidden" NAME="kode_adopsi_kasus" size="35" value="<!--{$KODE_ADOPSI_KASUS}-->" > 
						 </TD>
				 </TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr>
											...
											<th class="tdatahead" align="left" rowspan="2">No Paspor</TH>
