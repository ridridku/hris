...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Tindak Lanjut Kementerian Luar Negeri</td></tr> 
		</table>
...
<!--{/if}--> 
	...
	<div id="ajax_input2">
  	...
  	<TABLE id="table-add-box" width="90%"  >
						...
						<TR>
							<td  colspan="3" align="center"> DAFTAR TINDAK TANJUT PENGADUAN KASUS OLEH KEMENTERIAN LUAR NEGERI
