...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Tindak Lanjut Perwakilan</td></tr> 
		</table>
		...
		<FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php">
				...
				<TR>
					...
					<TD>:</TD>
					<TD>
					<!--{if ($KODE_VIA==1)}--> Datang Langsung <!--{/if}--> 
					<!--{if ($KODE_VIA==2)}--> Telepon <!--{/if}-->
					<!--{if ($KODE_VIA==3)}--> Surat <!--{/if}-->
					<!--{if ($KODE_VIA==4)}--> Email <!--{/if}-->
					<!--{if ($KODE_VIA==5)}--> Fax <!--{/if}-->
					&nbsp;</TD>	
				</TR>
...
<!--{/if}--> 
	...
	<div id="ajax_input2">
  	...
  	<TABLE id="table-add-box" width="90%"  >
						...
						<TR>
							<td  colspan="3" align="center"> DAFTAR TINDAK TANJUT PENGADUAN KASUS OLEH PERWAKILAN
						...
						<TR>
							<td  colspan="3" align="center">
													...
													<th class="thead" width="15%" >Tanggal</TH>
												 											 
													<th class="thead" width="60%">Tindak Lanjut yang dilakukan</TH>												
...
<!--{if ($JENIS_USER_SES=='1')}-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data Tindak Lanjut Kasus Oleh Perwakilan</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		...
		<tr>
											...
											<th class="tdatahead" align="left">Nama WNI/TKI/ABK/BHI</TH>
										 
											<th class="tdatahead" align="left">Jenis Kasus</TH>
											<th class="tdatahead" align="left">Perwakilan</TH>
											 
											<th class="tdatahead" align="left">Tanggal lapor</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
									...
									<!--{if ($DATA_TB[x].kode_kat_kasus==1) or ($DATA_TB[x].kode_kat_kasus==2) or ($DATA_TB[x].kode_kat_kasus==3)}--> 
									
													<!--{section name=y loop=$DATA_TB3}-->
												<!--{if ($DATA_TB3[y].kode_form_pengaduan==$DATA_TB[x].kode_form_pengaduan) and ($DATA_TB3[y].kode_wni==$DATA_TB[x].kode_wni)}-->													
									...
									<!--{if ($DATA_TB[x].kode_kat_kasus==5)}--> 
									
													<!--{section name=y loop=$DATA_TB3}-->
												<!--{if ($DATA_TB3[y].kode_form_pengaduan==$DATA_TB[x].kode_form_pengaduan) and ($DATA_TB3[y].kode_bhi==$DATA_TB[x].kode_wni)}-->													
													 - <!--{$DATA_TB3[y].nama_kasus}--> <BR>
												<!--{/if}-->
											<!--{/section}--> 
									<!--{/if}-->		
...
<INPUT TYPE="hidden" name="pil_kategor" value="<!--{$PIL_KATEGORI}-->">
