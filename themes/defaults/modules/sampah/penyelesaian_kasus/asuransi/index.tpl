...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pemenuhan Hak Asuransi WNI/TKI</td></tr> 
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					...
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="kode_asuransi" value="(OTOMATIS OLEH SISTEM)" size="35" readOnly class="text_disabled">
				 
					<!--{else}-->
					<INPUT TYPE="text" NAME="kode_asuransi" value="<!--{$KODE_ASURANSI}-->" size="35" readOnly class="text_disabled">
					<!--{/if}-->
					</TD>			
				</TR>
			...
			<TR>
					<TD>Jenis Asuransi Yang diberikan</TD>
					<TD>
						 <INPUT TYPE="text" NAME="jenis_asuransi"   id="jenis_asuransi"  size="35" value="<!--{$JENIS_ASURANSI}-->">  
					</TD>	
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Pemenuhan Hak Asuransi WNI/TKI</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead" align="left">No</TH>
											<th class="tdatahead" align="left">Perwakilan</TH>
											<th class="tdatahead" align="left">Kategori</TH>
											<th class="tdatahead" align="left">Nama WNI</TH>
											<th class="tdatahead" align="left">Daerah Asal</TH>
											<th class="tdatahead" align="left">Jenis Asuransi</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jenis_asuransi}--> </TD>
											...
											<TD class="tdatacontent" nowrap><!--{$DATA_TB[x].valas}-->  <!--{$DATA_TB[x].jumlah}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].ekuivalent_rp}--> </TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_asuransi=<!--{$DATA_TB[x].kode_asuransi}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_asuransi=<!--{$DATA_TB[x].kode_asuransi}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
