...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Hasil Sidang </td></tr> 
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD>Kode Vonis</TD>
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="kode_hasil_sidang" value="(AUTONUMBER BY SYSTEM)" size="35" readOnly class="text_disabled">
				 
					<!--{else}-->
					<INPUT TYPE="text" NAME="kode_hasil_sidang" value="<!--{$KODE_HASIL_SIDANG}-->" size="35" readOnly class="text_disabled">
					<!--{/if}-->
					</TD>			
				</TR>
				...
				<TR>
					...
					<TD>
						...
						<INPUT TYPE="hidden" NAME="kode_kat_kasus"  id="kode_kat_kasus" size="35" value="<!--{$KODE_KAT_KASUS}-->" >
				...
				<TR>
					...
					<TD>
					<!--{if $EDIT_VAL==0}-->
							 <input type="text" name="tgl_sidang" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_sidang,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">  	
					<!--{else}-->
							 <input type="text" name="tgl_sidang" value="<!--{$TGL_SIDANG}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_sidang,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">  	
					<!--{/if}-->
					</TD>	
				</TR> 				  
				<TR>
					<TD>Pengacara Pendamping</TD>
					<TD> <INPUT TYPE="text" NAME="pengacara_pendamping" id="pengacara_pendamping"  size="35" value="<!--{$PENGACARA_PENDAMPING}-->"> </TD>	
				</TR>

				<TR>
					<TD>Vonis</TD>
					<TD>
						 <INPUT TYPE="text" NAME="vonis" id="vonis"  size="35" value="<!--{$VONIS}-->">  
					</TD>	
				</TR>
 ...
 <TR>
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data Vonis Pengadilan </td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Vonis Pengadilan </td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead" align="left">No</TH>
											<th class="tdatahead" align="left">Perwakilan</TH>
											<th class="tdatahead" align="left">Nama WNI/TKI/BHI</TH>
											<th class="tdatahead" align="left">Daerah Asal</TH>
											<th class="tdatahead" align="left">Pengacara Pendamping</TH>
											<th class="tdatahead" align="left">Tanggal Vonis</TH>
											<th class="tdatahead" align="left">Vonis</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].pengacara_pendamping}--> </TD>
											...
											<TD class="tdatacontent" nowrap><!--{$DATA_TB[x].vonis}--> </TD>
										 
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_hasil_sidang=<!--{$DATA_TB[x].kode_hasil_sidang}-->&kode_kat_kasus=<!--{$DATA_TB[x].kode_kat_kasus}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_hasil_sidang=<!--{$DATA_TB[x].kode_hasil_sidang}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
