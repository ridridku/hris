...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<TABLE id="table-add-box">
				...
				<tr>
							<td>Kategori Terpanggil</td>
								<td><select name="kode_jenis_panggil"
									onchange="display(this,'1','2','3');">
										<option value="">[Pilih Kategori]</option>
										<option value="1"<!--{if ($KODE_JENIS_PANGGIL==1)}--> selected <!--{/if}--> >TKI/WNI/ABK</option>
										<option value="2"<!--{if ($KODE_JENIS_PANGGIL==2)}--> selected <!--{/if}--> >BHI</option>
										<option value="3"<!--{if ($KODE_JENIS_PANGGIL==3)}--> selected <!--{/if}--> >WNA</option>

								</select>
								</td>
							</tr>
							<table border="0" id="table-add-box">
								<tbody id="1" style="display: none;">
									</TR>
					<TR>
					<TD>Perwakilan</TD>
					<TD>
					<select name="kode_perwakilan" onchange="display(this,'1','2','3');" > 
					...
					<select name="kode_perwakilan" onchange="display(this,'1','2','3');" > 
						...
						<!--{/section}-->
								...
								<tbody id="3" style="display: none;">
									<!--<TR>
										<TD>kode_kat_kasus</TD>
										<TD><INPUT TYPE="text" NAME="kode_kat_kasus" size="30"></TD>
									</TR>-->
				...
				<TR>
					...
					<TD><select name="kode_asal" onChange="cari_item_detail(this.value);" > 
