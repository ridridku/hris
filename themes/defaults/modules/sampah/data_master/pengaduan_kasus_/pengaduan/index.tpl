...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<TABLE id="table-add-box">
				<TR>
					<TD width="100">KODE JENIS PENGADUAN</TD>	
					<TD><!--{if $EDIT_VAL==0}-->					
					<INPUT TYPE="text" NAME="kode_pengaduan" value="(AUTONUMBER BY SYSTEM)" size="35" readOnly class="text_disabled">
					<!--{else}-->
					<INPUT TYPE="text" NAME="kode_pengaduan" value="<!--{$EDIT_KODE_PENGADUAN}-->" size="35" readOnly class="text_disabled">
					<!--{/if}-->
					</TD>			
				</TR>
				<TR>
					...
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="nama_pengaduan" size="35">
					<!--{else}-->
					<INPUT TYPE="text" NAME="nama_pengaduan" value="<!--{$EDIT_NAMA_PENGADUAN}-->" size="35">
					<!--{/if}-->
					</TD>
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">							
			<TR>
				<TD width="75">KODE JENIS PENGADUAN</TD>
				<TD><INPUT TYPE="text" NAME="kode_pengaduan" size="25"></TD>
			</TR>
			<TR>
				<TD>[or] NAMA JENIS PENGADUAN</TD>
				<TD><INPUT TYPE="text" NAME="nama_pengaduan" id="nama_pengaduan" size="25">				
				</TD>
			</TR>
			<TR><TD></TD>
				<TD>
				...
				<a class="button" href="#" onclick="this.blur(); document.frmList1.reset(); frmList1.nama_pengaduan.focus();"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/blank.gif" align="absmiddle"><!--{$RESET}--></span></a>					
				</CENTER>
				</TD>
			</TR>
			</TABLE>
		...
		<th class="tdatahead">Nama Jenis Pengaduan</th>
...
<!--{section name=x loop=$DATA_TB}-->										
			<tr class='<!--{cycle values="alt,alt3"}-->'>
				...
				<td class="tdatacontent" nowrap><!--{$DATA_TB[x].nama_pengaduan}--></td>
				<td width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER="0" ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&kode_pengaduan=<!--{$DATA_TB[x].kode_pengaduan}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></td>
				<td width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER="0" ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&kode_pengaduan=<!--{$DATA_TB[x].kode_pengaduan}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></td>
			</tr>
			<!--{sectionelse}-->
			<tr>
