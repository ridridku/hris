...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<TABLE id="table-add-box">
				<TR>
					<TD width="100">KODE PJTKA</TD>	
					<TD><!--{if $EDIT_VAL==0}-->					
					<INPUT TYPE="text" NAME="kode_pjtka" value="(OTOMATIS OLEH SISTEM)" size="35" readOnly class="text_disabled">
					<!--{else}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<th class="tdatahead" align="left">Nama PJTKA</th>
...
<INPUT TYPE="hidden" name="nama_pjtka" value="<!--{$nama_pjtka}-->">
<INPUT TYPE="hidden" name="kode_pjtka" value="<!--{$kode_pjtka}-->">
