...
jQuery().ready(function(){	
	...
	<!--{/section}-->
	 ...
	 <!--{section name=z loop=$DATA_MENU_SUB_CHILD}-->
	<!--{if $DATA_MENU_SUB_CHILD[z].sum_child2>0}-->
	jQuery('#xtraMenu2<!--{$DATA_MENU_SUB_CHILD[z].menu_id}-->').Accordion({
		active: 'h4.selected',
		header: 'h4.head',
		alwaysOpen: false,
		animated: true,
...
<ul id="theMenu">
	...
	<li>
		...
		<form name="frmMenuShowGis" method="post" action="show.gis.php" target="_parent">
		<a class="menu-tree" HREF="javascript:document.frmMenuShowGis.submit();">
		<IMG SRC="<!--{$HREF_IMG_PATH}-->/<!--{$DATA_MENU_PARENT[x].menu_normal_icon}-->" WIDTH="16" HEIGHT="16" BORDER="0" align="absmiddle" class="pngfix"><!--{$DATA_MENU_PARENT[x].menu_label}--></a></form>
						...
						<!--{if $DATA_MENU_CHILD[y].sum_child>0}-->
								...
								<!--{section name=q loop=$DATA_MENU_SUB_CHILD}-->
															...
															<!--{if $DATA_MENU_SUB_CHILD[q].menu_parent == $DATA_MENU_CHILD[y].menu_id && $DATA_MENU_SUB_CHILD[q].menu_level == '2'  && $DATA_MENU_CHILD[y].menu_parent == $DATA_MENU_PARENT[x].menu_id }-->
																    	 ...
																    	 <!--{if $DATA_MENU_SUB_CHILD[q].sum_child2>0}-->
																				 
																			
																				<h4 class="head"> <li id="xtraMenu2<!--{$DATA_MENU_SUB_CHILD[q].menu_id}-->">  <a href="javascript:;"><img src="<!--{$HREF_IMG_PATH}-->/<!--{$DATA_MENU_SUB_CHILD[q].menu_normal_icon}-->" border="0" class="pngfix" align="absmiddle" style="margin-right:4px;"><!--{$DATA_MENU_SUB_CHILD[q].menu_label}--></a></li></h4>


																				  <!--{section name=z loop=$DATA_MENU_SUB_CHILD2}-->
																					
																						<!--{if $DATA_MENU_SUB_CHILD2[z].menu_parent == $DATA_MENU_SUB_CHILD[q].menu_id && $DATA_MENU_SUB_CHILD2[z].menu_level == '3' && $DATA_MENU_SUB_CHILD[q].menu_parent == $DATA_MENU_CHILD[y].menu_id}-->
																						<li> <a href="<!--{$DATA_MODULE}--><!--{$DATA_MENU_SUB_CHILD2[z].menu_link}-->?mod_id=<!--{$DATA_MENU_SUB_CHILD2[z].menu_id}-->" target="mainFrame"> <!--{$DATA_MENU_SUB_CHILD2[z].menu_label}-->  </a></li>
...
<ul>
	...
	<li><FORM  NAME="frmMenu" METHOD=POST ACTION="logout.php" target="_parent"><a class="menu-tree" HREF="javascript:document.frmMenu.submit();"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/lock.png" WIDTH="16" HEIGHT="16" BORDER="0" align="absmiddle" class="pngfix"> Keluar</A></FORM></li>
</ul>
