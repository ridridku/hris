...
<DIV ID="_menuEntry1_1" style="top:10px;width:100%;display:none;position:absolute;">
                ...
                <TR>
                    ...
                    <TD>
                         <select name="nama_shift" >
                                 ...
                                 <!--{if trim($DATA_SHIFT[x].r_shift__id)==$EDIT_LIBUR__SHIFT}-->
                 ...
                 <TR>
                            ...
                            <TD>
                            <!--{if $EDIT_VAL==0}-->
                            <input readonly="" type="text" NAME="tgl_libur" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->">
                            ...
                            <!--{else}-->
                            <input readonly="" type="text" name="tgl_libur" value="<!--{$EDIT_LIBUR__TGL}-->" >
                                                     <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_libur,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
                                    <!--{/if}-->
                ...
                <TR>
                            ...
                            <TD>
                                <SELECT name="jenis_libur">
                                    ...
                                    <OPTION value="1" <!--{if $EDIT_LIBUR__JENIS=='1'}-->selected<!--{/if}-->>Libur Reguler</OPTION> 
                                    <OPTION value="2" <!--{if $EDIT_LIBUR__JENIS=='2'}-->selected<!--{/if}-->>Libur Cuti Bersama</OPTION> 
                                </SELECT>
                            </TD>
                    </TR>        
 ...
 <TR>
				...
				<TD>    
                                    <TEXTAREA name="keterangan"  rows="5" cols="30"> <!--{$EDIT_LIBUR__KET}--></TEXTAREA>   
                                </TD>
                    </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0">Daftar Master Libur</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
                <THEAD>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent"> <!--{$DATA_TB[x].r_shift__ket}--></TD>
                                                                                        <TD class="tdatacontent"> <!--{$DATA_TB[x].r_libur__tgl|date_format:"%d-%b-%Y"}--></TD>
											...
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&id=<!--{$DATA_TB[x].r_libur__id}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&id=<!--{$DATA_TB[x].r_libur__id}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
