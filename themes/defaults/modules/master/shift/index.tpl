...
<DIV ID="_menuEntry1_1" style="top:10px;width:100%;display:none;position:absolute;">
		...
		<FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php">
               <TABLE id="table-add-box">
                ...
                <!--{/if}-->
                <INPUT   TYPE="hidden" name="r_shift__id" size="35" value="<!--{$EDIT_R_SHIFT__ID}-->"  >          
                        <TD>Nama Shift<font color="#ff0000">*</font></TD>
                        <TD><INPUT   TYPE="text" name="r_shift__ket" size="35" value="<!--{$EDIT_R_SHIFT__KET}-->"  >
                        </TD>
            </TR>
             <TR>
                        <TD>Jam Masuk<font color="#ff0000">*</font></TD>
                        <TD><INPUT    type="time" name="r_shift__jam_masuk" size="35" value="<!--{$EDIT_R_SHIFT__JAM_MASUK}-->"  >
                        </TD>
            </TR>
            
            <TR>
                        <TD>Jam Kerja<font color="#ff0000">*</font></TD>
                        <TD><INPUT    type="time" name="r_shift__jam_pulang" size="35" value="<!--{$EDIT_R_SHIFT__JAM_PULANG}-->"  >
                        </TD>
            </TR>
            
            <TR>
                        <TD>Total Jam Kerja<font color="#ff0000">*</font></TD>
                        <TD><INPUT    type="time" name="r_shift__jml_jam" size="35" value="<!--{$EDIT_R_SHIFT__JML_JAM}-->"   >
                        </TD>
            </TR>
...
<div id="panel-box">
		...
		<TABLE id="table-search-box" >
                            ...
                            <TR>
                                    <TD>Nama Shift</TD><TD><INPUT TYPE="text" NAME="nama_shift_cari" ></TD>
                            </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat">Data Shift</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0">Daftar Data Shihft</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
                <THEAD>   
											...
											<TH class="tdatahead" align="left" >TOTAL JAM KERJA</TH>                                                                                                  								<TH class="tdatahead" COLSPAN="2" ><!--{$ACTION}--></TH>
		</THEAD>		
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent"> <!--{$DATA_TB[x].r_shift__jml_jam}--></TD>                                                                                   
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&id=<!--{$DATA_TB[x].r_shift__id}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&id=<!--{$DATA_TB[x].r_shift__id}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
