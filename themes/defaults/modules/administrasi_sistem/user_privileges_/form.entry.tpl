...
<body class="contentPage" onLoad="hideIt(); <!--{if $OPT==1}-->showAll('_menuEntry1_',1);hideAll('_menuEntry2_',1);<!--{else}-->hideAll('_menuEdit_',1);hideAll('_menuEntry1_',1);showAll('_menuEntry2_',1);<!--{/if}-->">
		...
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> Profil User</td></tr>
		...
		<!--{if $CHILD != '2'}-->
		<h5 style="margin-bottom:5px;"><a href="index.php" style="text-decoration:none;color:#000;">List User</a>&nbsp;-->&nbsp;<a style="text-decoration:none;color:#000;" href="javascript:history.back(1);">Menu Utama</a>&nbsp;-->&nbsp;Sub Menu</h5>		
		<!--{else}-->
		<h5 style="margin-bottom:5px;"><a href="index.php" style="text-decoration:none;color:#000;">List User</a>&nbsp;-->&nbsp;<a style="text-decoration:none;color:#000;" href="javascript:history.back(1);">Menu Utama</a>&nbsp;-->&nbsp;<!--{$MENU_LABEL_SUB}-->&nbsp;-->&nbsp;<!--{$MENU_LABEL}--></h5>		
		<!--{/if}-->
		...
		<FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php">
					...
					<TH class="tdatahead" width="40">View</TH>
					<TH class="tdatahead" width="40">Insert</TH>
					<TH class="tdatahead" width="40">Edit</TH>
					<TH class="tdatahead" width="40">Delete</TH>
					<TH class="tdatahead" width="40">Search</TH>
					<TH class="tdatahead" width="40">Report</TH>
					<TH class="tdatahead" width="40">Print</TH>
					</TR>
				...
				<!--{else}-->
				<h5 style="margin-bottom:5px;"><a href="index.php" style="text-decoration:none;color:#000;">List User</a>&nbsp;-->&nbsp;<a style="text-decoration:none;color:#000;" href="javascript:history.back(1);">Menu Utama</a>&nbsp;-->&nbsp;<!--{$MENU_LABEL}--></h5>		
