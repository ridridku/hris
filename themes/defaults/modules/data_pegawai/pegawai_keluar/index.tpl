            ...
            <TR>
                   ...
                   <TR>
                            ...
                            <TD><INPUT TYPE="text" NAME="rsg__nama" readonly  id="r_pegawai__nama"  size="35" value="<!--{$EDIT_RSG_NAMA}-->">
                             NIP<INPUT TYPE="text" NAME="rsg__nip" readonly id="r_pnpt__nip" size="35" value="<!--{$EDIT_RSG_NIP}-->" >
				...
				<TD>Tanggal Keluar </TD>
					...
					<!--{else}-->
                                                        <input type="text" name="rsg__tgl" value="<!--{$EDIT_RSG__TGL}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.rsg_tgl,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->           
                                </TD>         
			</TR>
                        <TR>
				...
				<TD>
							...
							<OPTION value="1" <!--{if $EDIT_RSG__APR=='1'}-->selected<!--{/if}-->>Resign Disetujui </OPTION>
							<OPTION value="0" <!--{if $EDIT_RSG__APR=='0'}-->selected<!--{/if}-->>Resign Tidak Disetujui</OPTION>                                                       
                                    </SELECT>
                                </TD>
                     </TR>
                     ...
                     <TR>
                                ...
                                <TD><textarea rows="5" cols="20" NAME="rsg__ket"  size="12" ><!--{$EDIT_RSG__KET}--></textarea></TD>
                    </TR>
...
<!--form_cari-->
		...
		<table width="100%">
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent"> <!--{$DATA_TB[x].r_resign__tgl|date_format:"%e-%b-%Y"}--></TD>											
                                                                                        <TD class="tdatacontent"><!--{$DATA_TB[x].r_resign__ket}--></TD>                                                                                           
                                                                                        <TD class="tdatacontent"> 
                                                                                          <!--{if ($DATA_TB[x].r_resign__approval)==1}-->
                                                                                                  Disetujui
                                                                                                <!--{elseif ($DATA_TB[x].r_resign__approval) ==0}-->  
											...
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&id=<!--{$DATA_TB[x].r_resign__no}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&id=<!--{$DATA_TB[x].r_resign__no}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
