                   ...
                   <tr>
                    ...
                    <td>
                           <!--{if $JENIS_USER_SES==1}-->
                            <select name="tipe_pdrm" >
                                    ...
                                    <OPTION value="0" <!--{if $EDIT_R_PNPT__PDRM=='0'}--> selected <!--{/if}--> >Karyawan Baru</OPTION>
                    ...
                    <TR>
                            ...
                            <TD><INPUT TYPE="text" NAME="r_pegawai__nama" readonly  id="r_pegawai__nama"  size="35" value="<!--{$EDIT_R_PEGAWAI__NAMA}-->">
                                <INPUT TYPE="hidden" NAME="r_pegawai__id" readonly id="r_pegawai__id" size="35" value="<!--{$EDIT_R_PEGAWAI__ID}-->" >
