...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<tr><td class="tcat"> <!--{$TABLE_CAPTION_PERWAKILAN}--></td></tr>
		</table>
		...
		<TABLE id="table-add-box">
				<TR>
					<TD width="100"><!--{$TB_KODE_PERWAKILAN}--></TD>	
					<TD><!--{if $EDIT_VAL==0}-->					
					<INPUT TYPE="text" NAME="kode_perwakilan">
					<!--{else}-->
					<INPUT TYPE="text" NAME="kode_perwakilan" value="<!--{$EDIT_KODE_PERWAKILAN}-->" size="35" readOnly class="text_disabled">
					<!--{/if}-->
					</TD>			
				</TR>
				<TR>
					<TD><!--{$TB_NAMA_PERWAKILAN}--></TD>
					<TD><!--{if $EDIT_VAL==0}-->
				...
				<TR><td height="40"></td>
					<TD>
					<INPUT TYPE="hidden" name="kode_perwakilan" value="<!--{$EDIT_KODE_PERWAKILAN}-->">
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">							
			<TR>
				<TD width="75"><!--{$TB_KODE_PERWAKILAN}--></TD>
				<TD><INPUT TYPE="text" NAME="kode_perwakilan" size="25"></TD>
			</TR>
			<TR>
				<TD>[or] <!--{$TB_NM_PERWAKILAN}--></TD>
		...
		<th class="tdatahead" width="15%"><!--{$TB_KODE_PERWAKILAN}--></th>
		<th class="tdatahead"><!--{$TB_NAMA_PERWAKILAN}--></th>
...
<!--{section name=x loop=$DATA_TB}-->										
			<tr class='<!--{cycle values="alt,alt3"}-->'>
				...
				<td align="middle" class="tdatacontent" nowrap><!--{$DATA_TB[x].kode_perwakilan}--></td>
