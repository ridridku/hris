...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<TABLE id="table-add-box">
				<TR>
					...
					<TD><!--{if $EDIT_VAL==0}-->					
					<INPUT TYPE="text" NAME="kode_kasus" value="(AUTONUMBER BY SYSTEM)" size="35" readOnly class="text_disabled">
					<!--{else}-->
				...
				<TR>
					<TD>KETERANGAN </TD>
					<TD><!--{if $EDIT_VAL==0}-->
					<INPUT TYPE="text" NAME="keterangan" size="35">
					<!--{else}-->
					<INPUT TYPE="text" NAME="keterangan" value="<!--{$EDIT_NAMA_KETERANGAN}-->" size="35">
					<!--{/if}-->
					</TD>
				</TR>
                ...
                <TR>
					<TD>Jenis Kasus</TD>
                    <TD><select name="jenis_bh" >

					<option value=""> Pilih Jenis Kasus</option>
                    <option value=""> Hukum </option>
                    <option value=""> Non Hukum  </option></TD>
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<th class="tdatahead">Nama Jenis Kasus</th>
