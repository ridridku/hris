...
<!--{section name=x loop=$DATA_TB}-->										
			<tr class='<!--{cycle values="alt,alt3"}-->'>
				...
				<td class="tdatacontent"  ><!--{$DATA_TB[x].nama_perwakilan}--></td>
				<td class="tdatacontent"  ><!--{$DATA_TB[x].kode_staf}--></td>
				...
				<td class="tdatacontent"  ><!--{$DATA_TB[x].tgl_lahir}--></td>
...
<INPUT TYPE="hidden" name="kode_staf" value="<!--{$KODE_STAF}-->">
