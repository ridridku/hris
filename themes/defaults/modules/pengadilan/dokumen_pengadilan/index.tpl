		...
		<TABLE id="table-add-box">
				...
				<tr>
							<td>Kategori Terpanggil</td>
								<td><select name="kode_jenis_panggil"  >
		...
		<TABLE id="table-search-box">		
			...
			<TR>
								...
								<TD><select name="kode_jenis_panggil_cari" >
									...
									<option value="2">Badan Hukum Indonesia</option>
									<option value="3">WNA</option>
									<option value="4">Badan Usaha Asing</option>
...
<!--{if ($JENIS_USER_SES=='1')}-->
		...
		<tr>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent"  > <!--{if ($DATA_TB[x].kode_jenis_panggil==1)}--> WNI <!--{/if}--> 
											<!--{if ($DATA_TB[x].kode_jenis_panggil==2)}--> Badan Hukum Indonesia (BHI) <!--{/if}--> 
											
											<!--{if ($DATA_TB[x].kode_jenis_panggil==3)}--> WNA <!--{/if}--> 
											
											
												<!--{if ($DATA_TB[x].kode_jenis_panggil==4)}--> Badan Usaha Asing  <!--{/if}--> 
											</TD>
											<TD class="tdatacontent"  > <!--{$DATA_TB[x].nama}--> </TD>

											<TD class="tdatacontent"  > <!--{$DATA_TB[x].nama_pn}--> </TD>
											<TD class="tdatacontent"  > <!--{$DATA_TB[x].no_surat_pengadilan}--> </TD>
											<TD class="tdatacontent"  > <!--{$DATA_TB[x].no_surat_keluar}--> </TD>
...
<INPUT TYPE="hidden" name="kode_jenis_panggil_cari" value="<!--{$KODE_JENIS_PANGGIL_CARI}-->">
