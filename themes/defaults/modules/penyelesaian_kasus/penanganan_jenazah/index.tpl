...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Jenazah WNI/TKI</td></tr>
		</table>
		...
		<TABLE id="table-add-box">
                ...
                <TR>
				            <TD>No Berita Meninggal </TD>
							<TD><INPUT TYPE="text" NAME="no_berita_meninggal"  value="<!--{$EDIT_NO_BERITA_MENINGGAL}-->" size="30"></TD>
				</TR>
				...
				<TR>
					...
					<TD>
				    <select name="kode_sebab" >
						<option value="">[Pilihan Penyebab Meninggal]</option>
						<!--{section name=x loop=$DATA_AGAMA}-->
						<!--{if trim($DATA_AGAMA[x].kode_sebab) == $EDIT_KODE_SEBAB}-->
						<option value="<!--{$DATA_AGAMA[x].kode_sebab}-->" selected > <!--{$DATA_AGAMA[x].penyebab_kematian}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_AGAMA[x].kode_sebab}-->"  > <!--{$DATA_AGAMA[x].penyebab_kematian}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>
					</div></TD>
				...
				<TR>
					...
					<!--{if $EDIT_VAL==0}-->
							 ...
							 <input type="text" name="tgl_meninggal" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_meninggal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_meninggal" value="<!--{$EDIT_TGL_MENINGGAL}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_meninggal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->
					</TD>
				</TR>
               ...
               <TR>
					<TD>Pilihan Pemakaman</TD>
					<TD>
				    <select name="kode_pilihan_meninggal" >
						<option value="">[Pilihan Penguburan]</option>
						<!--{section name=x loop=$DATA_PILKUBUR}-->
						<!--{if trim($DATA_PILKUBUR[x].kode_pilihan_meninggal) == $EDIT_KODE_PILIHAN_MENINGGAL}-->
						<option value="<!--{$DATA_PILKUBUR[x].kode_pilihan_meninggal}-->" selected > <!--{$DATA_PILKUBUR[x].nama_pilihan_penguburan}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_PILKUBUR[x].kode_pilihan_meninggal}-->"  > <!--{$DATA_PILKUBUR[x].nama_pilihan_penguburan}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>
					</div></TD>
                	        ...
                	        <TR>
								...
								<TD><INPUT TYPE="text" NAME="diserahkan"  value="<!--{$EDIT_DISERAHKAN}-->"  size="30"></TD>
							</TR>

                    	<TR>
								<TD>Flight </TD>
								<TD><INPUT TYPE="text" NAME="flight"  value="<!--{$EDIT_FLIGHT}-->"  size="30"> * Diisi Jika Jenazah Dipulangkan </TD>
							</TR>

                            	<TR>
								<TD>Entry Point </TD>
								<TD><INPUT TYPE="text" NAME="entry_point"  value="<!--{$EDIT_ENTRY_POINT}-->"  size="30"> *  </TD>
							</TR>
                ...
                <TR>
					...
					<!--{if $EDIT_VAL==0}-->
							 ...
							 <input type="text" name="tgl_pulang" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_pulang,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_pulang" value="<!--{$EDIT_TGL_PULANG}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_pulang,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}--> *  
					</TD>
				</TR>
                  ...
                  <TR>
								<TD>Tempat Penguburan </TD>
								<TD><INPUT TYPE="text" NAME="tempat_penguburan"  value="<!--{$EDIT_TEMPAT_PENGUBURAN}-->" size="30"></TD>
							</TR>

                  <TR>
					<TD>Tanggal Penguburan</TD>
					<TD>
					<!--{if $EDIT_VAL==0}-->

							 <input type="text" name="tgl_penguburan" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_penguburan,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_penguburan" value="<!--{$EDIT_TGL_PENGUBURAN}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_penguburan,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->
					</TD>
				</TR>
                   <TR>
								...
								<TD><INPUT TYPE="text" NAME="no_bast"  value="<!--{$EDIT_NO_BAST}-->" size="30"></TD>
							</TR>

                    <TR>
					<TD>Tanggal Berita Acara Serah Terima</TD>
					<TD>
					<!--{if $EDIT_VAL==0}-->

							 <input type="text" name="tgl_bast" value="<!--{$smarty.now|date_format:"%Y-%m-%d"}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_bast,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{else}-->
								 <input type="text" name="tgl_bast" value="<!--{$EDIT_TGL_BAST}-->" >
							 <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_bast,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<!--{/if}-->
					</TD>
				</TR>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Jenazah WNI/TKI</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead" align="left">No</TH>
                                            <th class="tdatahead" align="left">No. Berita Meninggal</TH>
                                            <th class="tdatahead" align="left">Perwakilan</TH>
											<th class="tdatahead" align="left">Nama WNI</TH>
											<th class="tdatahead" align="left">Penyebab Meninggal</TH>
											<th class="tdatahead" align="left">Pilihan Pemakaman</TH>
                                            	<th class="tdatahead" align="left">Pihak Yang Menerima</TH>
                                                	<th class="tdatahead" align="left">Tanggal Meninggal</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											<td width="17" class="tdatacontent-first-col"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
                                            	<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].no_berita_meninggal}--> </TD>
                                            <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nm_perwakilan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nama}--> </TD>
												<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].penyebab_kematian}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nama_pilihan_penguburan}--> </TD>
                                            <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].diserahkan}--> </TD>
                                           	<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_meninggal}--> </TD>
                                    	    <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_tiba}--> </TD>
            	                             <TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&no_berita_meninggal=<!--{$DATA_TB[x].no_berita_meninggal}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&no_berita_meninggal=<!--{$DATA_TB[x].no_berita_meninggal}--> &mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
