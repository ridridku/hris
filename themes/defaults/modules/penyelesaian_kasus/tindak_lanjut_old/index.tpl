...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<tr><td class="tcat"> Tindak Lanjut Kasus Oleh PWNI</td></tr> 
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> DETAIL PENGADUAN DAN KASUS</td></tr>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD colspan="3">DATA TERLAPOR</TD>	
				</TR>

<!--{if ($KODE_KAT_KASUS==1 OR $KODE_KAT_KASUS==2 OR $KODE_KAT_KASUS==3 OR $KODE_KAT_KASUS==4 ) }-->
...
<!--{if ($KODE_KAT_KASUS==1 OR $KODE_KAT_KASUS==2   ) }-->
...
<!--{if ($KODE_KERJA_TKI!="")}-->
				...
				<TR>
				 ...
				 <TR>
					<TD colspan="3">TERKAIT DENGAN PEMBERI KERJA</TD>	
				</TR>
				<TR>
					<TD> Pemberi Kerja </TD>
					<TD>:</TD>
...
<table width="100%">
		<tr>
		<th class="tdatahead" align="center"><font color="#ff0000"> DATA SUDAH ADA </font></th>
 		</tr>
 </table>
<!--{/if }-->
					<TABLE id="table-add-box" width="90%"  >
						...
						<TR>
							<td  colspan="3" align="center">
													...
													<!--{sectionelse}-->
													<tr>
														<td class="tdatacontent" COLSPAN="8" align="center">Data Detail Jadwal Belum Ada</td>
													</tr>
													<!--{/section}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr>
											...
											<th class="tdatahead">Nama WNI/TKI/ABK/STAFF/BHI</TH>											 
											<th class="tdatahead">Jenis Pengaduan</TH>
