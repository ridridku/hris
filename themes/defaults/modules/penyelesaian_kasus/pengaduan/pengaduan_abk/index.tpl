...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle">Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pengaduan Kasus ABK</td></tr> 
		</table>
		...
		<FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php" autocomplete="off" >
			...
			<TR>
				...
				<TR>
				 ...
				 <TR>
				  ...
				  <TR>
					 <TD>Tempat kasus</TD>
						 <TD><select name="kode_tempat" >
							 <OPTION value=""> </OPTION>
							 <option value="1" 	<!--{if $KODE_TEMPAT==1}-->  SELECTED <!--{/if}-->>Darat</option>
							 <option value="2" <!--{if $KODE_TEMPAT==2}-->  SELECTED <!--{/if}--> >Laut</option>
							  </select>
						 </TD>
				 </TR>
							...
							<div id="ajax_cek" align="center">&nbsp;</div>
									<table width="50%" border=0>
									 ...
									 <!--{section name=y loop=$DATA_TB3}-->
										...
										<tr>
												<td ><select name="kode_kasus_<!--{$smarty.section.y.index+$COUNT_VIEW2}-->" style=width:150px onchange="cari_nama(this.value,'<!--{$smarty.section.y.index+$COUNT_VIEW2}-->');"  > 
													<option value=""> </option>
				...
				<TR>
					<TD>Nama Kapal</TD>
					<TD>
						 <INPUT TYPE="text" NAME="nama_kapal"     id="nama_kapal"  size="35" value="<!--{$NAMA_KAPAL}-->">  
					</TD>	
				</TR>
				...
				<TR>
					<TD>Bendera</TD>
					<TD>
						 <INPUT TYPE="text" NAME="bendera"     id="bendera"  size="35" value="<!--{$BENDERA}-->">  
					</TD>	
				</TR>
				...
				<TR>
					<TD>Buku Pelaut</TD>
					<TD>
						 <INPUT TYPE="text" NAME="buku_pelaut"     id="buku_pelaut"  size="35" value="<!--{$BUKU_PELAUT}-->">  
					</TD>	
				</TR>
...
<TR> 
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar  Pengaduan Kasus ABK</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left" rowspan="2">Buku Pelaut</TH>
		 ...
		 <tr>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kode_wni}--> </TD>
										 	<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].buku_pelaut}--> </TD>
