...
$().ready(function() {
	$("#kode_form_pengaduan").autocomplete("<!--{$HREF_HOME_PATH}-->/get_course_list_staf.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pengaduan/Kasus Staf Lokal</td></tr> 
		</table>
		...
		<INPUT TYPE="hidden" NAME="kode_form_pengaduan_hidden" id="kode_form_pengaduan_hidden" size="35" value="<!--{$KODE_FORM_PENGADUAN}-->"  > 
				...
				<TR>
					 <TD>Sumber</TD>
						 <TD><select name="kode_sumber_kasus" onchange="cari_kab2(this.value);">
							 <OPTION value=""> </OPTION>
			 ...
			 <TR>
				...
				<TR>
					...
					<select name="kode_perwakilan" > 
						...
						<!--{if trim($DATA_PWK[x].kode_perwakilan_asing) == $KODE_PERWAKILAN}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar  Pengaduan Kasus Staf Lokal</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
...
<td width="35">
		...
		<INPUT TYPE="hidden" name="kode_jenis_pw_cari" value="<!--{$KODE_JENIS_PW_CARI}-->">
