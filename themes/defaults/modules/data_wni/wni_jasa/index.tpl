...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<tr><td class="tcat"> Data TKI Jasa</td></tr> 
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
					<TD>No.KTP</TD>
					<TD><INPUT TYPE="text" NAME="kode_wni" value="<!--{$EDIT_KODE_WNI}-->" size="35"></TD>
				</TR>
...
<TR>
				...
				<TR>
				 ...
				 <TR>
					...
					<TD><textarea cols="50" rows="3" name="alamat"><!--{$EDIT_ALAMAT}--></textarea> </TD>
				</TR>

				
				 	
<TR>
					<TD>Jenis Jasa <font color="#ff0000">*</font></TD>
					<TD>
				 
					<select name="kode_jenis_wni" > 
						<option value="">[Pilih Jenis Jasa]</option>
						<!--{section name=x loop=$DATA_JNS_WNI}-->
						<!--{if trim($DATA_JNS_WNI[x].kode_jenis_jasa) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_jasa}-->" selected > <!--{$DATA_JNS_WNI[x].nama_jasa}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_jasa}-->"  > <!--{$DATA_JNS_WNI[x].nama_jasa}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>										
				 </TD>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data TKI Jenis Jasa</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar TKI Jenis Jasa</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead">Jenis Jasa</TH>
