...
<TR>
					<TD>Jenis ABK <font color="#ff0000">*</font></TD>
					<TD>
				 
					<select name="kode_jenis_wni" > 
						<option value="">[Pilih Jenis ABK]</option>
						<!--{section name=x loop=$DATA_JNS_WNI}-->
						<!--{if trim($DATA_JNS_WNI[x].kode_jenis_abk) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_abk}-->" selected > <!--{$DATA_JNS_WNI[x].nama_abk}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_abk}-->"  > <!--{$DATA_JNS_WNI[x].nama_abk}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>										
				 </TD>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar TKI ABK</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
