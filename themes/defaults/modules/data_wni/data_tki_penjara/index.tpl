...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data WNI/TKI Dipenjara</td></tr>
		</table>
		...
		<TABLE id="table-add-box">
				...
				<TR>
				 ...
				 <TR>
					...
					<!--{if $EDIT_VAL==0}-->
							 ...
							 <input type="text" name="tgl_masuk" value="" >
				...
				<TR>
					...
					<!--{if $EDIT_VAL==0}-->
							 ...
							 <input type="text" name="tgl_keluar" value="" >
	...
	<TR>
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data TKI Di Penjara</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar WNI/TKI Dipenjara</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
                                            ...
                                            <th class="tdatahead" align="left">Perwakilan</TH>
                                             <th class="tdatahead" align="left">Tanggal Masuk Penjara</TH>
											<th class="tdatahead" align="left">Tanggal Keluar Penjara</TH>
											<th class="tdatahead" align="left">Status</TH>
											<th class="tdatahead" align="left">Edit</TH>
