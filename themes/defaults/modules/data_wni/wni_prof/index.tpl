...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Search By</span></a>
		...
		<tr><td class="tcat"> Data WNI Profesional</td></tr> 
		</table>
...
<TR>
					<TD>Jenis WNI Profesional <font color="#ff0000">*</font></TD>
					<TD>
				 
					<select name="kode_jenis_wni" > 
						<option value="">[Pilih Jenis WNI]</option>
						<!--{section name=x loop=$DATA_JNS_WNI}-->
						<!--{if trim($DATA_JNS_WNI[x].kode_jenis_prof) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_prof}-->" selected > <!--{$DATA_JNS_WNI[x].nama_prof}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI[x].kode_jenis_prof}-->"  > <!--{$DATA_JNS_WNI[x].nama_prof}--> </option>
						<!--{/if}-->
						<!--{/section}-->
						</select>										
				 </TD>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar WNI Profesional</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead">Jenis Profesional</TH>
