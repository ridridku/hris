...
<a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle">Pencarian Data</span></a>
		...
		<tr><td class="tcat"> Data Pemberi Kerja ABK</td></tr>
		</table>
               ...
               <TR>
					...
					<TD>
						...
						<select name="kode_agency">
							...
							<!--{section name=x loop=$DATA_AGENCY}-->
							<!--{if  ($DATA_AGENCY[x].kode_agency) ==  ($EDIT_KODE_AGENCY)}-->
							<option value="<!--{$DATA_AGENCY[x].kode_agency}-->" selected > <!--{$DATA_AGENCY[x].nama_agency}--></option>
							<!--{else}-->
							<option value="<!--{$DATA_AGENCY[x].kode_agency}-->"  > <!--{$DATA_AGENCY[x].nama_agency}--> </option>
							<!--{/if}-->
							<!--{/section}-->
							</select>
                ...
                <TR>
                   ...
                   <TR>
					<TD>Nama Kapal</TD>
					<TD><INPUT TYPE="text" NAME="nama_kapal" value="<!--{$EDIT_NAMA_KAPAL}-->" size="35"></TD>
				</TR>
	...
	<!--{/if}-->
							...
							<TR>
								<TD>Nama Agensi</TD>
								<TD><INPUT TYPE="text" NAME="kode_agency_cari" size="30"></TD>
							</TR>
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Data Pemberi Kerja TKI ABK</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Pemberi Kerja TKI ABK</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead">No</TH>
											<th class="tdatahead">Nama Agensi</TH>
											<th class="tdatahead">Perwakilan</TH>
											<th class="tdatahead">No Paspor</TH>
											<th class="tdatahead">Nama ABK</TH>
											<th class="tdatahead">Tanggal Awal Kerja</TH>
											<th class="tdatahead">Tanggal Akhir Kerja</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_awal}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tgl_akhir}--> </TD>
                                           <TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nama_kapal}--> </TD>
...
<INPUT TYPE="hidden" name="kode_agency_cari" value="<!--{$KODE_AGENCY_CARI}-->">
