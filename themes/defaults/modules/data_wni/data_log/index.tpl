...
<div id="add-search-box">
 <a class="button" href="#" onclick="this.blur();showLevel('_menuEdit_',1,1);"><span><img src="<!--{$HREF_IMG_PATH}-->/icon/search.png" align="absmiddle"> Pencarian Data</span></a>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Daftar Log</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left">Host</TH>
											<th class="tdatahead" align="left">Aksi</TH>
											<th class="tdatahead" align="left">User</TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
										<td width="17" class="tdatacontent-first-col"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
											 <TD class="tdatacontent" > <!--{$DATA_TB[x].tanggal}--> </TD>
											 <TD class="tdatacontent" > <!--{$DATA_TB[x].jam}--> </TD>											
											 <TD class="tdatacontent" > <!--{$DATA_TB[x].url}--> </TD>
											 <TD class="tdatacontent" > <!--{$DATA_TB[x].module}--> </TD>
											 <TD class="tdatacontent" > <!--{$DATA_TB[x].user_id}--></TD>
