...
<TR>
			...
			<TR>
				...
				<TR>
				 ...
				 <TR>
					...
					<!--{/if}-->
					 ...
					 <!--{if ($DINA==3)}--> 	
						 <select name="kode_sektor" onchange="cari_jenis2(this.value);" > 
						<option value="">[Pilih Sektor Pekerjaan]</option>
						<!--{section name=x loop=$DATA_SEKTOR}-->
						<!--{if trim($DATA_SEKTOR[x].kode_sektor) == $KODE_SEKTOR}-->
				...
				<TR>
				  ...
				  <!--{if ($DINA==1)}--> 
					 <!--{section name=b loop=$DATA_JNS_WNI1}-->
						<!--{if  ($DATA_JNS_WNI1[b].kode_jenis_wni) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI1[b].kode_jenis_wni}-->" selected > <!--{$DATA_JNS_WNI1[b].nama_jenis_wni}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI1[b].kode_jenis_wni}-->"  > <!--{$DATA_JNS_WNI1[b].nama_jenis_wni}--> </option>
						<!--{/if}-->
					<!--{/section}-->
				...
				<!--{/if}-->
				 ...
				 <!--{if ($DINA==3)}--> 
					 <!--{section name=c loop=$DATA_JNS_WNI5}-->
						<!--{if  ($DATA_JNS_WNI5[c].kode_jenis_formal) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI5[c].kode_jenis_formal}-->" selected > <!--{$DATA_JNS_WNI5[c].nama_formal}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI5[c].kode_jenis_formal}-->"  > <!--{$DATA_JNS_WNI5[c].nama_formal}--> </option>
						<!--{/if}-->
					<!--{/section}-->
				...
				<!--{/if}-->
				 ...
				 <!--{if ($DINA==4)}--> 
					 <!--{section name=u loop=$DATA_JNS_WNI2}-->
						<!--{if  ($DATA_JNS_WNI2[u].kode_jenis_informal) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI2[u].kode_jenis_informal}-->" selected > <!--{$DATA_JNS_WNI2[u].nama_informal}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI2[u].kode_jenis_informal}-->"  > <!--{$DATA_JNS_WNI2[u].nama_informal}--> </option>
						<!--{/if}-->
				...
				<!--{if ($DINA==6)}--> 
					 <!--{section name=l loop=$DATA_JNS_WNI7}-->
						<!--{if trim($DATA_JNS_WNI7[l].kode_jenis_abk) == $EDIT_KODE_JENIS}-->
						<option value="<!--{$DATA_JNS_WNI7[l].kode_jenis_abk}-->" selected > <!--{$DATA_JNS_WNI7[l].nama_abk}--> </option>
						<!--{else}-->
						<option value="<!--{$DATA_JNS_WNI7[l].kode_jenis_abk}-->"  > <!--{$DATA_JNS_WNI7[l].nama_abk}--> </option>
						<!--{/if}-->
					<!--{/section}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr>
											...
											<th class="tdatahead" align="left" width="20%">Nama Pegawai</TH>
											<th class="tdatahead" align="left">Daerah Asal</TH>
											<th class="tdatahead" align="left" width="20%" >Alamat</TH>
											<th class="tdatahead" align="left">Perwakilan</TH>
											<th class="tdatahead" align="left">Klasifikasi </TH>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<!--{if ($DATA_TB[x].kode_sumber==1)}--> WNI NON TKI <!--{/if}--> 
											<!--{if ($DATA_TB[x].kode_sumber==3)}-->  TKI FORMAL <!--{/if}--> 
											<!--{if ($DATA_TB[x].kode_sumber==4)}--> TKI INFORMAL<!--{/if}--> 
											<!--{if ($DATA_TB[x].kode_sumber==6)}-->  TKI ABK <!--{/if}--> 
