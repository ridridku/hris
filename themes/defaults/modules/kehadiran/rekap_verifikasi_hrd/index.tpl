			...
			<TR>
				...
				<TD>:
					...
					<TD>: <SELECT name="bulan" >
							...
							<OPTION value="01" <!--{if $EDIT_T_RKP__BLN==1}-->selected<!--{/if}-->>Januari</OPTION>
							<OPTION value="02" <!--{if $EDIT_T_RKP__BLN==2}-->selected<!--{/if}-->>Februari</OPTION>
                                                        <OPTION value="03" <!--{if $EDIT_T_RKP__BLN==3}-->selected<!--{/if}-->>Maret</OPTION>
                                                        
                                                      
							<OPTION value="04" <!--{if $EDIT_T_RKP__BLN==4}-->selected<!--{/if}-->>April</OPTION>
							<OPTION value="05" <!--{if $EDIT_T_RKP__BLN==5}-->selected<!--{/if}-->>Mei</OPTION>
                                                        <OPTION value="06" <!--{if $EDIT_T_RKP__BLN==6}-->selected<!--{/if}-->>Juni</OPTION>
                                                        
                                                        <OPTION value="07" <!--{if $EDIT_T_RKP__BLN==7}-->selected<!--{/if}-->>Juli</OPTION>
							<OPTION value="08" <!--{if $EDIT_T_RKP__BLN==8}-->selected<!--{/if}-->>Agustus</OPTION>
                                                        <OPTION value="09" <!--{if $EDIT_T_RKP__BLN==9}-->selected<!--{/if}-->>September</OPTION>
...
<!--form_cari--> 			
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" >
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Verifikasi Rekap Data Kehadiran </td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onclick="return checkDelete('engine.php?op=2&id=<!--{$DATA_TB[x].t_rkp__no_mutasi}--> &mod_id=<!--{$MOD_ID}-->&tahun=<!--{$DATA_TB[x].t_rkp__thn}-->&bulan=<!--{$DATA_TB[x].t_rkp__bln}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
...
<div id="panel-footer">
 ...
 <table width="100%">
                    ...
                    <INPUT TYPE="hidden" name="kode_subcab_cari2" value="<!--{$KODE_SUBCAB_CARI2}-->">
