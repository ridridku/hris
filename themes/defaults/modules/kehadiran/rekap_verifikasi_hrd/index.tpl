...
<a class="button" href="#" onclick="return checkEdit('<!--{$SELF}-->?opt=1&id=<!--{$DATA_TB[x].t_rkp__no_mutasi}-->&tahun=<!--{$DATA_TB[x].t_rkp__thn}-->&bulan=<!--{$DATA_TB[x].t_rkp__bln}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');"<!--{if $OPT==1}--> DISABLED <!--{/if}-->><span><img src="<!--{$HREF_IMG_PATH}-->/icon/details.gif" align="absmiddle"> <!--{$BTN_VERIFIKASI}--></span></a>    
...
<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> Rekap Data Kehadiran Oleh HRD</td></tr>
                             ...
                             <!--{if ($JENIS_USER_SES==1)}-->
                                    ...
                                    <!--{else}-->
                                     <select name="jabatan_cari" >
                                        <option value="">[Pilih Jabatan]</option>
                                        <!--{section name=x loop=$DATA_JABATAN}-->
                                        <!--{if trim($DATA_JABATAN[x].r_jabatan__id)==0 and trim($DATA_JABATAN[x].r_jabatan__kategori_cabang)==2}-->
                                        <option value="<!--{$DATA_JABATAN[x].r_jabatan__id}-->" selected > <!--{$DATA_JABATAN[x].r_jabatan__ket}--> </option>
                                        <!--{else}-->
                                        <option value="<!--{$DATA_JABATAN[x].r_jabatan__id}-->"  > <!--{$DATA_JABATAN[x].r_jabatan__ket}--> </option>
                                        <!--{/if}-->
