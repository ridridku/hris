...
<DIV ID="_menuEntry1_1" style="top:10px;width:100%;display:none;position:absolute;">
		...
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> Posting Rekap Oleh HGLM</td></tr>
				...
				<TD>:
					...
					<TD>: 
						...
						<!--{section name=foo start=2016 loop=2021 step=1}-->
 							  <!--{if ($smarty.section.foo.index)==$PERIODE_TAHUN}-->
...
<!--form_cari--> 			
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" >
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0"> Rekap Data Kehadiran Oleh HGLM </td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											<TD width="17" class="tdatacontent-first-col"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
                                                                                        ...
                                                                                        <TD class="tdatacontent"  > <!--{$DATA_TB[x].t_rkp__dinas}--> </TD>
                                                                                         ...
                                                                                         <TD class="tdatacontent"  > <!--{$DATA_TB[x].t_rkp__keterangan}--> </TD>
