...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PENYERAHAN ASURANSI  TKI/WNI </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead">JENIS ASURANSI</TH>
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].jenis_asuransi}--></TD>
...
<TR>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML TKI/WNI YANG MENDAPAT ASURANSI  : </b></td>	
