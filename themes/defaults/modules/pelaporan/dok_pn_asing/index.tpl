...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN DOKUMEN PENGADILAN DARI KEDUTAAN </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead">KEDUTAAN</TH>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML DOKUMEN PENGADILAN DARI KEDUTAAN  : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_dok_asing}--> </td>	
