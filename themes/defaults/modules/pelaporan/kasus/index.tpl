...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PENANGANAN KASUS</td></tr>
		</table>
					...
					<!--{/if}-->
								...
								<TR>
									<TD COLSPAN="2">
										...
										<thead>									 
										<TR>
											<TH class="tdatahead" align="left">DATA WNI/TKI</TH>
											<TH class="tdatahead" align="left">PERWAKILAN</TH>
											<TH class="tdatahead" align="left">SUMBER INFORMASI</TH>
											<TH class="tdatahead" align="left">TANGGAL PENGADUAN</TH>
											<TH class="tdatahead" width="6%" align="left">PERMASALAHAN</TH>
											<TH class="tdatahead" width="6%" align="left">PERMOHONAN BANTUAN</TH>
											<TH class="tdatahead" align="left">TINDAK LANJUT  PWNI-BHI</TH>
											<TH class="tdatahead" align="left">TINDAK LANJUT  PERWAKILAN</TH>
											<TH class="tdatahead" align="left">PENYELESAIAN KASUS</TH>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											Nama : <!--{$DATA_TB[x].nama}--> <BR> 
											No KTP :  <!--{$DATA_TB[x].no_paspor}--> <BR> 
											No Pasport :<!--{$DATA_TB[x].kode_wni}--> <BR> 
											Alamat : <!--{$DATA_TB[x].alamat}--> <BR>
											Daerah Asal : <!--{$DATA_TB[x].nama_kabupaten}--> <BR> 
											</TD>

											<TD class="tdatacontent"    ><!--{$DATA_TB[x].nm_perwakilan}--></TD>

											<TD class="tdatacontent"    ><!--{$DATA_TB[x].sumber_informasi}--></TD>
											<TD class="tdatacontent"    >
											...
											<TD class="tdatacontent"  > <b><!--{$DATA_TB[x].kronologis_permasalahan}-->   </b></TD>
												<TD class="tdatacontent"  > <b><!--{$DATA_TB[x].bantuan}-->   </b></TD>
											<TD class="tdatacontent"  >
