...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
								...
								<TD>
                                                         ...
                                                         <TR>
                                                                ...
                                                                <TD>
                                                                            ...
                                                                            <!--{if trim($DATA_JENIS[x].r_jenis__id)==0}-->
                                                          ...
                                                          <TR>
                                                                ...
                                                                <TD>
                                                                            ...
                                                                            <option value="">[Dipinjam/Kembali]</option>
		...
		<tr><td class="tcat">LAPORAN REKAP INVENTARIS </td></tr>
		</table>
									...
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" align="left">DEPARTEMEN</TH>
                                                                                        <TH class="tdatahead" align="left">JENIS BARANG</TH>
                                                                                        <TH class="tdatahead" align="left">NAMA BARANG</TH>
                                                                                        <TH class="tdatahead" align="left">KODE BARANG</TH>
                                                                                        <TH class="tdatahead" align="left">NO INVENTARIS</TH>
                                                                                        
                                                                                        <TH class="tdatahead" align="left">TGL PINJAM </TH>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent"><!--{$DATA_TB[x].r_dept__ket}--></TD>
                                                                                        ...
                                                                                        <TD class="tdatacontent"><!--{$DATA_TB[x].r_inventaris__kode}--></TD>
                                                                                        ...
                                                                                        <TD class="tdatacontent">
                                                                                            ...
                                                                                            <font style="color: #006600">Kembali</font>
                                                                                             <!--{else}-->
                                                                                             <font style="color: #ff0000">Dipinjam</font
                                                                                             <!--{/if}-->
                                                                                        </TD>
