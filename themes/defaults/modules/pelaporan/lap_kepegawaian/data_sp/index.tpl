                ...
                <TR>
                    <TD>Cabang <font color="#ff0000">*</font>
						...
						<!--{section name=foo start=2010 loop=2021 step=1}-->
 							  <!--{if ($smarty.section.foo.index)==$TAHUN_SESSION}-->
									...
									<TD COLSPAN="2">
										...
										<!--{section name=x loop=$DATA_TB}-->
											...
											<TD class="tdatacontent"><!--{$DATA_TB[x].r_dept__ket}--></TD>
                                                                                        ...
                                                                                        <TD class="tdatacontent"> <!--{$DATA_TB[x].t_sp__tgl|date_format:"%d-%b-%Y"}--></TD>	
                                                                                        <TD class="tdatacontent"> <!--{$DATA_TB[x].t_sp__tgl_expired|date_format:"%d-%b-%Y"}--></TD>
										...
										<Td class="tdatahead"  colspan="1"  align=" " > <!--{$DATA_TB4[y].total_orang}--> Orang </td>	
                                                                                <!--{/section}-->
										</TR>
