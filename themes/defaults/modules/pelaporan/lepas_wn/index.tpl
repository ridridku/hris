...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN TKI/WNI MELEPASKAN KEWARGANEGARAAN</td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >TANGGAL LAHIR</TH>
											<TH class="tdatahead" >NEGARA</TH>
											<TH class="tdatahead" >ASAL KEPINDAHAN</TH>
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<!--{if ( $$DATA_TB2[y].jk == 1 ) }-->
															<TD class="tdatacontent"   nowrap>Laki - laki</TD>
															<!--{else}-->
															<TD class="tdatacontent"   nowrap>Perempuan</TD>
															<!--{/if}-->
															
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_lahir}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_negara}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_kabupaten}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].alamat_tujuan}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="4" align="right" ><b>JML TKI/WNI MELEPASKAN KEWARGANEGARAAN  : </b></td>	
											<Td class="tdatahead"  colspan="2"   align=" " > <!--{$DATA_TB[x].jml_lepas_wn}--> </td>	
