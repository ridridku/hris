...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
				...
				<TR>
							...
							<TD>
								...
								<SELECT name="kode_perwakilan_asing"  style="width:200px" > 				  
		...
		<tr><td class="tcat">PENYAMPAIAN DOKUMEN PENGADILAN DARI KEDUTAAN ASING </td></tr>
		</table>
				...
				<!--{/if}-->
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_perwakilan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat_diplomatik}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_terpanggil}--></TD>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_nota}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML PENYAMPAIAN DOKUMEN PENGADILAN DARI KEDUTAAN ASING : </b></td>	
