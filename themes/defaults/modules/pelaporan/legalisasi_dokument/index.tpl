...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN LEGALISASI DOKUMEN </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >TANGGAL STEMPEL</TH>
											...
											<TH class="tdatahead">DAERAH ASAL</TH>
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tanggal_stempel}--></TD>
															<TD class="tdatacontent" nowrap> 
											<!--{if ($DATA_TB2[y].kode_jenis_dok==1)}--> Akte Cerai <!--{/if}--> 
											<!--{if ($DATA_TB2[y].kode_jenis_dok==2)}--> Akte Kelahiran <!--{/if}--> 
											<!--{if ($DATA_TB2[y].kode_jenis_dok==3)}--> Akte Kematian <!--{/if}--> 
											<!--{if ($DATA_TB2[y].kode_jenis_dok==4)}--> Akte Lain <!--{/if}--> 
											</TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>TOTAL LEGALISASI DOKUMEN  : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_dokument}--> </td>	
