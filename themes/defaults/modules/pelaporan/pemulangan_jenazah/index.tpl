...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PEMULANGAN JENAZAH </td></tr>
		</table>
				...
				<!--{/if}-->
								...
								<TR>
									<TD COLSPAN="2">
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_bast}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>TOTAL PEMULANGAN JENAZAH : </b></td>	
