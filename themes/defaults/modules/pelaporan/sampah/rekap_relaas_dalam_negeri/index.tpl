		...
		<TABLE id="table-search-box">
						...
						<OPTION VALUE="" selected>[Pilih Tahun]</OPTION>
							...
							<TD>  
								...
								<select name="kode_asal"  onChange="cari_item_detail(frmList1.kode_asal.value, frmList1.no_propinsi.value);" > 
...
<TR>
					<TD>Propinsi</TD>
					<TD> 	<select name="no_propinsi" onChange="cari_item_detail(frmList1.kode_asal.value, frmList1.no_propinsi.value);" > 
		...
		<tr><td class="tcat">REKAP RELAAS DALAM NEGERI</td></tr>
		</table>
		...
		<table width="100%" >
				...
				<!--{if ( $JENIS_PANGGIl !='' ) }-->
											...
											<tr><td class="tdatacontent"  >JENIS PANGGIL </td><td> : </td><td>
				...
				<!--{/if}-->
				 ...
				 <!--{if ( $ASAL !='' ) }-->
											...
											<tr><td class="tdatacontent"  >ASAL PENGADILAN </td><td> : </td><td>
				...
				<!--{/if}-->
				  ...
				  <!--{if ( $NAMA_PROPINSI !='' ) }-->
											...
											<tr><td class="tdatacontent"  >PROPINSI </td><td> : </td><td>
				...
				<!--{/if}-->
				 ...
				 <!--{if ( $NAMA_PN !='' ) }-->
											...
											<tr><td class="tdatacontent"  >NAMA PENGADILAN </td><td> : </td><td>
				...
				<!--{/if}-->
								...
								<br>
									...
									<div style="position:relative;float:right;margin-top:20;"><INPUT TYPE="text" NAME="print_desc" class="text_transparent" style="background:transparant;border:0;">
									 <IMG SRC="<!--{$HREF_IMG_PATH}-->/grafik.jpg"  width="55"  height="55" style="cursor:pointer" align="absmiddle"   onMouseOver="document.frmList.print_desc.value='Grafik';"  onclick="window.open('../../../libchart/grafik/rekap_relaas_dalam_negeri.php?<!--{$VAR_CARI}-->',null,'height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')" >
									&nbsp;&nbsp;
