...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PENGUBURAN JENAZAH DI LUAR NEGERI</td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >TANGGAL DIKUBUR</TH>
											<TH class="tdatahead">TEMPAT PENGUBURAN</TH>		
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_penguburan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tempat_penguburan}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>TOTAL   JENAZAH YANG DIKUBUR DI LUAR NEGERI: </b></td>	
