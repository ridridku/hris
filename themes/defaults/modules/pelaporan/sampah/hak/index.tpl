...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PENYERAHAN HAK  TKI/WNI </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead">JENIS KELAMIN</TH>
											<TH class="tdatahead" >PERWAKILAN</TH>
											<TH class="tdatahead" >TANGGAL PENYERAHAN</TH>
											<TH class="tdatahead">JENIS HAK</TH>
											<TH class="tdatahead">JUMLAH VALAS</TH>
											<TH class="tdatahead">EKUIVALENT RUPIAH</TH>

											<TH class="tdatahead">JENIS KASUS</TH>
											<TH class="tdatahead">NO BAST</TH>
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap>
															  <!--{if ($DATA_TB2[y].jk==1)}--> Perempuan <!--{/if}--> 
															   <!--{if ($DATA_TB2[y].jk==2)}--> Laki-Laki  <!--{/if}--> 														
															   </TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nm_perwakilan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_penyerahan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].jenis_hak}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].valas}--> <!--{$DATA_TB2[y].jumlah}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].ekuivalent_rp}--></TD>
															<TD class="tdatacontent"   nowrap>
															
															<!--{section name=i loop=$DATA_TB3}-->
														...
														<!--{/section}--> 
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_bast}--></TD>
															<TD class="tdatacontent"    ><!--{$DATA_TB2[y].keterangan}--></TD>
													...
													<!--{/section}-->
<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML NILAI EKUIVALENT RUPIAH : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_rp}--> </td>	

										</TR>
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML TKI/WNI YANG MENDAPAT HAK : </b></td>	
