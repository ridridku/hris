...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
	 ...
	 <TR>
		...
		<tr><td class="tcat">REKAP DEPORTASI/REPATRIASI/EVAKUASI</td></tr>
		</table>
		...
		<table width="100%" >
				...
				<!--{/if}-->
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >JUMLAH DEPORTASI</TH>
											<TH class="tdatahead" >JUMLAH REPATRIASI</TH>
											<TH class="tdatahead" >JUMLAH EVAKUASI</TH>
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].orang2}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].orang3}--></TD>
										...
										<TR>
											...
											<Td class="tdatahead"   align="left" ><!--{$TOTAL_ORANG2}--> </td>
											<Td class="tdatahead"   align="left" ><!--{$TOTAL_ORANG3}--> </td>
								...
								<br>
											...
											<TH class="tdatahead" >JUMLAH EVAKUASI</TH>
												...
												<!--{section name=y loop=$DATA_TB3}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB3[y].orang2}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB3[y].orang3}--></TD>
									...
									<IMG SRC="<!--{$HREF_IMG_PATH}-->/grafik.jpg"  width="55"  height="55" style="cursor:pointer" align="absmiddle"   onMouseOver="document.frmList.print_desc.value='Grafik';"  onclick="window.open('../../../libchart/grafik/rekap_deportasi.php?<!--{$VAR_CARI}-->',null,'height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')" >
									&nbsp;&nbsp;
