...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
				...
				<TR>
					...
					<div id="ajax_kabupaten">
								...
								<SELECT name="kode_sub_jenis_pelayanan"  style="width:200px"  > 				  
		...
		<tr><td class="tcat">REKAP PELAYANAN DAN PERLINDUNGAN</td></tr>
		</table>
...
<!--{if ( $BULAN!='' ) }-->
				...
				<!--{/if}-->
				 ...
				 <!--{if ( $NAMA_JENIS_PELAYANAN !='' ) }-->


											<tr><td class="tdatacontent"  >JENIS PELAYANAN </td><td> : </td><td>
											 								
											<!--{$NAMA_JENIS_PELAYANAN}--> &nbsp;</td></tr>
				<!--{/if}-->
				 ...
				 <!--{if ( $NAMA_PELAYANAN !='' ) }-->
											...
											<tr><td class="tdatacontent"  >PELAYANAN </td><td> : </td><td>
											 								
											<!--{$NAMA_PELAYANAN}--> &nbsp;</td></tr>
				<!--{/if}-->
								...
								<br>
									...
									<IMG SRC="<!--{$HREF_IMG_PATH}-->/grafik.jpg"  width="55"  height="55" style="cursor:pointer" align="absmiddle"   onMouseOver="document.frmList.print_desc.value='Grafik';"  onclick="window.open('../../../libchart/grafik/rekap_pelayanan.php?<!--{$VAR_CARI}-->',null,'height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')" >
									&nbsp;&nbsp;
