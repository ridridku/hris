...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
				...
				<TR>
						...
						<OPTION VALUE="" selected>[Pilih Tahun]</OPTION>
							...
							<TD>  							
								 <select name="kode_jenis_panggil" >
								 <option value="">[Pilih Kategori]</option>
								 <option value="1"<!--{if ($EDIT_KODE_JENIS_PANGGIL==1)}--> selected <!--{/if}--> >WNI</option>
								 <option value="2"<!--{if ($EDIT_KODE_JENIS_PANGGIL==2)}--> selected <!--{/if}--> >Badan Hukum Indonesia (BHI)</option>
								 <option value="3"<!--{if ($EDIT_KODE_JENIS_PANGGIL==3)}--> selected <!--{/if}--> >WNA</option>
								 <option value="4"<!--{if ($EDIT_KODE_JENIS_PANGGIL==4)}--> selected <!--{/if}--> >Badan Usaha Asing  </option>
								</select>
		...
		<tr><td class="tcat">PENYAMPAIAN DOKUMEN PENGADILAN </td></tr>
		</table>
		...
		<table width="100%">				
				 <TR>
				 <TD COLSPAN="2">
				 <table border=0 width="100%"  class="tbheader" >	
				<!--{if ($NM_PERWAKILAN !='') }-->
				 <tr>
				 <td  width="17%" >PERWAKILAN</td>
				 <td width="2%" > : </td>
				 <td  ><!--{$NM_PERWAKILAN}--> &nbsp;</td>
				 </tr>
				<!--{/if}-->
				...
				<!--{/if}-->	
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											<TH class="tdatahead">ASAL PN/PT/PA</TH>
											<TH class="tdatahead">NO SURAT PENGADILAN</TH>
											<TH class="tdatahead">NAMA TERPANGGIL</TH>
											<TH class="tdatahead" >PERWAKILAN</TH>
											<TH class="tdatahead" >NO SURAT KELUAR</TH>
											<TH class="tdatahead" >TANGGAL SURAT KELUAR</TH>
											<TH class="tdatahead" >NO SURAT BALASAN</TH>
											<TH class="tdatahead" >TANGGAL SURAT BALASAN</TH>
											<TH class="tdatahead" >NO SURAT RELAAS</TH>
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_pn}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat_pengadilan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nm_perwakilan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat_keluar}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_surat_keluar}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat_balasan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_surat_balasan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat_releas}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML PENYAMPAIAN DOKUMEN PENGADILAN : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_dok}--> </td>	
