	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
				...
				<TR>
							...
							<TD>Pilihan</TD>
							<TD>					 
								<SELECT name="kode_pilihan"  style="width:200px" > 				  
		...
		<tr><td class="tcat">LAPORAN DEPORTASI/REPATRIASI/EVAKUASI</td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >TANGGAL TIBA</TH>
											<TH class="tdatahead">ENTRY POINT</TH>		
											<TH class="tdatahead">DAERAH ASAL</TH>
									 
											<TH class="tdatahead">NO BAST</TH>
											<TH class="tdatahead">TANGGAL BAST</TH>
											<TH class="tdatahead">PILIHAN <BR> PEMULANGAN</TH>
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_tiba}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].entry_point}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_kabupaten}--></TD>
														 
																<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_sk_pemulangan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_sk}--></TD>
															
															<TD class="tdatacontent"   nowrap><!--{if ($DATA_TB2[y].kode_pilihan==1)}--> Deportasi <!--{/if}-->
															<!--{if ($DATA_TB2[y].kode_pilihan==2)}--> Repatriasi <!--{/if}--> 

															<!--{if ($DATA_TB2[y].kode_pilihan==3)}--> Evakuasi <!--{/if}--> 
