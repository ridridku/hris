...
<DIV ID="_menuEntry2_1" style="width:100%;top:25px;position:absolute;">
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
				...
				<TR>
							...
							<TD>
								...
								<SELECT name="kode_cabang"  style="width:200px" > 				  
								<OPTION VALUE="" selected>[Pilih Cabang]</OPTION>
								<!--{section name=x loop=$DATA_INSTANSI}-->						 
									<!--{if ($DATA_INSTANSI[x].kode_cabang) == $SES_PERWAKILAN}-->
									<option value="<!--{$DATA_INSTANSI[x].kode_cabang}-->" selected  > <!--{$DATA_INSTANSI[x].nama_cabang}--> </option>
									<!--{else}-->
									<option value="<!--{$DATA_INSTANSI[x].kode_cabang}-->"  > <!--{$DATA_INSTANSI[x].nama_cabang}--> </option>
									<!--{/if}-->
									<!--{/section}-->
								</SELECT>
		...
		<!--{if $KODE_WNI==""}-->
				...
				<tr><td class="tcat">LAPORAN DATA PEGAWAI </td></tr>
				</table>
				...
				<!--{/if}-->
				 ...
				 <!--{/if}--> 
												...
												<TR>
														...
														<!--{section name=y loop=$DATA_TB2}-->
															...
															<TR>
																	...
																	<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].departemen}--></TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap> <!--{$DATA_TB2[y].jabatan}--> </TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap> <!--{$DATA_TB2[y].nama_cabang}--> </TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap> <!--{$DATA_TB2[y].nama_status}--> </TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap>  <!--{$DATA_TB2[y].tgl_masuk}--></TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap> <!--{$DATA_TB2[y].tgl_kontrak_awal}--> </TD>
                                                                                                                                        <TD class="tdatacontent"  nowrap> <!--{$DATA_TB2[y].tgl_kontrak_akhir}--> </TD>
												...
												<TR><!--{section name=y loop=$DATA_TB4}-->
													<Td class="tdatahead" colspan="7" align="right" ><b>TOTAL PEGAWAI : </b></td>	
