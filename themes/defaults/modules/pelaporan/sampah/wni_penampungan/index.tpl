...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN TKI/WNI DI PENAMPUNGAN </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB2[y].tgl_keluar}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB2[y].nama_kabupaten}--> </TD>
												...
												<TD class="tdatacontent" nowrap> <!--{$DATA_TB2[y].statusa}--> </TD>
													</TR>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML TKI/WNI DI PENAMPUNGAN  : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_wni}--> </td>	
