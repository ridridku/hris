...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
							  ...
							  <TR>
							<TD>Tampilkan Berdasarkan</TD>
							<TD>
					 
								<SELECT name="kode_tampil" style="width:200px" onchange="cari_kab(this.value);"  > 				  
							...
							<TD>
								<div id="ajax_kawasan">
									<SELECT name="kode_kawasan" style="width:200px"  disabled> 				  
							...
							<TD>	
							<div id="ajax_negara">
								<SELECT name="kode_negara" style="width:200px"  disabled> 				  
...
<!--{if ( $BULAN!='' ) }-->
				...
				<!--{/if}-->
							 ...
							 <input name="Button" type="button" class="button" style="cursor: hand;" onclick="goDetailBaik('<!--{$DATA_TB2[y].kode_perwakilan}-->','<!--{$TAHUN}-->','<!--{$BULAN}-->','<!--{$KODE_KASUS}-->')" value=" <!--{$DATA_TB2[y].orang}--> " /> 
								...
								<br>
												...
												<!--{section name=y loop=$DATA_TB3}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap>
															 ...
															 <input name="Button" type="button" class="button" style="cursor: hand;" onclick="goDetailKawasan('<!--{$DATA_TB3[y].kode_kawasan}-->','<!--{$TAHUN}-->','<!--{$BULAN}-->','<!--{$KODE_KASUS}-->')" value=" <!--{$DATA_TB3[y].orang}--> " /> 
									...
									<IMG SRC="<!--{$HREF_IMG_PATH}-->/grafik.jpg"  width="55"  height="55" style="cursor:pointer" align="absmiddle"  onMouseOver="document.frmList.print_desc.value='Grafik';"  onclick="window.open('../../../libchart/grafik/rekap_kasus.php?<!--{$VAR_CARI}-->',null,'height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')" >
									&nbsp;&nbsp;
