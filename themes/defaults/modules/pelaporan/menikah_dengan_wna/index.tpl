...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN  WNI MENIKAH DENGAN WNA</td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >ALAMAT di LN</TH>
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_wna}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="5" align="right" ><b>JML TKI/WNI YANG MENIKAH  : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_nikah}--> </td>	
