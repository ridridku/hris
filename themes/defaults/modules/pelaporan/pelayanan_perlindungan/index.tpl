...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PELAYANAN </td></tr>
		</table>
		...
		<table width="100%" >
				...
				<!--{if ($NM_PERWAKILAN !='') }-->
				 <tr><td class="tdatacontent"  width="100" >PERWAKILAN</td>
				 <td width="5"> : </td>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<!--{section name=x loop=$DATA_TB}-->
										 ...
										 <TR>
											<Td class="tdatahead" ><b>PELAYANAN 								
										 
										   <!--{$DATA_JENIS_PELAYANAN[x].nama_jenis_pelayanan}-->
										...
										<TR>
											...
											<TH class="tdatahead">NAMA PELAYANAN </TH> 
											<TH class="tdatahead">PERWAKILAN </TH> 
											<TH class="tdatahead">NAMA PEMOHON </TH>
											<TH class="tdatahead">NO SURAT/DOKUMEN </TH>
											...
											<TH class="tdatahead" >KETERANGAN </TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
												  <!--{if ($DATA_TB2[y].nama_jenis_pelayanan==$DATA_TB[x].nama_jenis_pelayanan)}-->
													
													<TR>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_pelayanan}--></TD>
															 
															<TD class="tdatacontent" nowrap> <!--{$DATA_TB2[y].nm_perwakilan}--> </TD>
															 
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama}--></TD>
															
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].no_surat}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_pelayanan}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="5" align="right" ><b>TOTAL PELAYANAN : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB[x].jml_pelayanan}-->  </td>	
