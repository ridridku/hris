...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN REKAP PENYERAHAN ASURANSI </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >JUMLAH EKUIVALENT RUPIAH</TH>										 
										</TR> 	
											 
												<!--{section name=x loop=$DATA_TB}-->														
													<TR>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB[x].nm_perwakilan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB[x].jumlah}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB[x].jumlah_ekuivalent}--></TD>
													</TR>
											...
											<TR>
											<Td class="tdatahead"  align="right" ><b>TOTAL : </b></td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB3[z].tot_wni}--> </td>	
											<Td class="tdatahead"   align=" " > <!--{$DATA_TB3[z].tot_ekuivalent}--> </td>
										</TR>
										<!--{/section}-->
										...
										<TR>
											...
											<TH class="tdatahead" >JUMLAH EKUIVALENT RUPIAH</TH>										 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].nama_kawasan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].jumlah}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].jumlah_ekuivalent}--></TD>
													</TR>
									...
									<div style="position:relative;float:right;margin-top:20;"><INPUT TYPE="text" NAME="print_desc" class="text_transparent" style="background:transparant;border:0;">
									 <IMG SRC="<!--{$HREF_IMG_PATH}-->/grafik.jpg"  width="55"  height="55" style="cursor:pointer" align="absmiddle"   onMouseOver="document.frmList.print_desc.value='Grafik';"  onclick="window.open('../../../libchart/grafik/rekap_penyerahan_asuransi.php?<!--{$VAR_CARI}-->',null,'height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,left=0,top=0,screenX=0,screenY=0')" >
									 &nbsp;&nbsp;
