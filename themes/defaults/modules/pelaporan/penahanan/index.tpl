...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<tr><td class="tcat">LAPORAN PENAHANAN TKI/WNI </td></tr>
		</table>
								...
								<TR>
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" >TANGGAL DITAHAN</TH>											 
											<TH class="tdatahead">TEMPAT PENAHANAN</TH>
											...
											<TH class="tdatahead">KETERANGAN</TH>											 
												...
												<!--{section name=y loop=$DATA_TB2}-->
													...
													<TR>
															...
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tempat_penahanan}--></TD>
															<TD class="tdatacontent"   nowrap><!--{$DATA_TB2[y].tgl_ditahan}--></TD>
										...
										<TR>
											<Td class="tdatahead" colspan="7" align="right" ><b>JML TKI/WNI YANG DITAHAN  : </b></td>	
