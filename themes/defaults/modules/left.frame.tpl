...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>
<A HREF="javascript:checkFrame('FrameImg');" TITLE="Show/Hide Menu"><IMG ID="FrameImg" NAME="FrameImg" src="<!--{$HREF_IMG_PATH}-->/layout/mini-left2.gif" BORDER="0"></A></TD>
</td>
  </tr>
</table>
</body>
...
var openImg = new Image();
        openImg.src = "<!--{$HREF_IMG_PATH}-->/layout/mini-right2.gif"
var closeImg = new Image();
        closeImg.src = "<!--{$HREF_IMG_PATH}-->/layout/mini-left2.gif"
