...
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdn.datatables.net/buttons/1.2.4/js/buttons.flash.min.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdnjs.cloudflare.com/ajax/libs/jszip/2.5.0/jszip.min.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdn.rawgit.com/bpampuch/pdfmake/0.1.24/build/pdfmake.min.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdn.rawgit.com/bpampuch/pdfmake/0.1.24/build/vfs_fonts.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdn.datatables.net/buttons/1.2.4/js/buttons.html5.min.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="https://cdn.datatables.net/buttons/1.2.4/js/buttons.print.min.js"></SCRIPT>
...
<table id="payroll" class="display" cellpadding="4" cellspacing="6" width="100%">
    <thead>
        <tr>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>NO</u><br>1 </font></TH>
             <TH class="tdatahead"><Font style="font-size:10;"><u>VERIFIKASI</u><br>2</font></TH>
            <TH class="tdatahead" align="center"><img src="<!--{$HREF_IMG_PATH}-->/icon/tick.png" align="absmiddle"><br>3</TH>   
           
            <TH class="tdatahead"><Font style="font-size:10;"><u>NAMA</u><br>4</font></TH>
             <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>JABATAN STATUS</u><br>5</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>JABATAN</u><br>6</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>LEVEl</u><br>7</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>CABANG</u><br>8</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>SB LOKASI</u><br>9</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>LAMA(BLN)</u><br>10</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>GAJI POKOK</u><br>11</font></TH>
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>T.LAIN-LAIN</u><br>12</font></TH> 
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>T.LAIN-LAIN2</u><br>13</font></TH> 
...
<!--{section name=x loop=$DATA_PJM}-->
           <tr>
            <TD align="center"><!--{$smarty.section.x.index+1}--></td>
            <TD align="center"><!--{if $DATA_PJM[x].verifikasi==1}-->
             <Font color='#450ef9'>Pegawai aktif</Font> <!--{else}--><Font color='#ff0000'>Belum Diverifikasi</Font><!--{/if}-->
            
            </td>
            <TD align="center"><INPUT type="checkbox" name="approval[]" id="check_list" value="<!--{$DATA_PJM[x].r_pegawai__id}-->" > </TD>
            <TD ><input type="hidden"  name="mutasi[]" value="<!--{$DATA_PJM[x].r_pnpt__no_mutasi}-->"><Font style="font-size:12;"><!--{$DATA_PJM[x].r_pegawai__nama}--></TD>
             <TD align="center">
             <!--{if $DATA_PJM[x].status_staf==1}--><Font color='#450ef9'>Non Staff</Font> <!--{else}--><Font color='#ff0000'>Staff</Font><!--{/if}-->
            
             <input type="text" name="cabang__id[]" value="<!--{$DATA_PJM[x].r_cabang__id}-->">
                <input type="text" name="cabang__nama[]" value="<!--{$DATA_PJM[x].r_cabang__nama}-->">   
                <input type="text" name="subcab__id[]" value="<!--{$DATA_PJM[x].r_subcab__id}-->">
                <input type="text" name="subcab__nama[]" value="<!--{$DATA_PJM[x].r_subcab__nama}-->">    
                <input type="text" name="nip[]" value="<!--{$DATA_PJM[x].r_pnpt__nip}-->"> 
            ...
            <TD align="center"><input type="hidden" name="cabang_id[]" value="<!--{$DATA_PJM[x].r_cabang__id}-->"><!--{$DATA_PJM[x].r_cabang__nama}--></TD>
            <TD align="center"><input type="hidden" name="sub_cab[]" value="<!--{$DATA_PJM[x].r_subcab__id}-->"><!--{$DATA_PJM[x].r_subcab__nama}--></TD>
            ...
            <TD align="center" > <input type="text" size="15" name="lain1[]" value="<!--{$DATA_PJM[x].r_gapok__lain1|number_format:0:".":","}-->" onkeyup="formatangka(this)" style="text-align :left;"></TD><!-- lainlain1 -->
                 <TD align="center" > <input type="text" size="15" name="lain1[]" value="<!--{$DATA_PJM[x].r_gapok__lain2|number_format:0:".":","}-->" onkeyup="formatangka(this)" style="text-align :left;"></TD><!-- lainlain1 -->
        </tr>
           <!--{sectionelse}-->
        <TR>
...
<!--form_cari-->
        ...
        <tbody class="tdatacontent">
              <!--{section name=x loop=$DATA_TB}-->
                <TR>
                <TD width="10" class="tdatacontent"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
