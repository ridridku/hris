    ...
    <thead>
        <tr>
          ...
          <TH class="tdatahead" align="center"><img src="<!--{$HREF_IMG_PATH}-->/icon/tick.png" align="absmiddle"><br>B</TH>   
            ...
            <TH class="tdatahead" align="center"><Font style="font-size:10;"><u>GAJI GROSS</u><br>N</font></TH> 
            ...
            <input type="hidden" name="dept__id[]" value="<!--{$DATA_PJM[x].r_dept__id}-->"> 
             ...
             <!--{$DATA_PJM[x].lama_bln}--> </TD>
                       ...
                       aktif</font>
                        ...
                        <TD ><INPUT onkeyup="formatangka(this)" style="text-align :left;" type="text" size="8"  name="gaji_kotor[]" value="<!--{$DATA_PJM[x].gaji_gross|number_format:0:".":","}-->"></TD><!-- GAJI KOTOR -->
                        ...
                        <TD  align="center"><INPUT type="text" size="8"  name="thp[]"  value="<!--{$DATA_PJM[x].gaji_netto|number_format:0:".":","}-->" onkeyup="formatangka(this)" style="text-align :left;"></TD>
