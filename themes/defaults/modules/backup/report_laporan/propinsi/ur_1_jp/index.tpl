					...
					<FORM METHOD=GET ACTION="" NAME="frmList">
						...
						<FONT SIZE="2"><!--{$TB_TAHUN}--> : <!--{$TAHUN}--></FONT></B></TD>
								...
								<TR>
									...
									<tr><td width="120">Sektor</td><td width="5"> : </td><td colspan="2"><!--{$SEKTOR}--></td></tr>
									...
									<tr><td>Propinsi </td><td> : </td><td><!--{$NAMA_PROPINSI}--></td><td align="right"><b>Rencana Kerja dan Anggaran</b></td></tr>									
									</table>
									</TD>
								</TR>														
								<TR>
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
									    <tr>
										    ...
										    <th colspan="11" class="tdatahead">Target Fisik dan Biaya </th>
										    <th colspan="7" class="tdatahead">Rincian Sumber Pembiayaan </th>
										    <th colspan="4" class="tdatahead">Proses Perencanaan </th>
										    <th rowspan="3" class="tdatahead">Kode Kelayakan </th>
										    <th rowspan="3" class="tdatahead">Keterangan</th>
										  </tr>
										  <tr>		
										    <th rowspan="2" class="tdatahead">Nama Pangkal </th>
										    <th rowspan="2" class="tdatahead">Nama Ujung </th>								    
										    ...
										    <th class="tdatahead">PAD 1 (Rp)</th>
										    ...
										    <th colspan="3" class="tdatahead">Status Evaluasi </th>
										  </tr>
										  <tr>
										    
										    <th class="tdatahead">Panjang Proyek (Km) </th>
										    <th class="tdatahead">Status Awal </th>
										    <th class="tdatahead">Status Akhir </th>
										    <th class="tdatahead">Jenis Penanganan </th>
										    <th class="tdatahead">Tipe PKRSN </th>
										    <th class="tdatahead">Lebar PKRSN </th>
										    ...
										    <th class="tdatahead">PJP (Rp) </th>
										    <th class="tdatahead">Jumlah PHLN (Rp) </th>
										    <th class="tdatahead">Nomor Loan </th>
										    <th class="tdatahead">Jumlah</th>
										    <th class="tdatahead">Kode</th>
										    <th class="tdatahead">NPV/Km (Rp) </th>
										    <th class="tdatahead">INPV/Km (Rp) </th>
										    <th class="tdatahead">IRR (%) </th>
										  </tr>		
										  <tbody>				
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].panjang_jalan}--> </B></TD>											
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].sasaran}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].kabupaten}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].panjang_proyek}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].status_awal_jalan}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].status_akhir_jalan}--> </B></TD>
											...
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].lebar_pkrsn}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].biaya_jalan}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].jumlah_jembatan}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent"  align="right" nowrap><B> <!--{$DATA_TB[x].panjang_jembatan}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].biaya_jembatan}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].total_biaya}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].pad1}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].du_dpp}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].pjp_dpp}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].jumlah_loan_phln}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].jenis_loan_phln}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].jumlah_sumber_dana_lain}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].jenis_sumber_dana_lain}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].biaya_per_km}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].npv_per_km}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].inpv_per_km}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].irr}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" align="right" nowrap><B> <!--{$DATA_TB[x].kelayakan}--> </B></TD>											
