					...
					<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
						...
						<FONT SIZE="2"><!--{$TB_TAHUN}--> : <!--{$TAHUN}--></FONT></B></TD>
								<TR>
									...
									<tr><td>Propinsi </td><td> : </td><td><!--{$NAMA_PROPINSI}--></td><td align="right"><b>Rekapitulasi Dokumen Pelaksana Anggaran</b></td></tr>									
									</table>
									</TD>
								</TR>														
								<TR>
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										<TR>
											...
											<TH ROWSPAN="3" class="tdatahead">Jumlah Proyek/Paket (Km)</TH>											
										...
										<TR>											
											...
											<TH align="center" class="tdatahead">Jumlah (Bh)</TH>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].jumlah_proyek_per_paket}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].jumlah_kabupaten}--> </B></TD>											
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].total_panjang_ruas}--> </B></TD>
											<TD bgcolor="<!--{$ROW_CLASSNAME[x]}-->" class="tdatacontent" nowrap><B> <!--{$DATA_TB[x].panjang_proyek_jalan}--> </B></TD>
