								...
								<TR>						
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										...
										<TR>
											...
											<TH class="tdatahead" COLSPAN="2"><!--{$TB_BIAYA}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_METODA_PELAKSANAAN}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_TANGGAL_SPMK}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_RENCANA_PHO}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_WAKTU_PELAKSANAAN}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_PIMPRO}--></TH>	
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KONTRAKTOR}--></TH>	
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_PENGAWAS_LAPANGAN}--></TH>	
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KETERANGAN}--></TH>										
											</TH>
										</TR>
										<TR>
											<TH class="tdatahead"><!--{$TB_TARGET_M}--></TH>
											<!--<TH class="tdatahead"><!--{$TB_TARGET_UNIT}--></TH>-->
											<!--<TH class="tdatahead"><!--{$TB_BIAYA_DAK}--></TH>-->
											<!--<TH class="tdatahead"><!--{$TB_BIAYA_PENDAMPING}--></TH>-->
											<TH class="tdatahead"><!--{$TB_BIAYA_TOTAL}--></TH>
											<TH class="tdatahead"><!--{$TB_SUMBER_PENDANAAN}--></TH>
										</TR>
										<TR>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_NAMA_PAKET[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kecamatan_yg_dilalui}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TARGET_M[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_BIAYA_TOTAL[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].nama_prop_sumber_dana_lain}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].metoda_pelaksanaan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TANGGAL_SPMK[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_RENCANA_PHO[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].waktu_pelaksanaan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].pimpro}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kontraktor}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].pengawas}--> </TD>
