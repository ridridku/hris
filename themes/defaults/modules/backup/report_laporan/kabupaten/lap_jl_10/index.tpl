								...
								<TR>
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										...
										<TR>
										    ...
										    <TH class="tdatahead" rowspan="3">No. Kab./Kota</th>
										    <TH class="tdatahead" rowspan="3">No Ruas</th>
										    <TH class="tdatahead" rowspan="3">Nama Ruas / Jembatan</th>
										    <TH class="tdatahead" colspan="2" rowspan="2">Panjang</th>
										    <TH class="tdatahead" colspan="4">Awal <!--{$TB_TAHUN1}--></th>
										    <TH class="tdatahead" colspan="4">Akhir <!--{$TB_TAHUN2}--></th>
										    <TH class="tdatahead" rowspan="3">Keterangan</th>
										  </tr>
										  <tr>
										    <TH class="tdatahead" colspan="4">Panjang Tiap Kondisi (Km)</th>
										    <TH class="tdatahead" colspan="4">Panjang Tiap Kondisi (Km)</th>
										  </tr>
										  <tr>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun1_baik}--> (<!--{$KONDISI_BAIK[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun1_sedang}--> (<!--{$KONDISI_SEDANG[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun1_rusak}--> (<!--{$KONDISI_RUSAK_RINGAN[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun1_rusak_berat}--> (<!--{$KONDISI_RUSAK_BERAT[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun2_baik}--> (<!--{$KONDISI_BAIK_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun2_sedang}--> (<!--{$KONDISI_SEDANG_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun2_rusak}--> (<!--{$KONDISI_RUSAK_RINGAN_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].tahun2_rusak_berat}--> (<!--{$KONDISI_RUSAK_BERAT_TH2[x]}-->%)</TD>
											-->
											<TD class="tdatacontent" nowrap> <!--{$DATA_PANJANG_KM[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_PANJANG_M[x]}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN1_BAIK[x]}--> (<!--{$KONDISI_BAIK[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN1_SEDANG[x]}--> (<!--{$KONDISI_SEDANG[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN1_RUSAK[x]}--> (<!--{$KONDISI_RUSAK_RINGAN[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN1_RUSAK_BERAT[x]}--> (<!--{$KONDISI_RUSAK_BERAT[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN2_BAIK[x]}--> (<!--{$KONDISI_BAIK_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN2_SEDANG[x]}--> (<!--{$KONDISI_SEDANG_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN2_RUSAK[x]}--> (<!--{$KONDISI_RUSAK_RINGAN_TH2[x]}-->%)</TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TAHUN2_RUSAK_BERAT[x]}--> (<!--{$KONDISI_RUSAK_BERAT_TH2[x]}-->%)</TD>
