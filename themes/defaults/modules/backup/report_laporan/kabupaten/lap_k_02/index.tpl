	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table width="100%">								
								...
								<table width="100%" class="tbheader">																			
									<tr>
										<td width="50">Propinsi </td><td width="5"> : </td><td><!--{$NAMA_PROPINSI}--></td>
										<td width="100">Tahun</td><td width="5">:</td><td width="100"><!--{$SEARCH_YEAR}--></td>
									</tr>			
									<tr>
										<td width="50">Kabupaten/Kota </td><td width="5"> : </td><td><!--{$NAMA_KABUPATEN}--></td>
										<td width="100">Diisi Oleh </td><td width="5">:</td><td width="100"><!--{$DIISI_OLEH}--></td>
									</tr>			
									<tr>
										<td width="50">Kategori Jalan</td><td width="5"> : </td><td colspan="4"><!--{if $NO_JENIS_JALAN=="1"}-->Provinsi<!--{else}-->Kabupaten/ Kota<!--{/if}--></td>
									</tr>									
									</table>
									</TD>
								</TR>														
								<TR>
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										 ...
										 <thead>
										<TR>
										    <TH class="tdatahead">No Ruas</th>
										    <TH class="tdatahead">Nama Ruas</th>
										    <TH class="tdatahead">Panjang (Km)</th>
										    <TH class="tdatahead">Kondisi</th>
										    <TH class="tdatahead">Lebar (m)</th>
										    <TH class="tdatahead">LHR Kendaraan Roda 4 / Tahun</th>
										    <TH class="tdatahead">Kota Utama / Aktivitas yang dilayani</th>
										  </tr>
										...
										<tbody>				
										<TR bgcolor="#999999"><TD class="tdatacontent" height="21" valign="absmiddle" COLSPAN="7">(A) Prioritas nasional, akses ke jalan nasional/propinsi</TD></TR>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											<TD class="tdatacontent" align="right"> <!--{$DATA_TB[x].no_ruas}-->&nbsp;&nbsp;</TD>
											<TD class="tdatacontent"> <!--{$DATA_TB[x].nama_ruas}--> </TD>
											<!-- <TD class="tdatacontent" align="center"> <!--{$DATA_TB[x].panjang}--> </TD> -->
											<TD class="tdatacontent" align="center"> <!--{$DATA_PANJANG[x]}--> </TD>
											<TD class="tdatacontent"> <!--{$DATA_TB[x].kondisi}--> </TD>
											<!-- <TD class="tdatacontent" align="center"> <!--{$DATA_TB[x].lebar}--> </TD> -->
											<TD class="tdatacontent" align="center"> <!--{$DATA_LEBAR[x]}--> </TD>
											<TD class="tdatacontent" align="center"> <!--{$DATA_TB[x].lhr_roda_4}--> </TD>
											<TD class="tdatacontent"> <!--{$DATA_TB[x].kota_aktivitas_dilayani}--> </TD>
											</TR>
										<!--{/if}-->
										<!--{/section}-->
										<TR bgcolor="#999999"><TD class="tdatacontent" height="21" valign="absmiddle" COLSPAN="7">(B) Prioritas nasional, ruas-ruas jalan di daerah perbatasan, pulau-pulau kecil, rawan bencana, dll.</TD></TR>
										<!--{section name=x loop=$DATA_TB}-->
										
										<!--{if $DATA_TB[x].kelompok_prioritas=="B"}-->
										
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_TB[x].no_ruas}-->&nbsp;&nbsp;</TD>
											...
											<TD class="tdatacontent" align="center" nowrap> <!--{$DATA_TB[x].lhr_roda_4}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kota_aktivitas_dilayani}--> </B></TD>
										</TR>
										<!--{/if}-->
										<!--{/section}-->
										</tbody>
