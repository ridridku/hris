								...
								<TR>
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										...
										<TR>
											...
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KESESUAIAN_RD_DAK}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KESESUAIAN_RD}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_ALASAN}--></TH>
											<TH class="tdatahead" COLSPAN="3"><!--{$TB_KELENGKAPAN_DOKUMEN}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KETERANGAN}--></TH>										
											</TH>
										</TR>
										<TR>
											<TH class="tdatahead"><!--{$TB_GAMBAR}--></TH>
											<TH class="tdatahead"><!--{$TB_SPESIFIKASI}--></TH>
											<TH class="tdatahead"><!--{$TB_RAB}--></TH>											
										</TR>
										<TR>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].rd_dak}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].rd}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].alasan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kelengkapan_gambar}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kelengkapan_spesifik}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].kelengkapan_rab}--> </TD>
