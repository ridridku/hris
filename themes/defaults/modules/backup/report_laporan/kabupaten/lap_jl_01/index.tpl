	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table width="100%">
								<TR>
									...
									<tr><td width="50">Kategori Jalan</td><td width="5"> : </td><td colspan="2"><!--{if $NO_JENIS_JALAN=="1"}-->Provinsi<!--{else}-->Kabupaten/ Kota<!--{/if}--></td></tr>
								...
								<TR>
									...
									<TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
										...
										<TR>
											...
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_TITIK_PENGENAL_PANGKAL}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_TITIK_PENGENAL_UJUNG}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_NAMA_KECAMATAN}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_PANJANG_RUAS}--></TH>
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_LEBAR_RATA_RATA}--></TH>
											<TH class="tdatahead" COLSPAN="6"><!--{$TB_PANJANG_PERMUKAAN}--></TH>	
											<TH class="tdatahead" ROWSPAN="2"><!--{$TB_KETERANGAN}--></TH>										
											</TH>
										</TR>
										<TR>
											<TH class="tdatahead"><!--{$TB_TANAH}--></TH>
											<TH class="tdatahead"><!--{$TB_KERIKIL}--></TH>
											<TH class="tdatahead"><!--{$TB_PENETRASI_MACADAM}--></TH>
											<TH class="tdatahead"><!--{$TB_HOT_MIX}--></TH>
											<TH class="tdatahead"><!--{$TB_BETON_SEMEN}--></TH>
											<TH class="tdatahead"><!--{$TB_LAIN_LAIN}--></TH>
										</TR>
										<TR>
											...
											<TH class="tdatahead" align="center">15</TD>
											<TH class="tdatahead" align="center">16</TD>
										</TR>
										</thead>	
										<tbody>									
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_TB[x].no_kabupaten}--> </TD>
											...
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_PANJANG[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_LEBAR[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_TANAH[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_KERIKIL[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_PENETRASI_MACADAM[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_HOT_MIX[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_BETON_SEMEN[x]}--> </TD>
											<TD class="tdatacontent" align="right" nowrap> <!--{$DATA_LAIN_LAIN[x]}--> </TD>
