...
<!--{/if}-->
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<table width="100%">									
								...
								<TR>
									...
									<tr><td colspan="6" align="center"><b></b><br></td></tr>
									<tr>
										<td width="50">Propinsi </td>
										<td width="5"> : </td>
										<td><!--{$NAMA_PROPINSI}--></td>
										<td width="110">Triwulan ke </td>
										<td width="5">:</td>
									...
									<tr valign="top">
										...
										<td width="110">Status Progres</td>
										<td width="5">:</td>
										<td width="100"><!--{$STATUS_PROGRES}--></td>
									</tr>
									<tr>
    ...
    <TH class="tdatahead" rowspan="2">LHR (Lintas Harian Rata-rata)</th>
    <TH class="tdatahead" colspan="7">Pekerjaan Jalan</th>
    <TH class="tdatahead" rowspan="2">Keterangan</th>
  </tr>
  <tr>
    <TH class="tdatahead">Perkerasan</th>
    <TH class="tdatahead">Bahu</th>
    <TH class="tdatahead">Drainase</th>
    <TH class="tdatahead">Trotoar</th>
    <TH class="tdatahead">Pagar Pengaman</th>
    <TH class="tdatahead">Talud</th>
    <TH class="tdatahead">Lainnya</th>
  </tr>
  <tr>
    ...
    <TH class="tdatahead">10</th>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_perkerasan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_bahu}--> </TD>											
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_drainase}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_trotoar}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_pengaman}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_talud}--> </TD>											
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].jalan_lain}--> </TD>											
