		...
		<table width="100%">								
								...
								<TR>
									...
									<tr valign="top">
										...
										<td width="120">Status Progres</td>
										<td width="5">:</td>
									...
									<TD COLSPAN="2"><TABLE ALIGN="CENTER" WIDTH="100%"  cellspacing="1" cellpadding="2">										
									   <thead>
										<TR>
										    ...
										    <TH class="tdatahead">Nama Paket (Ruas Jalan/Jembatan)</th>
										    <TH class="tdatahead">Masalah Pelaksanaan di Lapangan</th>
										    <TH class="tdatahead">Upaya Pemecahan Masalah yang dihadapi</th>
										    <TH class="tdatahead">Instansi Terkait</th>
										    <TH class="tdatahead">Status Perkembangan Penyelesaian Masalah</th>
										  </tr>
										  <tr>
										...
										<TR onmouseover="setPointer(this, <!--{$INITSET[x]}-->, 'over', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmouseout="setPointer(this, <!--{$INITSET[x]}-->, 'out', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');" onmousedown="setPointer(this, <!--{$INITSET[x]}-->, 'click', '<!--{$ROW_CLASSNAME[x]}-->', '#CCFFCC', '#FFCC99');">
											...
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].pemecahan}--> </TD>
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].instansi}--> </TD>											
											<TD class="tdatacontent" nowrap> <!--{$DATA_TB[x].status_perkembangan}--> </TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
