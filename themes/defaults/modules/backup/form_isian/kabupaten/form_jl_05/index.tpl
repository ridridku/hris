...
<TABLE id="table-add-box">
<tr valign="top">
<td colspan="2" width="200">Nama Paket (Ruas Jalan)</td>
<td>
...
<td>Unit</td>
<td><input type="text" name="target_unit" value="<!--{$TARGET_UNIT}-->" OnKeyUp="validateNum(this)"></td>
</tr>
-->
<tr>
...
<!--{if $STATUS_ERROR==2}--><BR><BR><p align="center">DATA SUDAH DIKIRIM</p> <!--{/if}-->
