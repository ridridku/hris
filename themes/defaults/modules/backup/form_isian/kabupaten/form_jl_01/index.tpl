...
<table id="table-add-box">
<tr>
<td width="150">Nomor Ruas</td>
<td>
  <div id="ajax_no_ruas">
    <input type="text" readonly id="no_ruas" name="no_ruas" maxlength="25" 
	OnKeyUp="get_data_ruas(<!--{$NO_PROPINSI|default:0}-->,<!--{$NO_KABUPATEN|default:0}-->,this.value)" 
	value="<!--{$NO_RUAS}-->"> 
	<!--{if $TOTAL_RUAS_JALAN>0}-->
	  <img src="<!--{$HREF_IMG_PATH}-->/icon/table.gif" border="0" 
	  title="Tampilkan Data Ruas Jalan" 
	  onclick="showRuas();" 
	  class="imgLink" align="absmiddle">
	<!--{/if}-->
  </div>
...
<tr><td>Nama Ruas</td><td><div id="ajax_nama_ruas">

<input name="nama_ruas" type="text" value="<!--{$NAMA_RUAS}-->" size="35" maxlength="200" readonly></td></tr>

<!-- Tambahan 05-06-2010 -->
<tr><td>Kategori Jalan</td><td>
<!-- <div id="ajax_hidden_jns_jln">
<INPUT readOnly TYPE="hidden" name="txt_hidden_jns_jln" value="<!--{$ID_HIDDEN_JSN_JLN}-->"></div> -->

<div id="ajax_hidden_jns_jln">
<INPUT TYPE="hidden" name="txt_hidden_jns_jln" value="<!--{$ID_HIDDEN_JSN_JLN}-->"></div>

<div id="ajax_jns_jln">
<input name="txt_jns_jln" type="text" value="<!--{$PID_JENIS_JLN2}-->" size="35" maxlength="200" readonly></div>

</td></tr>
<!-- End 0f Tambahan 05-06-2010 -->

<tr><td>Titik Pengenal Pangkal</td><td><div id="ajax_titik_pangkal">
<INPUT name="titik_pengenal_pangkal" type="text" value="<!--{$TITIK_PENGENAL_PANGKAL}-->" size="35" maxlength="200" readonly></td></tr>
<tr><td>Titik Pengenal Ujung</td><td><div id="ajax_titik_ujung">

<INPUT name="titik_pengenal_ujung" type="text" value="<!--{$TITIK_PENGENAL_UJUNG}-->" size="35" maxlength="200" readonly></td></tr>
...
<tr><td>Panjang Ruas (Km)</td><td><div id="ajax_panjang_ruas"><input type="text" name="panjang" value="<!--{$PANJANG}-->" OnKeyUp="validateNum(this)" readOnly></td></tr>
<tr><td>Lebar Rata-rata (m)</td><td><div id="ajax_lebar_ruas"><input readOnly type="text" name="lebar" value="<!--{$LEBAR}-->" OnKeyUp="validateNum(this)" readOnly></td></tr>
</table>

<div id="title-box2">Panjang Tiap Jenis Permukaan (Km)</div>

<table id="table-add-box">
<tr><td width="150">Tanah</td><td><input type="text" name="tanah" value="<!--{$TANAH}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td>Kerikil</td><td><input type="text" name="kerikil" value="<!--{$KERIKIL}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td>Aspal (Penetrasi Macadam)</td><td><input type="text" name="penetrasi_macadam" value="<!--{$PENETRASI_MACADAM}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td>Aspal (Hot Mix)</td><td><input type="text" name="hot_mix" value="<!--{$HOT_MIX}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td>Beton (Semen)</td><td><input type="text" name="beton_semen" value="<!--{$BETON_SEMEN}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td>Lain-lain</td><td><input type="text" name="lain_lain" value="<!--{$LAIN_LAIN}-->" onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang.value)-(document.frmCreate.tanah.value)-(document.frmCreate.kerikil.value)-(document.frmCreate.penetrasi_macadam.value)-(document.frmCreate.hot_mix.value)-(document.frmCreate.beton_semen.value)-(document.frmCreate.lain_lain.value)"></td></tr>
<tr><td></td><td><input type="text" name="totalP" value="<!--{$TotalP}-->"></td></tr> 
