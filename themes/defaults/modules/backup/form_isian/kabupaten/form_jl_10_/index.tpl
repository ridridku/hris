...
<td><div id="ajax_panjang_ruas"><input type="text" name="panjang_km" value="<!--{$PANJANG_KM}-->" onChange="document.frmCreate.panjang_m.value=this.value*1000" readonly></div>
</td>
</tr>

<tr>
<td colspan="2">Panjang (m)</td>
<td><div id="id_tahun1"><input type="text" name="tahun1" value="<!--{$PANJANG_M}-->" readonly></div></td>
</tr>
<tr>
<td colspan="2">Akhir Tahun I</td>
<td><div id=""><input type="text" name="tahun1" value="<!--{$TAHUN1}-->" onBlur="get_tahun(<!--{$NO_PROPINSI|default:0}-->,<!--{$NO_KABUPATEN|default:0}-->,<!--{$NO_RUAS|default:0}-->,1,this.value)"></div></td>
</tr>
<tr>
<td colspan="2">Akhir Tahun II </td>
<td><div id=""><input type="text" name="tahun2" value="<!--{$TAHUN2}-->" onBlur="get_tahun(<!--{$NO_PROPINSI|default:0}-->,<!--{$NO_KABUPATEN|default:0}-->,<!--{$NO_RUAS|default:0}-->,2,this.value)"></div></td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>
...
<td></td>
<td><input type="hidden" name="total1"></div></td>
</tr>
<tr>
<td colspan="3">&nbsp;</td>
</tr>
...
<td><div align="right">&raquo;</div></td>
<td>Rusak Berat </td>
<td><div id="ajax_tahun2_rusak_berat"><input type="text" name="tahun2_rusak_berat" value="<!--{$TAHUN2_RUSAK_BERAT}-->" OnKeyUp="validateNum(this)"
onChange="document.frmCreate.total2.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.tahun2_baik.value)-(document.frmCreate.tahun2_sedang.value)-(document.frmCreate.tahun2_rusak.value)-(this.value)"></div></td>
</tr>
<tr>
<td><div align="right"></div></td>
<td></td>
<td><input type="hidden" name="total2"></div></td>
</tr>
<tr valign="top">
