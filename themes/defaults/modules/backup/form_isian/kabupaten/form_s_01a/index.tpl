...
<td width="200">
  <div id="ajax_no_ruas"><input type="text" name="no_ruas" maxlength="25" 
  onBlur="get_data_ruas(frmCreate.no_propinsi.value,frmCreate.no_kabupaten.value,this.value)" value="<!--{$NO_RUAS}-->">
</td>
</tr>
