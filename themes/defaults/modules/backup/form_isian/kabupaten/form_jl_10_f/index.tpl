...
<td><div id="ajax_panjang_ruas"><input type="text" name="panjang_km" value="<!--{$PANJANG_KM}-->" OnChange="CountPanjangM(this.value)" OnKeyUp="validateNum(this)"></div>
</td>
</tr>

<tr>
<td colspan="2">Panjang (m)</td>
<td><div id="ajax_panjang_ruas2"><input type="text" name="panjang_m" id="panjang_m" value="<!--{$PANJANG_M}-->"></div></td>
</tr>
<tr>
...
<td><div align="right">&raquo;</div></td>
<td>Rusak Berat </td>
<td><div id="ajax_tahun2_rusak_berat"><input type="text" name="tahun2_rusak_berat" value="<!--{$TAHUN2_RUSAK_BERAT}-->" onChange="document.frmCreate.total2.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.tahun2_baik.value)-(document.frmCreate.tahun2_sedang.value)-(document.frmCreate.tahun2_rusak.value)-(this.value)"></div></td>
</tr>
<tr>
<td><div align="right"></div></td>
<td></td>
