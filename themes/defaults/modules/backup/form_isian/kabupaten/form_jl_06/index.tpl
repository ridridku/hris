...
<!--{/if}-->
	...
	<DIV ID="_menuEntry3_1" style="top:10px;width:100%;display:none;position:absolute;">
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		    <tr>
				<td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> <!--{$FORM_NAME2}--></td>
			</tr>
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr>
		  <td class="tcat"> <!--{$TABLE_CAPTION}--></td></tr>
		</table>
		
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
			<tr>
				<td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/form.gif" align="absmiddle" border="0"> <!--{$FORM_NAME}--></td></tr>
			<tr>
		<td class="alt2" style="padding:0px;">
		...
		<TABLE id="table-add-box">
			<TR>					
				...
				<td>
				<input type="text" name="tanggal" value="<!--{if $TANGGAL==''}--><!--{else}--><!--{$TANGGAL}--><!--{/if}-->"> <img src="<!--{$HREF_IMG_PATH}-->/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tanggal,'dd-mm-yyyy',this)"  class="imgLink" align="absmiddle" title="Show Calendar List"></td>
			</tr>
		...
		<td>
			...
			<div id="ajax_paket_jalan">
				<input name="nama_paket" type="text" value="<!--{$NAMA_PAKET}-->" size="65" maxlength="200">
					<!--{if $TOTAL_PAKET_JALAN>0}--><img src="<!--{$HREF_IMG_PATH}-->/icon/table.gif" border="0" title="Tampilkan Data Paket Jalan" onClick="showPaket();" class="imgLink" align="absmiddle"><!--{else}--> {-- Cari dulu di form pencarian ! <!--{/if}-->
			</div>
			...
			<div id="ajax_paket_jalan2" style="position:absolute;display:none;">
				...
				<option value="<!--{$DATA_PAKET_JALAN[x].nama_ruas}-->" selected >
					<!--{$DATA_PAKET_JALAN[x].nama_prop_jenis_penanganan}--> jalan <!--{$DATA_PAKET_JALAN[x].nama_ruas}--></option>
					<!--{else}-->
				<option value="<!--{$DATA_PAKET_JALAN[x].nama_ruas}-->"  >
					<!--{$DATA_PAKET_JALAN[x].nama_prop_jenis_penanganan}--> jalan <!--{$DATA_PAKET_JALAN[x].nama_ruas}--></option>
					<!--{/if}-->
					<!--{/section}-->								
				</SELECT>
