...
<input type="text" readOnly id="no_ruas" name="no_ruas" maxlength="25" OnKeyUp="get_data_ruas(<!--{$NO_PROPINSI|default:0}-->,<!--{$NO_KABUPATEN|default:0}-->,this.value)" value="<!--{$NO_RUAS}-->"> <!--{if $TOTAL_RUAS_JALAN>0}--><img src="<!--{$HREF_IMG_PATH}-->/icon/table.gif" border="0" title="Tampilkan Data Ruas Jalan" onclick="showRuas();" class="imgLink" align="absmiddle"><!--{/if}--></div>
...
<td width="150">Panjang v (Km)</td><td><div id="ajax_panjang_ruas"><input type="text" readOnly id="panjang_km" name="panjang_km" value="<!--{$PANJANG_KM}-->" OnChange="CountPanjangM(this.value)" OnKeyUp="validateNum(this)"></div></td></tr>
...
<td width="150">Jumlah Penduduk</td><td><div id="ajax_jumlah_penduduk"><input type="text" name="jumlah_penduduk" value="<!--{$JUMLAH_PENDUDUK}-->" OnKeyUp="validateNum(this)" readOnly></div></td></tr>
</table>
