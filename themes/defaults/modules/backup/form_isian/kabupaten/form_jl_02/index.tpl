...
<td>
   <div id="ajax_no_ruas">
      <input type="text" readOnly id="no_ruas" name="no_ruas" maxlength="25" OnKeyUp="get_data_ruas(
	      <!--{$NO_PROPINSI|default:0}-->,
		  <!--{$NO_KABUPATEN|default:0}-->,
		  this.value )" 
		  value="<!--{$NO_RUAS}-->"> 
		  <!--{if $TOTAL_RUAS_JALAN>0}-->
		     <img src="<!--{$HREF_IMG_PATH}-->/icon/table.gif" border="0" title="Tampilkan Data Ruas Jalan" onClick="showRuas();" class="imgLink" align="absmiddle">
		  <!--{/if}-->
   </div>

   <div id="ajax_no_ruas2" style="position:absolute;display:none;">
      <select id="no_ruas_results" multiple size="10" onChange="frmCreate.no_ruas.value=this.value; get_data_ruas(
	   <!--{$NO_PROPINSI|default:0}-->,<!--{$NO_KABUPATEN|default:0}-->,this.value);showRuas();">";
       <!--{section name=x loop=$DATA_RUAS_JALAN}-->
        <!--{if $DATA_RUAS_JALAN[x].no_ruas == $NO_RUAS}-->
            <option value="<!--{$DATA_RUAS_JALAN[x].no_ruas}-->" selected > 
			    <!--{$DATA_RUAS_JALAN[x].nama_pangkal_ruas}--> - <!--{$DATA_RUAS_JALAN[x].nama_ujung_ruas}-->
			</option>
                <!--{else}-->
            <option value="<!--{$DATA_RUAS_JALAN[x].no_ruas}-->" > <!--{$DATA_RUAS_JALAN[x].nama_pangkal_ruas}--> - <!--{$DATA_RUAS_JALAN[x].nama_ujung_ruas}-->
			</option>
                <!--{/if}-->
      <!--{/section}-->								
     </SELECT>
...
<td width="150">Panjang (Km)</td><td><div id="ajax_panjang_ruas"><input type="text" id="panjang_km" name="panjang_km" value="<!--{$PANJANG_KM}-->" OnChange="CountPanjangM(this.value)" OnKeyUp="validateNum(this)" readonly></div></td></tr>
<td width="150">Panjang (m)</td><td><div id="ajax_panjang_ruas2"><input type="text" id="panjang_m" name="panjang_m" value="<!--{$PANJANG_M}-->" OnKeyUp="validateNum(this)" readonly></div></td></tr>
...
<td class="tdatacontent" width="150">Kondisi Baik</td><td><input type="text" name="kondisi_baik" value="<!--{$KONDISI_BAIK}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.kondisi_baik.value)-(document.frmCreate.kondisi_sedang.value)-(document.frmCreate.kondisi_rusak.value)-(document.frmCreate.kondisi_rusak_berat.value)"></td></tr>
<td class="tdatacontent"width="150">Kondisi Sedang</td><td><input type="text" name="kondisi_sedang" value="<!--{$KONDISI_SEDANG}-->" OnKeyUp="validateNum(this)" " onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.kondisi_baik.value)-(document.frmCreate.kondisi_sedang.value)-(document.frmCreate.kondisi_rusak.value)-(document.frmCreate.kondisi_rusak_berat.value)"></td></tr>
<td class="tdatacontent" width="150">Kondisi Rusak Ringan</td><td><input type="text" name="kondisi_rusak" value="<!--{$KONDISI_RUSAK}-->" OnKeyUp="validateNum(this)" onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.kondisi_baik.value)-(document.frmCreate.kondisi_sedang.value)-(document.frmCreate.kondisi_rusak.value)-(document.frmCreate.kondisi_rusak_berat.value)"></td></tr>
<td class="tdatacontent" width="150">Kondisi Rusak Berat</td><td><input type="text" name="kondisi_rusak_berat" value="<!--{$KONDISI_RUSAK_BERAT}-->" OnKeyUp="validateNum(this)" onChange="document.frmCreate.totalP.value=(document.frmCreate.panjang_km.value)-(document.frmCreate.kondisi_baik.value)-(document.frmCreate.kondisi_sedang.value)-(document.frmCreate.kondisi_rusak.value)-(document.frmCreate.kondisi_rusak_berat.value)"></td></tr>
<td width="150"></td><td><input type="text" name="totalP" value="<!--{$TotalP}-->"></td></tr></div>
