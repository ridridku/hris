...
<tr>
<td>Triwulan&nbsp;</td>
<td><!--{html_radios name="triwulan" options=$TRIWULANARR class=radio selected=$TRIWULAN_SEARCH|default:'1' separator="&nbsp;&nbsp;"}--></td>
</tr>
<tr>
...
<th class="tdatahead" style="padding:1px" width="200" nowrap>Nama Paket</th>
<th class="tdatahead" style="padding:1px" width="200" nowrap>Masalah</th>
<th class="tdatahead" style="padding:1px" width="200" nowrap>Upaya Pemecahan Masalah yang telah dilakukan</th>
<th class="tdatahead" style="padding:1px" width="150" nowrap>Instansi Terkait</th>
<th class="tdatahead" style="padding:1px" width="150" nowrap>Status Perkembangan Penyelesaian Masalah</th>
</tr>
</table>

<!--
<div id="test">Coba Aja:<!--{$JENIS_JALAN_COBA}--></div>
-->
...
<TABLE width="100%">
				<TR>
					...
					<INPUT TYPE="hidden" name="xid_jl_07_main" value="<!--{$ID_JL_07_MAIN}-->">	
					<INPUT TYPE="hidden" name="mod_id" value="<!--{$MOD_ID}-->">
					<INPUT TYPE="hidden" name="Search_Year" value="<!--{$TAHUN}-->">
...
<a class="button" href="#" onclick="this.blur();showAll('_menuEntry1_',1);hideAll('_menuEntry2_',1);getAllData('<!--{$NO_PROPINSI}-->','<!--{$NO_KABUPATEN}-->','<!--{$TAHUN}-->','<!--{$TRIWULAN_SEARCH}-->','<!--{$NO_JENIS_JALAN}-->');frmCreate.op.value=1;this.disabled=true;" <!--{if $OPT==1}--> DISABLED <!--{/if}-->><span><img src="<!--{$HREF_IMG_PATH}-->/icon/details.gif" align="absmiddle"> Edit Data</span></a>
</div>		
		<table width="100%"><tr><td>
									<table class="tbheader">
									<tr><td width="100">Propinsi </td><td width="10"> : </td><td><!--{$NAMA_PROPINSI}--></td>
									<td width="50">Tahun </td><td width="10"> : </td><td width="100"><!--{$TAHUN}--></td></tr>
									<tr><td>Kabupaten/Kota </td><td> : </td><td><!--{$NAMA_KABUPATEN}--></td>
									<td width="50">Triwulan </td><td width="10"> : </td><td width="100"><!--{$TRIWULAN_SEARCH}--></td></tr>
									</table>
									</TD>
								</TR>								
								<TR>
									<TD><TABLE  WIDTH="100%">										
										<TR>
											...
											<th class="tdatahead">Nama Paket</TH>
											<th class="tdatahead">Masalah</TH>
											<th class="tdatahead">Upaya Penyelesaian</TH>
											<th class="tdatahead">Instansi</TH>											
										...
										<tr class='<!--{cycle values="alt,alt3"}-->'>
											...
											<td class="tdatacontent" nowrap> <!--{$DATA_TB[x].pemecahan|replace:";":"\n\r"}--> </TD>
											<td class="tdatacontent" nowrap> <!--{$DATA_TB[x].instansi}--> </TD>	
											<td width="20" class="tdatacontent" ALIGN="CENTER">
											<IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" VALIGN="middle" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onClick="return checkDelete('engine.php?op=2&id_fjl_07_main=<!--{$DATA_TB[x].id_fjl_07_main}-->&Search_Year=<!--{$TAHUN}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink">
											</TD>
										</TR>
										<!--{sectionelse}-->
										<TR>
