...
<td>Nama Propinsi </td>
<td>
					<SELECT name="no_propinsi" onChange="get_proyek();">
...
<!--{section name=x loop=$DATA_UR1}-->
<!--{if trim($DATA_UR1[x].kode_proyek) == trim($KODE_PROYEK)}-->
<option value="<!--{$DATA_UR1[x].kode_proyek}-->" selected > <!--{$DATA_UR1[x].kode_proyek}--> </option>
<!--{else}-->
<option value="<!--{$DATA_UR1[x].kode_proyek}-->"  > <!--{$DATA_UR1[x].kode_proyek}--> </option>
<!--{/if}-->
<!--{/section}-->
</SELECT>
</div>
...
<tr>
<td>Jumlah Proyek / Paket (bh) </td>
<td><input type="text" name="jumlah_proyek" value="<!--{$JUMLAH_PROYEK}-->"></td>
</tr>
<tr>
<td>Jumlah Kabupaten (bh) </td>
<td><input type="text" name="jumlah_kabupaten" value="<!--{$JUMLAH_KABUPATEN}-->"></td>
</tr>
<tr>
<td>Panjang Total Ruas Jalan (Km) </td>
<td><input type="text" name="panjang_jalan" value="<!--{$PANJANG_JALAN}-->"></td>
</tr>
<tr>
<td>Panjang Proyek Jalan (Km) </td>
<td><input type="text" name="panjang_proyek" value="<!--{$PANJANG_PROYEK}-->"></td>
</tr>
<tr>
<td>Biaya Jalan (Rp) </td>
<td><input type="text" name="biaya_jalan" value="<!--{$BIAYA_JALAN}-->"></td>
</tr>
<tr>
<td>Jumlah Jembatan (bh) </td>
<td><input type="text" name="jumlah_jembatan" value="<!--{$JUMLAH_JEMBATAN}-->"></td>
</tr>
<tr>
<td>Total Panjang Jembatan (m) </td>
<td><input type="text" name="panjang_jembatan" value="<!--{$PANJANG_JEMBATAN}-->"></td>
</tr>
<tr>
<td>Biaya Jembatan (Rp) </td>
<td><input type="text" name="biaya_jembatan" value="<!--{$BIAYA_JEMBATAN}-->"></td>
</tr>
<tr>
<td>Biaya Umum (Rp) </td>
<td><input type="text" name="biaya_umum" value="<!--{$BIAYA_UMUM}-->"></td>
</tr>
<tr>
...
<tr>
<td>PAD1 (Rp) </td>
<td><input type="text" name="pad1" value="<!--{$PAD1}-->"></td>
</tr>
<tr>
<td>Dana Umum DPP (Rp) </td>
<td><input type="text" name="du_dpp" value="<!--{$DU_DPP}-->"></td>
</tr>
<tr>
<td>PJP DPP (Rp) </td>
<td><input type="text" name="pjp_dpp" value="<!--{$PJP_DPP}-->"></td>
</tr>
<tr>
...
<td><input type="text" name="jumlah_loan_phln" value="<!--{$JUMLAH_LOAN_PHLN}-->"></td>
</tr>
<tr>
<td>Nomor Sumber Dana Lainnya </td>
<td>
...
<tr>
<td>Jumlah Sumber Dana Lainnya </td>
<td><input type="text" name="jumlah_sumber_dana_lain" value="<!--{$JUMLAH_SUMBER_DANA_LAIN}-->"></td>
</tr>
<tr valign="top">
<td>Keterangan</td>
...
<TR
><TD></TD>
<TD><INPUT TYPE="hidden" name="xid_form_ur_02_jp_main" value="<!--{$ID_FORM_UR_02_JP_MAIN}-->">
<INPUT TYPE="hidden" name="xid_form_ur_02_jp_detail" value="<!--{$ID_FORM_UR_02_JP_DETAIL}-->">
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" CELLPADDING="1" CELLSPACING="2">
		...
		<TABLE id="table-search-box">
			...
			<TD>
				...
				<OPTION VALUE="">[Pilih Propinsi]</OPTION><!--{section name=x loop=$DATA_PROPINSI}-->
		...
		<table width="100%"><TR>
			...
			<TABLE  WIDTH="100%">
				...
				<td width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onClick="return checkEdit('<!--{$SELF}-->?opt=1&id_form_ur_02_jp_main=<!--{$DATA_TB[x].id_form_ur_02_jp_main}-->&id_form_ur_02_jp_detail=<!--{$DATA_TB[x].id_form_ur_02_jp_detail}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
				<td width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/delete.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$DELETE}-->" onClick="return checkDelete('engine.php?op=2&id_form_ur_02_jp_main=<!--{$DATA_TB[x].id_form_ur_02_jp_main}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
				</TR>
				<!--{sectionelse}-->
				<TR>
