		...
		<FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php">
            ...
            <TR>
                        <TD>No Pinjaman <font color="#ff0000">*</font></TD>
                                 <TD>
                                    <!--{if $EDIT_VAL==0}-->
                                        <INPUT  readonly=""  TYPE="text" name="t_pjm__no_pinjaman" size="35" value="<!--{$NO_PINJAMAN}-->"  onkeypress="JavaScript:Ajax('ajax_cek_id','<!--{$HREF_HOME_PATH_AJAX}-->/cek.php?t_sp__no='+frmCreate.t_sp__no.value)">
					<!--{else}-->
                                        <INPUT  readonly=""  TYPE="text" name="t_pjm__no_pinjaman" size="35" value="<!--{$EDIT_T_PJM__NO_PINJAM}-->"  onkeypress="JavaScript:Ajax('ajax_cek_id','<!--{$HREF_HOME_PATH_AJAX}-->/cek.php?t_sp__no='+frmCreate.t_sp__no.value)">
					<!--{/if}-->  
