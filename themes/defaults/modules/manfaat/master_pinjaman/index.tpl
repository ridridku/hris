		...
		<tr><td class="alt2" style="padding:0px;">
            <FORM NAME="frmCreate" METHOD="POST" ACTION="engine.php">
					...
					<!--{/if}-->
                                        ...
                                        <INPUT TYPE="hidden" NAME="r_ang__id" value="<!--{$EDIT_R__ANG__ID}-->" size="35" readOnly class="text_disabled">
                      <TR>
                                        <TD>Jenis Pinjaman <font color="#ff0000">*</font></TD> 
                                        <TD> <INPUT TYPE="text" NAME="r_ang__jenis" value="<!--{$EDIT_R_ANG__JENIS}-->" size="35"></TD> 
                      </TR>
                                         
                    <TR>
                        <TD>Besar Platfond<font color="#ff0000">*</font></TD>
                        <TD><INPUT TYPE="text" NAME="r_ang__platfond"   size="35" value="<!--{$EDIT_R_ANG__PLATFON|number_format:0:".":","}-->"   onkeyup="formatangka(this)" style="text-align :left;"></TD>                                			
                                               
                    </TR>
                    
                    <TR>
                        <TD>Total <font color="#ff0000">*</font></TD>
                        <TD><INPUT TYPE="text" NAME="r_ang__total"  size="35" value="<!--{$EDIT_R_ANG__TOTAL|number_format:0:".":","}-->"  onkeyup="formatangka(this)"></TD>                                			
                    ...
                    <TR>
                                ...
                                <TD> <INPUT TYPE="text" name="r_ang__tenor_bulan" value="<!--{$EDIT_R_ANG__TENOR}-->"  size="5">Bulan
                                  </TD>
                     </TR>
                                     
                    <TR>
                                <TD>Cicilan Perbulan <font color="#ff0000">*</font></TD> 
                                <TD> <INPUT TYPE="text" name="r_ang__cicilan" value="<!--{$EDIT_R_ANG__CICILAN|number_format:0:".":","}-->" size="25"  onkeyup="formatangka(this)">
                                  </TD>
                     </TR>
                      <TR>
                                <TD>Keterangan</TD> 
                                <TD><textarea rows="5" cols="20" NAME="r_ang__ket"  size="12" ><!--{$EDIT_R_ANG__KET}--></textarea></TD>
                     </TR>
		...
		<TABLE id="table-search-box" >
                  <TR>
					...
					<TD><SELECT name="jenis_cari">
							...
							<OPTION value="1" <!--{if $EDIT_R_ANG__JENIS=='1'}-->selected<!--{/if}-->>Pinjaman Senior Manager</OPTION>
							<OPTION value="2" <!--{if $EDIT_R_ANG__JENIS=='2'}-->selected<!--{/if}-->>Pinjaman Staff</OPTION>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<!--{$HREF_IMG_PATH}-->/layout/columns.gif" align="absmiddle" border="0">Data Pengajuan Pinjaman</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
                <THEAD>
			...
			<tr class='<!--{cycle values="alt,alt3"}-->'>
											<td width="17" class="tdatacontent-first-col"> <!--{$smarty.section.x.index+$COUNT_VIEW}-->.</TD>
                                                                                        <TD class="tdatacontent"  width="50" ><!--{$DATA_TB[x].r_ang__jenis}--></TD>
                                                                                        <TD class="tdatacontent">Rp.<!--{$DATA_TB[x].r_ang__platfond|number_format:2:".":","}--> </TD>
                                                                                        <TD class="tdatacontent">Rp. <!--{$DATA_TB[x].r_ang__total|number_format:2:".":","}--> </TD>
											...
											<TD class="tdatacontent"> <!--{$DATA_TB[x].r_ang__ket}--></TD>											
                                                                                                                                                                           
                                                                                               
                                                                                        
                                                                                                                                                                          
                                                                                          
											<TD width="20" class="tdatacontent" ALIGN="CENTER"><IMG SRC="<!--{$HREF_IMG_PATH}-->/icon/edit.gif" WIDTH="12" HEIGHT="13" BORDER=0 ALT="<!--{$EDIT}-->" onclick="return checkEdit('<!--{$SELF}-->?opt=1&id=<!--{$DATA_TB[x].r_ang__id}-->&mod_id=<!--{$MOD_ID}-->&<!--{$STR_COMPLETER_}-->');" class="imgLink"></TD>
