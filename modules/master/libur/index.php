...
$smarty->assign ("HREF_HOME_PATH_AJAX", $HREF_HOME.'/modules/master/libur');
...
if ($_GET['id_libur_cari']) $id_libur_cari= $_GET['id_libur_cari'];
else if ($_POST['id_libur_cari']) $id_libur_cari = $_POST['id_libur_cari'];
else $id_libur_cari="";
...
FROM
t_libur
INNER JOIN r_shift ON t_libur.r_libur__shift = r_shift.r_shift__id WHERE r_libur__id='".$_GET['id']."' ";
       
                                $resultSet = $db->Execute($sql_);
$edit_r_libur__id = $resultSet->fields[r_libur__id];
$edit_r_libur__shift=$resultSet->fields[r_libur__shift];
$edit_r_libur__tgl=$resultSet->fields[r_libur__tgl];
$edit_r_libur__ket=$resultSet->fields[r_libur__ket];
$edit_r_shift__id = $resultSet->fields[r_shift__id];
$edit_r_libur__jenis=$resultSet->fields[r_libur__jenis];
...
$smarty->assign ("EDIT_LIBUR__ID",$edit_r_libur__id);
$smarty->assign ("EDIT_LIBUR__SHIFT",$edit_r_libur__shift);
$smarty->assign ("EDIT_LIBUR__TGL",$edit_r_libur__tgl);
$smarty->assign ("EDIT_LIBUR__KET",$edit_r_libur__ket);

$smarty->assign ("EDIT_LIBUR__JENIS",$edit_r_libur__jenis);
	...
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
		  ...
		  if($jenis_user=='2'){
                                ...
                                if ($jenis_cari !='')
                                  ...
                                  if ($id_libur_cari !='')
                                    {
                                    $sql.=" AND r_libur__id= '$id_libur_cari' ";
                                    }
