...
$sql_pelatihan ="SELECT
                                    ...
                                    C.r_mastpel__tempat AS r_mastpel__tempat,
                                    C.r_mastpel__status AS r_mastpel__status,
                                    ...
                                    INNER JOIN v_pegawai peg ON peg.r_pnpt__no_mutasi=B.r_pel__mutasi where peg.r_pnpt__nip ='$nip_karyawan_cari'";
...
$smarty->assign ("CV_PELATIHAN", $data_pelatihan);
