...
//{
				  ...
				  if ($usia!='') { 
					 ...
					 $smarty->assign ("NAMA_USIA", $nama_usia); 	 
						 ...
						 (select count(*) from tbl_wni  left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
								left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi where tbl_wni.kode_perwakilan = a.kode_perwakilan and kode_sumber=1 ";
						 ...
						 $sql.=" (select count(*) from tbl_wni left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
								left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi where tbl_wni.kode_perwakilan = a.kode_perwakilan and kode_sumber=6 ";
						...
						$sql.="(select count(*) from tbl_wni  left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
								left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi where tbl_wni.kode_perwakilan = a.kode_perwakilan and kode_sumber=3 ";
					...
					if ($usia!='') { 
						 ...
						 $sql.=") as jml_tki_formal ,";
						
						
						
						
						$sql.="(select count(*) from tbl_wni  left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
								left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi where tbl_wni.kode_perwakilan = a.kode_perwakilan and kode_sumber=4   ";
 ...
 left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi inner join  tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_wni.kode_perwakilan  LEFT JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  where  kode_sumber=1 ";
...
if ($kode_kawasan !=''){
 ...
 $sql2="select count(*) as total_wni_formal from tbl_wni left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
 left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi inner join  tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_wni.kode_perwakilan  LEFT JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  where  kode_sumber=3 ";

  if ($no_propinsi !='') { 
	$sql2.= "  AND tbl_mast_wil_kabupaten.no_propinsi='$no_propinsi' ";
 }

 if ($id_kab !='') { 
	$sql2.= "  AND tbl_wni.id_kabupaten='$id_kab' ";
 }
...
if ($usia!='') { 
		 ...
		 if ($usia=='1') { 
			 $sql2.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
		 }

		 if ($usia=='2') { 
			 $sql2.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
		 }

		 if ($usia=='3') { 
			 $sql2.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
		 }


		 if ($usia=='4') { 
			 $sql2.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
		  }
}


if ($kode_kawasan !=''){
	$sql2.=" and   tbl_mast_negara.kode_kawasan = '$kode_kawasan' ";
 }	


 $resultSet2 = $db->Execute($sql2);
 $total_wni_formal = $resultSet2->fields[total_wni_formal];
 $smarty->assign ("TOTAL_WNI_FORMAL", $total_wni_formal); 


 $sql3="select count(*) as total_wni_informal from tbl_wni left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
 left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi inner join  tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_wni.kode_perwakilan  LEFT JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  where  kode_sumber=4 ";
  if ($no_propinsi !='') { 
	$sql3.= "  AND tbl_mast_wil_kabupaten.no_propinsi='$no_propinsi' ";
 }

 if ($id_kab !='') { 
	$sql3.= "  AND tbl_wni.id_kabupaten='$id_kab' ";
 }
...
if ($kode_kawasan !=''){
 ...
 $resultSet3 = $db->Execute($sql3);
 $total_wni_informal = $resultSet3->fields[total_wni_informal];
 $smarty->assign ("TOTAL_WNI_INFORMAL", $total_wni_informal); 


 $sql4="select count(*) as total_wni_abk_ from tbl_wni left join tbl_mast_wil_kabupaten on tbl_mast_wil_kabupaten.id_kabupaten=tbl_wni.id_kabupaten
 left join tbl_mast_wil_propinsi on tbl_mast_wil_propinsi.no_propinsi=tbl_mast_wil_kabupaten.no_propinsi inner join  tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_wni.kode_perwakilan  LEFT JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  where  kode_sumber=6 ";
  if ($no_propinsi !='') { 
	$sql4.= "  AND tbl_mast_wil_kabupaten.no_propinsi='$no_propinsi' ";
 }

 if ($id_kab !='') { 
	$sql4.= "  AND tbl_wni.id_kabupaten='$id_kab' ";
 }
...
if ($kode_kawasan !=''){
 ...
 $resultSet4 = $db->Execute($sql4);
 $total_wni_abk_ = $resultSet4->fields[total_wni_abk_];
 $smarty->assign ("TOTAL_WNI_ABK_", $total_wni_abk_); 


//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".$sql4;
