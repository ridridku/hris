...
require_once($DIR_HOME.'/laporan/inc.rekap_pelayanan.php');  
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/pelaporan/rekap_pelayanan';
 
#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/pelaporan');
$FILE_JS  = $JS_MODUL.'/rekap_pelayanan';
...
if ($_GET['kode_kawasan']) $kode_kawasan = $_GET['kode_kawasan'];
 ...
 if ($_GET['kode_jenis_pelayanan']) $kode_jenis_pelayanan = $_GET['kode_jenis_pelayanan'];
else if ($_POST['kode_jenis_pelayanan']) $kode_jenis_pelayanan = $_POST['kode_jenis_pelayanan'];
else $kode_jenis_pelayanan="";


if ($_GET['kode_sub_jenis_pelayanan']) $kode_sub_jenis_pelayanan = $_GET['kode_sub_jenis_pelayanan'];
else if ($_POST['kode_sub_jenis_pelayanan']) $kode_sub_jenis_pelayanan = $_POST['kode_sub_jenis_pelayanan'];
else $kode_sub_jenis_pelayanan="";
 


$var_cari="kode_jenis_pelayanan=".$kode_jenis_pelayanan."&kode_sub_jenis_pelayanan=".$kode_sub_jenis_pelayanan."&kode_kawasan=".$kode_kawasan."&bulan=".$bulan."&tahun=".$tahun;
...
if ($_GET[get_prop] == 1)
{
	$no_propinsi = $_GET[no_prop];
			if($no_propinsi!=''){	
					$sql_kabupaten = "SELECT * from tbl_mast_jenis_pelayanan_detail  WHERE kode_jenis_pelayanan='".$no_propinsi."'  order by nama_pelayanan asc";
					$recordSet_kabupaten = $db->Execute($sql_kabupaten);
					//print $sql_kabupaten;
					$input_kab="<select name=kode_sub_jenis_pelayanan  style=\"width:200px\" >";
					$input_kab.="<option value=>";
					$input_kab.="</option> ";
					while(!$recordSet_kabupaten->EOF): 
						$input_kab.="<option value=";
						$input_kab.= $recordSet_kabupaten->fields['kode_sub_jenis_pelayanan'].">".$recordSet_kabupaten->fields['nama_pelayanan'];   
						$input_kab.="</option>";
...
// SHOW DATA PELAYANAN ========================
$sql_pelayanan = "SELECT  *  FROM tbl_mast_jenis_pelayanan order by nama_jenis_pelayanan asc";
...
if ($_GET['tahun'] != '')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$rs__=$db->Execute($sql__);
				 ...
				 if ($kode_jenis_pelayanan !='') {	
					 	$sql__="select * , upper(nama_jenis_pelayanan) as nama_jenis_pelayanan from tbl_mast_jenis_pelayanan where kode_jenis_pelayanan='$kode_jenis_pelayanan' ";
						$rs__=$db->Execute($sql__);
						 $nama_jenis_pelayanan = $rs__->fields['nama_jenis_pelayanan'];
						 $smarty->assign ("NAMA_JENIS_PELAYANAN", $nama_jenis_pelayanan);
				 }

				  if ($kode_sub_jenis_pelayanan !='') {	
						 $sql__="select * , upper(nama_pelayanan) as nama_pelayanan from tbl_mast_jenis_pelayanan_detail where kode_sub_jenis_pelayanan='$kode_sub_jenis_pelayanan' ";
						$rs__=$db->Execute($sql__);
						 $nama_pelayanan = $rs__->fields['nama_pelayanan'];
						 $smarty->assign ("NAMA_PELAYANAN", $nama_pelayanan);
...
(SELECT COUNT(c.kode_wni) from tbl_pelayanan c inner join tbl_mast_jenis_pelayanan_detail on tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan =c.kode_sub_jenis_pelayanan where c.kode_perwakilan=a.kode_perwakilan  ";	

 if ($bulan !='') {	
 $sql_detail.= "  and MONTH(c.tgl_pelayanan) ='$bulan' ";
 }

 if ($tahun !='') {	
 $sql_detail.= " and LEFT(c.tgl_pelayanan,4) = '$tahun' ";
 }

 if ($kode_jenis_pelayanan !='') {	
	 $sql_detail.= " and tbl_mast_jenis_pelayanan_detail.kode_jenis_pelayanan  = '$kode_jenis_pelayanan' ";
 }

  if ($kode_sub_jenis_pelayanan !='') {	
	$sql_detail.= " and  tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan = '$kode_sub_jenis_pelayanan' ";
 }
 

 $sql_detail.= "  ) as orang FROM tbl_mast_perwakilan a LEFT JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = a.kode_negara     ";
	 

 if ($kode_kawasan !='') {
 $sql_detail.=" where  tbl_mast_negara.kode_kawasan = '$kode_kawasan' ";
 }	 
...
//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".$sql_detail;
...
(SELECT COUNT(tbl_pelayanan.kode_wni) from tbl_pelayanan  inner join tbl_mast_jenis_pelayanan_detail on tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan =tbl_pelayanan.kode_sub_jenis_pelayanan
 left join tbl_mast_perwakilan on tbl_pelayanan.kode_perwakilan=tbl_mast_perwakilan.kode_perwakilan
...
where tbl_mast_kawasan.kode_kawasan=a.kode_kawasan  ";

if ($tahun !='') {	
	$sql_kawasan .= " and YEAR(tgl_pelayanan) ='$tahun'";
}

 if ($kode_jenis_pelayanan !='') {	
 $sql_kawasan.= " and tbl_mast_jenis_pelayanan_detail.kode_jenis_pelayanan  = '$kode_jenis_pelayanan' ";
 }

  if ($kode_sub_jenis_pelayanan !='') {	
 $sql_kawasan.= " and  tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan = '$kode_sub_jenis_pelayanan' ";
 }



if ($bulan !='') {	
  $sql_kawasan .= " and MONTH(tgl_pelayanan)= '$bulan'  "; 
	}
 
$sql_kawasan.= " ) as orang FROM tbl_mast_kawasan a ";
...
$sql_kawasan.= " order by nama_kawasan ";				
 ...
 $sql_total="SELECT COUNT(kode_wni) as total_orang from tbl_pelayanan inner join tbl_mast_jenis_pelayanan_detail on tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan =tbl_pelayanan.kode_sub_jenis_pelayanan  inner join tbl_mast_perwakilan on tbl_pelayanan.kode_perwakilan=tbl_mast_perwakilan.kode_perwakilan
				LEFT JOIN tbl_mast_negara ON tbl_mast_perwakilan.kode_negara=tbl_mast_negara.kode_negara
				LEFT JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan where 1=1 ";

 if ($tahun !='') {	
 $sql_total.= " and YEAR(tgl_pelayanan) ='$tahun'   ";
 }

if ($bulan !='') {	
 $sql_total.= " and MONTH(tgl_pelayanan) = '$bulan' ";
 }
 ...
 if ($kode_jenis_pelayanan !='') {	
 $sql_total.= " and tbl_mast_jenis_pelayanan_detail.kode_jenis_pelayanan  = '$kode_jenis_pelayanan' ";
 }

  if ($kode_sub_jenis_pelayanan !='') {	
 $sql_total.= " and  tbl_mast_jenis_pelayanan_detail.kode_sub_jenis_pelayanan = '$kode_sub_jenis_pelayanan' ";
 }
				...
				while ($arr4=$recordSet4->FetchRow()) {
					...
					$content_data .= print_content("","<b>TOTAL PELAYANAN DAN PERLINDUNGAN </b>",$tot2);
				 	 $content_data2 .= print_content("","<b>TOTAL PELAYANAN DAN PERLINDUNGAN </b>",$tot2);
			  ...
			  $smarty->assign ("DATA_TB4", $data_tb4);
				...
				$file= $DIR_HOME."/files/rekap_pelayanan_".$nama_bulan."_".$tahun.".xls";
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/rekap_pelayanan_".$nama_bulan."_".$tahun.".xls";	
}
