...
if ($_GET['tahun'] != '')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$rs__=$db->Execute($sql__);			  
				 ...
				 $smarty->assign ("NM_PERWAKILAN", $nama_perwakilan); 
				    ...
				    if ($kode_perwakilan !='') {
						 ...
						 $sql="select distinct bulan, tahun , (select count(*) from tbl_dok_pengadilan_asing where LEFT(tgl_surat_keluar,4)='$tahun'  and SUBSTRING(tgl_surat_keluar,6,2)=v_dok_pengadilan_asing.bulan   and tbl_dok_pengadilan_asing.kode_perwakilan_asing = v_dok_pengadilan_asing.kode_perwakilan_asing   )  as jml_dok from v_dok_pengadilan_asing where tahun='$tahun'  and tbl_dok_pengadilan_asing.kode_perwakilan='$kode_perwakilan'  ";
			    ...
			    left  join tbl_mast_pengadilan on tbl_mast_pengadilan.kode_pn = tbl_dok_pengadilan_asing.kode_pn  
				 and LEFT(tgl_surat_keluar,4) ='$tahun'   "; 
	...
	$sql_detail = "select * , SUBSTRING(tgl_surat_keluar,6,2)  as bulan , LEFT(tgl_surat_keluar,4) as tahun , RIGHT(tgl_surat_keluar,2) as tanggal
			    ...
			    left  join tbl_mast_pengadilan on tbl_mast_pengadilan.kode_pn = tbl_dok_pengadilan_asing.kode_pn  
				 and LEFT(tgl_surat_keluar,4) ='$tahun'   "; 
					...
					if ($kode_perwakilan !='') {
						 $sql_detail.=" and tbl_dok_pengadilan_asing.kode_perwakilan='$kode_perwakilan' ";
