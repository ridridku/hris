		...
		if ($_GET['page']) $start = $p->findStartGet($LIMIT); else $start = $p->findStartPost($LIMIT);
			  ...
			  where 1=1  ";
				...
				while ($arr4=$recordSet4->FetchRow()) {
					 ...
					 $content_data .= print_content("","<b>TOTAL RELAAS LUAR NEGERI</b>",$tot2);
				 	 $content_data2 .= print_content("","<b>TOTAL RELAAS LUAR NEGERI</b>",$tot2);
			   ...
			   array_push($row_class4, $ROW_CLASSNAME2);
				...
				$file= $DIR_HOME."/files/rekap_relaas_luar_negeri_".$nama_bulan."_".$tahun.".xls";
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/rekap_relaas_luar_negeri_".$nama_bulan."_".$tahun.".xls";
