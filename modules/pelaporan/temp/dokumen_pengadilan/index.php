...
if ($_GET['tahun'] != '')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
					 ...
					 if ($kode_jenis_panggil!='') { 
						 ...
						 $smarty->assign ("JENIS_PANGGIl", $jenis_panggil); 	 
					 }
					 ...
					 if ($kode_perwakilan !='') {
						 ...
						 if ($kode_jenis_panggil !='') { // ada jenis panggil nya

							$sql="select distinct bulan, tahun , (select count(*) from tbl_dok_pengadilan where LEFT(tgl_surat_keluar,4)='$tahun'  and SUBSTRING(tgl_surat_keluar,6,2)=v_dok_pengadilan.bulan    and tbl_dok_pengadilan.kode_perwakilan = v_dok_pengadilan.kode_perwakilan  and tbl_dok_pengadilan.kode_jenis_panggil = v_dok_pengadilan.kode_jenis_panggil )  as jml_dok from v_dok_pengadilan where tahun='$tahun' and v_dok_pengadilan.kode_perwakilan='$kode_perwakilan' "; 
						 } else {
						 ...
						 if ($kode_jenis_panggil !='') { // ada jenis panggil nya
							 ...
							 $sql="select distinct bulan, tahun , (select count(*) from tbl_dok_pengadilan where LEFT(tgl_surat_keluar,4)='$tahun'  and SUBSTRING(tgl_surat_keluar,6,2)=v_dok_pengadilan.bulan and tbl_dok_pengadilan.kode_jenis_panggil = v_dok_pengadilan.kode_jenis_panggil ) as jml_dok from v_dok_pengadilan where tahun='$tahun' ";
						 } else { 							 
					...
					if ($kode_jenis_panggil !='') {
						$sql.= "and  v_dok_pengadilan.kode_jenis_panggil ='$kode_jenis_panggil' ";
					}
 
							$sql.=" order by bulan  asc ";


							//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".$sql;
				...
				(CASE  WHEN kode_jenis_panggil=1 then (select nama from tbl_wni where tbl_wni.kode_wni=tbl_dok_pengadilan.kode_terpanggil limit 1 )   WHEN kode_jenis_panggil=2 then (select bhi  from tbl_bhi  where tbl_bhi.kode_bhi=tbl_dok_pengadilan.kode_terpanggil limit 1 )  WHEN kode_jenis_panggil=3 then (select nama_wna  from tbl_wna  where tbl_wna.kode_wna=tbl_dok_pengadilan.kode_terpanggil limit 1 )  WHEN kode_jenis_panggil=4 then (select nama_bha  from tbl_mast_badan_hukum_asing  where tbl_mast_badan_hukum_asing.kode_bha=tbl_dok_pengadilan.kode_terpanggil limit 1) else '' END) as nama
				from tbl_dok_pengadilan  inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_dok_pengadilan.kode_perwakilan
				...
				where  LEFT(tgl_surat_keluar,4) ='$tahun' ";
					...
					if ($kode_jenis_panggil !='') {
						$sql_detail.= "and  kode_jenis_panggil ='$kode_jenis_panggil' ";
					}

				//	echo "<br><br><br><br><br> <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".$sql_detail;
				...
				while ($arr2=$recordSet2->FetchRow()) {
					...
					$tot="<b>TOTAL LAPORAN PENYAMPAIAN DOKUMEN PENGADILAN : </b>".$arr[jml_dok];
