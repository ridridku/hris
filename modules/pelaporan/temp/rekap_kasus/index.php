...
$var_cari="kode_kawasan=".$kode_kawasan."&bulan=".$bulan."&tahun=".$tahun."&kode_kasus=".$kode_kasus."&kode_negara=".$kode_negara."&kode_klasifikasi_wni=".$kode_klasifikasi_wni."&kode_sektor=".$kode_sektor."&kode_jenis=".$kode_jenis."&usia=".$usia."&jk=".$jk;
...
$smarty->assign ("KODE_NEGARA", $kode_negara);
$smarty->assign ("KODE_KLASIFIKASI_WNI", $kode_klasifikasi_wni);
$smarty->assign ("KODE_SEKTOR", $kode_sektor);
$smarty->assign ("KODE_JENIS", $kode_jenis);
$smarty->assign ("JK", $jk);
...
if ($_GET['tahun'] != '')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$sql__="select * , upper(nama_negara) as nama_negara from tbl_mast_negara where kode_negara='$_GET[kode_negara]' ";
				$rs__=$db->Execute($sql__);			  
				 $nama_negara = $rs__->fields['nama_negara']; 				 
				 $smarty->assign ("NAMA_NEGARA", $nama_negara); 
...
$sql_negara= "select IFNULL(count(*),0) as orang, nama_negara, tbl_mast_negara.kode_negara from tbl_kasus_pengaduan
...
inner  JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan 
 ...
 inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where 1=1 ";
			 if ($kode_kasus!='') { 
			  $sql_negara.= "  AND tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus' ";
			  }


			  if ($tahun!='') { 
			  $sql_negara.= "  AND year(tgl_pengaduan)='$tahun' ";		
			  
			  }

			  if ($bulan!='') { 
			 $sql_negara.= "  and month(tgl_pengaduan)='$bulan' ";		
			 	 ...
			 	 if ($kode_klasifikasi_wni !='') { 
					 $sql_negara.= " AND kode_sumber='$kode_klasifikasi_wni' ";
					 }
							 if ($kode_jenis !='') { 
									 $sql_negara.= " and tbl_wni.kode_jenis='$kode_jenis' ";
							 }
  
							  if ($jk!='') { 
								  $sql_negara.= "  AND jk='$jk' ";
							 }

							
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql_negara.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql_negara.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql_negara.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql_negara.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}

							if ($kode_kawasan!='') { 
								  $sql_negara.= "  AND tbl_mast_negara.kode_kawasan='$kode_kawasan' ";
							 }


				$sql_negara.=" group by tbl_mast_negara.kode_negara  ";
 
 				
				$numresults3=$db->Execute($sql_negara);
				$count2 = $numresults3->RecordCount();
 				$recordSet3 = $db->Execute($sql_negara);
				$end2 = $recordSet3->RecordCount();
				
				$jml = $recordSet3->fields['orang']; 
				$initSet3 = array();
				$data_tb4 = array();
				$row_class2 = array();
				$z=0;
				while ($arr3=$recordSet3->FetchRow()) {
					...
					//$content_data .= print_content($z+1,$arr3[nm_perwakilan],$arr3[orang],$arr3[jml_status_selesai],$arr3[jml_selisih]);
					
					array_push($data_tb4, $arr3);
					if ($z%2==0){ 
...
$sql_negara_total= "select  IFNULL(count(*),0)  as jml_orang_negara  from tbl_kasus_pengaduan
inner join   tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan 
left  join   tbl_mast_negara  on tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara 
 inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan 
inner  JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan 
 ...
 inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where 1=1 ";
			 if ($kode_kasus!='') { 
			  $sql_negara_total.= "  AND tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus' ";
			  }


			  if ($tahun!='') { 
			  $sql_negara_total.= "  AND year(tgl_pengaduan)='$tahun' ";		
			  
			  }

			  if ($bulan!='') { 
			 $sql_negara_total.= "  and month(tgl_pengaduan)='$bulan' ";		
			 	 ...
			 	 if ($kode_klasifikasi_wni !='') { 
					 $sql_negara_total.= " AND kode_sumber='$kode_klasifikasi_wni' ";
					 }
							 if ($kode_jenis !='') { 
									 $sql_negara_total.= " and tbl_wni.kode_jenis='$kode_jenis' ";
							 }
  
							  if ($jk!='') { 
								  $sql_negara_total.= "  AND jk='$jk' ";
							 }

							
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql_negara_total.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql_negara_total.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql_negara_total.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql_negara_total.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}

							if ($kode_kawasan!='') { 
								  $sql_negara_total.= "  AND tbl_mast_negara.kode_kawasan='$kode_kawasan' ";
							 }
				...
				$rs_negara_total=$db->Execute($sql_negara_total);
				$total_jumlah_negara = $rs_negara_total->fields['jml_orang_negara'];
$smarty->assign ("TOTAL_JML_NEGARA", $total_jumlah_negara);


//AKHIR PILIHAN NEGARA
//AKHIR PILIHAN NEGARA
if ($kode_kasus =='') { 
				if ($bulan =='') {	

					
						$sql_detail = " select kode_perwakilan, nm_perwakilan, 						
						...
						where tbl_kasus_pengaduan.kode_perwakilan =a.kode_perwakilan   and year(tgl_pengaduan)='$tahun'   ";
							 ...
							 if ($kode_jenis !='') { 
							  ...
							  if ($jk!='') { 
								  $sql_detail.= "  AND jk='$jk' ";
							 }

							
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql_detail.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql_detail.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql_detail.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql_detail.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}
						...
						where v_kasus_rekap.kode_perwakilan = a.kode_perwakilan
						...
						$sql_detail.=" ),0) as jml_status_selesai ,
						...
						from  v_kasus_rekap 	inner join tbl_wni on v_kasus_rekap.kode_wni = tbl_wni.kode_wni   where v_kasus_rekap.kode_perwakilan = a.kode_perwakilan
						and   v_kasus_rekap.thn_pengaduan = '$tahun' ";
						...
						if ($kode_negara !='') {
							$sql_detail.= "  and a.kode_negara='$kode_negara' "; 
						}
		...
		if ($bulan =='') {	
						...
						$sql_detail.=" ),0) jml_status_selesai , 
						...
						inner join  tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan 
						inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus 
						inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni	where tbl_kasus_pengaduan.kode_perwakilan =a.kode_perwakilan   and year(tgl_pengaduan)='$tahun' and tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus' ";
...
//echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>".$sql_detail;
 ...
 if ($kode_kasus=='') { 
					if ($bulan =='') {	
						...
						$sql3="select count(*) as tot_jm_kasus from tbl_kasus_pengaduan  inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan =   tbl_kasus_pengaduan.kode_form_pengaduan 
						 inner join tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus						
						 inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan
						 left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara
						 inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni
						 where year(tgl_pengaduan)='$tahun' ";
							...
							if ($kode_negara !='') {
							$sql3.= "  and tbl_mast_perwakilan.kode_negara='$kode_negara' "; 
							}
							...
							if ($kode_klasifikasi_wni !='') { 
									  $sql3.= " AND kode_sumber='$kode_klasifikasi_wni' ";
  							 }
							 if ($kode_jenis !='') { 
									 $sql3.= " and tbl_wni.kode_jenis='$kode_jenis' ";
							 }
							...
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql3.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql3.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql3.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql3.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}
						...
						$sql4="select sum(status_selesai)as jml_status_selesai  from  v_kasus_rekap inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = v_kasus_rekap.kode_perwakilan
						  left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara inner join tbl_wni on v_kasus_rekap.kode_wni = tbl_wni.kode_wni  where  
						  v_kasus_rekap.thn_pengaduan = '$tahun' ";
							
							if ($kode_negara !='') {
							$sql4.= "  and tbl_mast_perwakilan.kode_negara='$kode_negara' "; 
							}
						   ...
						   if ($kode_klasifikasi_wni !='') { 
									  $sql4.= " AND kode_sumber='$kode_klasifikasi_wni' ";
  							 }
							 if ($kode_jenis !='') { 
									 $sql4.= " and tbl_wni.kode_jenis='$kode_jenis' ";
							 }
							...
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql4.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql4.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql4.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql4.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}
						...
						$sql3="select count(*) as tot_jm_kasus from tbl_kasus_pengaduan  inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus   inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan
						 left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  	inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni  where    year(tgl_pengaduan)='$tahun'  and month(tgl_pengaduan)='$bulan' ";
						...
						$sql4= "select sum(status_selesai)as jml_status_selesai from  v_kasus_rekap   inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = v_kasus_rekap.kode_perwakilan
						  left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara inner join tbl_wni on v_kasus_rekap.kode_wni = tbl_wni.kode_wni  where v_kasus_rekap.thn_pengaduan = '$tahun'  and  v_kasus_rekap.bln_pengaduan ='$bulan' ";
...
if ($bulan =='') {	
						...
						$sql3="select count(*) as tot_jm_kasus from tbl_kasus_pengaduan  inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus   inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan
						 left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara 	inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where    year(tgl_pengaduan)='$tahun'  and tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus' ";
						...
						$sql3="select count(*) as tot_jm_kasus from tbl_kasus_pengaduan  inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus   inner join tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan
						 left  JOIN tbl_mast_negara ON tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara 	inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where    year(tgl_pengaduan)='$tahun'  and month(tgl_pengaduan)='$bulan'  and tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus' ";
...
if ($kode_kasus !='') {  // ada pilihan kasus
					...
					inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan
					 ...
					 where    year(tgl_pengaduan)='$tahun' and month(tgl_pengaduan)='$bulan'  and  tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus'  ";
						...
						if ($kode_kawasan !='') {
						 ...
						 if ($kode_klasifikasi_wni !='') { 
 $sql7.= " AND kode_sumber='$kode_klasifikasi_wni' ";
 }
							 if ($kode_jenis !='') { 
									 $sql7.= " and tbl_wni.kode_jenis='$kode_jenis' ";
							 }
							...
							if ($usia!='') { 
								  if ($usia=='1') { 
									  $sql7.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 0 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 20  ";
								 }

								 if ($usia=='2') { 
									  $sql7.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 21 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 40  ";
								 }

								  if ($usia=='3') { 
									  $sql7.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >= 41 AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) <= 60  ";
								 }


								   if ($usia=='4') { 
									  $sql7.= "  AND ( CASE  WHEN  year(tgl_lahir)='' then 0  WHEN  year(tgl_lahir)='1' then 0 WHEN  year(tgl_lahir) IS NULL then 0 else   YEAR(CURDATE())  -  YEAR(tgl_lahir) end ) >=60 ";
								 } 
							}
 ...
 $sql_kawasan.= " AND kode_sumber='$kode_klasifikasi_wni' ";
					...
					inner join   tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan 
					left  join   tbl_mast_negara  on tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara 
					inner  JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan 	inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus  inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where year(tgl_pengaduan)='$tahun'  and  tbl_kasus_pengaduan_detail.kode_kasus='$kode_kasus'     ";
 ...
 $sql7.= " AND kode_sumber='$kode_klasifikasi_wni' ";
				...
				if ($bulan !='') {			 
					...
					inner join   tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan 
					left join   tbl_mast_negara  on tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara 
					inner  JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus  inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where year(tgl_pengaduan)='$tahun' and month(tgl_pengaduan)='$bulan' ";
					if ($kode_kawasan !='') {
							$sql7.= " and tbl_mast_kawasan.kode_kawasan='$kode_kawasan'  "; 
					 }
 ...
 $sql7.= " AND kode_sumber='$kode_klasifikasi_wni' ";
			...
			if ($bulan =='') {
					...
					inner join   tbl_mast_perwakilan on tbl_mast_perwakilan.kode_perwakilan = tbl_kasus_pengaduan.kode_perwakilan 
					left  join   tbl_mast_negara  on tbl_mast_negara.kode_negara = tbl_mast_perwakilan.kode_negara  inner join tbl_kasus_pengaduan_detail on tbl_kasus_pengaduan_detail.kode_form_pengaduan = tbl_kasus_pengaduan.kode_form_pengaduan 
					inner  JOIN tbl_mast_kawasan ON tbl_mast_negara.kode_kawasan=tbl_mast_kawasan.kode_kawasan  	inner join  tbl_mast_kasus on tbl_mast_kasus.kode_kasus = tbl_kasus_pengaduan_detail.kode_kasus  inner join tbl_wni on tbl_kasus_pengaduan.kode_wni = tbl_wni.kode_wni where year(tgl_pengaduan)='$tahun'    ";
					if ($kode_kawasan !='') {
							$sql7.= " and    tbl_mast_kawasan.kode_kawasan='$kode_kawasan'  "; 
						}
