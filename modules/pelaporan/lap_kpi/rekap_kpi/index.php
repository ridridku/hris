...
require_once($DIR_HOME.'../laporan/inc.rekap_kpi.php');  
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/pelaporan/lap_kpi/rekap_kpi';
 
#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/pelaporan/lap_kpi');
$FILE_JS  = $JS_MODUL.'/rekap_kpi';
				           ...
				           $sql  = "SELECT
                                                  ...
                                                  FROM
                                                    ...
                                                    INNER JOIN r_departement
                                                      ON r_departement.r_dept__id = r_subdepartement.r_subdept__dept WHERE r_cabang__id= '".$kode_pw_ses."' ";
			} else {
					   $sql  = "SELECT
                                                    r_kpi.r_kpi__id AS r_kpi__id,
                                                    r_kpi.r_kpi__finger AS r_kpi__finger,
                                                  ...
                                                  FROM
                                                    ...
                                                    INNER JOIN r_subdepartement
                                                      ON r_subdepartement.r_subdept__id = r_pnpt__subdept
                                                    INNER JOIN r_departement
                                                      ON r_departement.r_dept__id = r_subdepartement.r_subdept__dept WHERE 1=1 ";	
						...
						if ($nama_karyawan_cari !='') {
						 	$sql.="and r_pegawai__nama LIKE '%".$nama_karyawan_cari."%'  ";
                                                 ...
                                                 if ($finger_cari !='') {
						 	$sql.="and r_kpi__finger LIKE '%".$finger_cari."%'  ";
						 }
//                                               
							...
							while ($arr=$recordSet->FetchRow()) {
								array_push($data_tb, $arr);
                                                        ...
                                                        $smarty->assign ("MUTASI_PEG", $kpi_mutasi);
                                                         ...
                                                         $bulan_kpi=tampil_bulan($arr[r_kpi__bulan]);
                                                        ...
                                                        $arr[r_dept__ket],
                                                        $bulan_kpi,
                                                        $arr[r_kpi__tahun],//tenor
                                                        $arr[r_kpi__nilai],//total bayar
                                                        $arr[r_kpi__keterangan]);	
						...
						if ($nama_karyawan_cari !='') {
						 	$sql_total.="and r_pegawai__nama LIKE '%".$nama_karyawan_cari."%'  ";
                                                 ...
                                                 if ($finger_cari !='') {
						 	$sql_total.="and r_kpi__finger LIKE '%".$finger_cari."%'  ";
						 }
//                                               
				...
				array_push($initSet4, $z);
					...
					$content_data .= print_content("","","","","","","","",$label);
                               ...
                               //TUTUP TOTAL 
				$file= $DIR_HOME."/files/kpi_".$nm_perwakilan."_".$tahun.".xls";
				$fp=@fopen($file,"w");
				if(!is_resource($fp))
				return false;
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/kpi_".$nm_perwakilan."_".$tahun.".xls";	
