...
$sql_pendidikan ="SELECT peg.r_pnpt__nip AS r_pnpt__nip, 
                ...
                DATE_FORMAT(peg.r_pegawai__pend_tgl_lulus,'%d-%m-%Y')  AS r_pegawai__pend_tgl_lulus,
                peg.r_pegawai__pend_jurusan AS r_pegawai__pend_jurusan  
                from v_pegawai peg where peg.r_pnpt__nip ='$nip_karyawan_cari' GROUP BY r_pnpt__nip ";
...
$sql_pelatihan ="SELECT
r_pelatihan.r_pel__id AS r_pel__id,
r_pelatihan.r_pel__no_sertifikat AS r_pel__no_sertifikat,
r_pelatihan.r_pel__nip AS r_pel__nip,
r_pelatihan.r_pel__tema AS r_pel__tema,
r_pelatihan.r_pel__tgl_awal AS r_pel__tgl_awal,
r_pelatihan.r_pel__tgl_akhir AS r_pel__tgl_akhir,
r_pelatihan.r_pel__pelaksana AS r_pel__pelaksana
FROM
r_pelatihan where r_pel__nip  ='$nip_karyawan_cari' order by r_pel__id ";

//var_dump($sql_pelatihan) or die();
$recordSet_pelatihan = $db->Execute($sql_pelatihan);
$initSet = array();
$data_pelatihan= array();
$z=0;
while ($arr=$recordSet_pelatihan->FetchRow()) {
	array_push($data_pelatihan, $arr);
	array_push($initSet, $z);
	$z++;
}
$smarty->assign ("PELATIHAN", $data_pelatihan);
		  ...
		  if($jenis_user=='2'){
                                            ...
                                            $sql  ="SELECT
                                                ...
                                                DATE_FORMAT(r_pegawai.r_pegawai__tgl_lahir,'%d-%m-%Y') AS r_pegawai__tgl_lahir,
...
//                                        $approval_status);
				...
				$next_prev = $p->nextPrevCustom($page, $pages, "ORDER=".$ORDER."&".$str_completer); 
                                ...
                                $no_mutasi = $data_tb[0][r_pnpt__no_mutasi];
...
//				fclose($fp);
          ...
          $file_2= $HREF_HOME."/laporan/inc.detail_pegawai.php?nm_perwakilan=".$nm_perwakilan."&nip=".$nip."&no_mutasi=".$no_mutasi; 
