...
require_once($DIR_HOME.'../laporan/inc.sp_detail.php');  
...
//                                 $label_tahun=$arr[label_tahun];
       ...
       //$file_2= $HREF_HOME."/laporan/inc.sp2.php?nm_perwakilan=".$nm_perwakilan."&bulan=".$bulan."&tahun=".$tahun."&jenis=".$jenis_sp."&nip=".$nip."&r_pegawai__nama=".$r_pegawai__nama."&r_cabang__nama=".$r_cabang__nama."&r_dept__ket=".$r_dept__ket."&t_sp__tgl=".$t_sp__tgl."&t_sp__alasan=".$t_sp__alasan."&kode_pw_ses=".$kode_pw_ses;
          $file_2= $HREF_HOME."/laporan/inc.sp2.php?nm_perwakilan=".$nm_perwakilan."&bulan=".$bulan."&tahun=".$tahun."&nip=".$nip."&no=".$no;                     
}
