...
require_once($DIR_HOME.'../laporan/inc.rekap_training.php');  
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/pelaporan/lap_training/rekap_training';
 
#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/pelaporan/lap_training');
$FILE_JS  = $JS_MODUL.'/rekap_training';
        ...
        $smarty->assign ("NM_PERWAKILAN", $nm_perwakilan);	
              ...
              if($jenis_user=='2'){
				           $sql  = "SELECT
                                                    ...
                                                    r_pelatihan.r_pel__id AS r_pel__id,
                                                    r_pelatihan.r_pel__mutasi AS r_pel__mutasi,
                                                    r_pelatihan.r_pel__master_pel AS r_pel__master_pel,
                                                    r_pelatihan.r_pel__tema AS r_pel__tema,
                                                    r_pelatihan.r_pel__no_sertifikat AS r_pel__no_sertifikat,
                                                    r_pelatihan.r_pel__nilai AS r_pel__nilai,
                                                    r_pelatihan.r_pel__document AS r_pel__document,
                                                    r_master_pelatihan.r_mastpel__id AS r_mastpel__id,
                                                    r_master_pelatihan.r_mastpel__mutasi AS r_mastpel__mutasi,
                                                    r_master_pelatihan.r_mastpel__email_pic AS r_mastpel__email_pic,
                                                    r_master_pelatihan.r_mastpel__tema AS r_mastpel__tema,
                                                    r_master_pelatihan.r_mastpel__tgl_awal AS r_mastpel__tgl_awal,
                                                    r_master_pelatihan.r_mastpel__tgl_akhir AS r_mastpel__tgl_akhir,
                                                    r_master_pelatihan.r_mastpel__penyelenggara AS r_mastpel__penyelenggara,
                                                    r_master_pelatihan.r_mastpel__jenis AS r_mastpel__jenis,
                                                    r_master_pelatihan.r_mastpel__deskripsi AS r_mastpel__deskripsi,
                                                    r_master_pelatihan.r_mastpel__tempat AS r_mastpel__tempat,
                                                    r_master_pelatihan.r_mastpel__status AS r_mastpel__status
                                                    ...
                                                    INNER JOIN r_pelatihan ON r_pelatihan.r_pel__mutasi = r_pnpt__no_mutasi
                                                    INNER JOIN r_master_pelatihan ON r_master_pelatihan.r_mastpel__id = r_pelatihan.r_pel__master_pel WHERE r_cabang__id= '".$kode_pw_ses."' ";
			} else {
					   $sql  = "SELECT
                                                    r_penempatan.r_pnpt__nip AS r_pnpt__nip,
                                                    r_penempatan.r_pnpt__no_mutasi AS r_pnpt__no_mutasi,
                                                    ...
                                                    INNER JOIN r_cabang ON r_cabang.r_cabang__id = r_subcabang.r_subcab__cabang
                                                    INNER JOIN r_pelatihan ON r_pelatihan.r_pel__mutasi = r_pnpt__no_mutasi
                                                    INNER JOIN r_master_pelatihan ON r_master_pelatihan.r_mastpel__id = r_pelatihan.r_pel__master_pel WHERE 1=1 ";	
						...
						if ($nama_karyawan_cari !='') {
						 	$sql.="and r_pegawai__nama LIKE '%".$nama_karyawan_cari."%'  ";
                                                  ...
                                                  if ($tema_cari !='') {
						 	$sql.="and r_mastpel__tema LIKE '%".$tema_cari."%'  ";
						 }
							...
							while ($arr=$recordSet->FetchRow()) {
								array_push($data_tb, $arr);
                                                ...
                                                $content_data .= print_content(
                                                        ...
                                                        $arr[r_dept__ket],
                                                        $arr[r_mastpel__tema],
                                                        $arr[r_mastpel__penyelenggara],//tenor
                                                        $arr[r_pel__nilai],//total bayar
                                                        $arr[r_mastpel__tgl_awal]);	
                                                ...
                                                //total karyawan
                                                $sql_total="SELECT COUNT(r_pelatihan.r_pel__id) AS total_orang
                                                    FROM r_pegawai
                                                    INNER JOIN r_penempatan ON r_penempatan.r_pnpt__id_pegawai = r_pegawai.r_pegawai__id
                                                    INNER JOIN r_jabatan ON r_penempatan.r_pnpt__jabatan = r_jabatan.r_jabatan__id
                                                    INNER JOIN r_subdepartement ON r_penempatan.r_pnpt__subdept = r_subdepartement.r_subdept__id
						...
						if ($departemen_cari !=''  ) {
						 	$sql_total.="  and r_dept__id='$departemen_cari' ";
                                                 ...
                                                 if ($bulan !=''  ) {
                                                   $sql_total.="  and MONTH(r_mastpel__tgl_awal)='$bulan' ";
                                                     } 
                                                if ($tahun !=''  ) {
                                                               $sql_total.="  and YEAR(r_mastpel__tgl_awal)='$tahun' ";
                                                        } 
						if ($nama_karyawan_cari !='') {
						 	$sql_total.="and r_pegawai__nama LIKE '%".$nama_karyawan_cari."%'  ";
						 }
                                                  if ($tema_cari !='') {
						 	$sql_total.="and r_mastpel__tema LIKE '%".$tema_cari."%'  ";
						 }
				...
				array_push($initSet4, $z);
					...
					$content_data .= print_content("","","","","","","","",$label);
                               ...
                               //TUTUP TOTAL 
				$file= $DIR_HOME."/files/Training_".$nm_perwakilan."_".$tahun.".xls";
				$fp=@fopen($file,"w");
				if(!is_resource($fp))
				return false;
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/Training_".$nm_perwakilan."_".$tahun.".xls";	
