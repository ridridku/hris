...
$smarty->assign ("HREF_HOME_PATH_AJAX", $HREF_HOME.'/modules/manfaat/angsuran_verifikasi');
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/manfaat/angsuran_verifikasi';
#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/manfaat');
$FILE_JS  = $JS_MODUL.'/angsuran_verifikasi';
...
if($opt=="1"){ 
                        ...
                        $sql_ = "SELECT
                                            ...
                                            DATE_FORMAT(t_angsuran_pinjaman.t_ang__tanggal,'%Y-%m-%d') AS t_ang__tanggal,
                                            ...
                                            WHERE t_ang__jenis ='".$_GET['id']."' AND t_ang__nopjm='".$_GET['no_pjm']."' AND t_ang__mutasi='".$_GET['mutasi_pjm']."' AND t_ang__tanggal='".$_GET['tgl_pjm']."' ";
...
$edit_t_ang__jenis = $resultSet->fields[t_ang__jenis];
$edit_t_ang__nopjm = $resultSet->fields[t_ang__nopjm];
$edit_t_ang__mutasi = $resultSet->fields[t_ang__mutasi];
$edit_t_ang__tanggal = $resultSet->fields[t_ang__tanggal];
$edit_t_ang__nilai_angsuran = $resultSet->fields[t_ang__nilai_angsuran];
$edit_t_ang__angsuran_ke = $resultSet->fields[t_ang__angsuran_ke];
...
$smarty->assign ("EDIT_T_ANG__JENIS",$edit_t_ang__jenis);
$smarty->assign ("EDIT_T_ANG__NOPJM",$edit_t_ang__nopjm);
$smarty->assign ("EDIT_T_ANG__MUTASI",$edit_t_ang__mutasi);
$smarty->assign ("EDIT_T_ANG__TGL",$edit_t_ang__tanggal);
$smarty->assign ("EDIT_T_ANG__NILAI",$edit_t_ang__nilai_angsuran);
$smarty->assign ("EDIT_T_ANG__KE",$edit_t_ang__angsuran_ke);


$smarty->assign ("EDIT_R_CABANG__ID",$edit_r_cabang__id);
$smarty->assign ("EDIT_MUTASI",$edit_r_pnpt__no_mutasi);
$smarty->assign ("EDIT_NIP",$edit_r_pnpt__nip);
$smarty->assign ("EDIT_NAMA",$edit_r_pegawai__nama);
