...
$smarty->assign ("HREF_FOTO", $HREF_HOME.'/modules/training/training_recorded/uploads');
$smarty->assign ("HREF_HOME_PATH_AJAX", $HREF_HOME.'/modules/training/training_recorded');
...
$sql_cek_no="SELECT count(A.r_pel__id) as no_pel FROM r_pelatihan A";
		  ...
		  if($jenis_user=='2'){
                                  ...
                                  $sql  = "SELECT
                                    ...
                                    peg.r_pegawai__nama AS r_pegawai__nama
                                     FROM r_pelatihan B
                                    INNER JOIN r_master_pelatihan C ON C.r_mastpel__id = B.r_pel__master_pel
                                    INNER JOIN v_pegawai peg ON peg.r_pnpt__no_mutasi=B.r_pel__mutasi WHERE 1 = 1  AND r_cabang__id= '".$kode_pw_ses."' ";
                           ...
                           $sql  = "SELECT
                                    ...
                                    r_pelatihan B
                                    INNER JOIN r_master_pelatihan C ON C.r_mastpel__id = B.r_pel__master_pel
                                    INNER JOIN v_pegawai peg ON peg.r_pnpt__no_mutasi=B.r_pel__mutasi WHERE 1=1 ";	
