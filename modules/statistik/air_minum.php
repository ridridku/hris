...
<script type="text/javascript">
 ...
 ?>
	...
	<center>
<form method="post" action="air_minum.php"  >
...
WHERE
	1 = 1
AND date(r_kpi__date_updated) BETWEEN '2016-01-21'
AND '2016-10-21'
AND r_pegawai__nama LIKE '%barid%'
order by r_kpi__id ASC  "; 
	...
	echo renderChart("FusionCharts/MSLine.swf", "", $strXML, "myChart", 900, 350, false, true);
