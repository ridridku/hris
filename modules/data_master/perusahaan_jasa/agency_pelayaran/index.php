...
// themes\defaults\javascripts\modules\data_master\perusahaan_jasa\agency_pelayaran
...
if ($_GET['nama_agency']) $NAMA_AGENCY = $_GET['nama_agency'];
else if ($_POST['nama_agency']) $NAMA_AGENCY = $_POST['nama_agency'];
else $NAMA_AGENCY="";

  

$smarty->assign ("NAMA_AGENCY", $NAMA_AGENCY);


$str_completer = "mod_id=".$mod_id."&limit=".$LIMIT."&SORT=".$SORT."&kode_agency=".$KODE_AGENCY."&nama_agency=".$NAMA_AGENCY."&kode_jenis_agency=".$KODE_JENIS_AGENCY."&alamat_agency=".$ALAMAT_AGENCY."&tlp_agency=".$TLP_AGENCY;
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$sql  = "SELECT *, tbl_mast_agency_pelayaran.alamat_agency, tbl_mast_agency_pelayaran.tlp_agency ";
				$sql .= "FROM ".$tbl_name." ";
				$sql .= "WHERE 1=1 ";

			 
				if($NAMA_AGENCY!=''){
					$sql .= "AND nama_agency LIKE '%".$NAMA_AGENCY."%' ";
				}
...
$smarty->assign ("TABLE_CAPTION", _CAPTION_TABLE_AGENCY);
$smarty->assign ("TABLE_NAME", _NAMA_TABLE_AGENCY);
$smarty->assign ("FORM_NAME", _FORM);
$smarty->assign ("TITLE", _TITLE_AGENCY);
...
$smarty->assign ("LIST", _LIST_AGENCY);
