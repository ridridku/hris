...
$user_id = base64_decode($_SESSION['UID']);
 ...
 $sql2="INSERT INTO tbl_log (url, waktu, module, user_id ) VALUES ('$ip_now',now(),'Hapus data >> master Negara','$user_id') ";
 $db->Execute($sql2);
}
...
global $db;
			...
			$sql_edit  ="UPDATE tbl_mast_negara ";
			$sql_edit .=" SET nama_negara='$_POST[nama_negara]', ";
  	        $sql_edit .=" kode_kawasan='$_POST[kode_kawasan]' ";
		          			 
			$sql_edit .="WHERE kode_negara ='$_POST[kode_negara]' ";
            
			$sqlresult4 = $db->Execute($sql_edit);
			$ip_now = $_SERVER['REMOTE_ADDR'];
$user_id = base64_decode($_SESSION['UID']);
 $sql2="INSERT INTO tbl_log (url, waktu, module, user_id )  VALUES ('$ip_now',now(),'Ubah data >> master Negara','$user_id') ";
 $db->Execute($sql2);
...
function create_($kode_negara,$name,$kode_kawasan){
global $mod_id;	
global $db;
global $tbl_name;
global $field_name;
...
$ip_now = $_SERVER['REMOTE_ADDR'];
$user_id = base64_decode($_SESSION['UID']);
 $sql2="INSERT INTO tbl_log (url, waktu, module, user_id )  VALUES ('$ip_now',now(),'Tambah Data >> master Negara','$user_id') ";
 $db->Execute($sql2);
}
