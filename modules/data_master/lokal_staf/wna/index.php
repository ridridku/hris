...
$smarty->assign ("HREF_HOME_PATH_AJAX", $HREF_HOME.'/modules/data_master/lokal_staf/wna');
...
if ($_GET['kode_wna']) $KODE_WNA = addslashes($_GET['kode_wna']);
else if ($_POST['kode_wna']) $KODE_WNA = addslashes($_POST['kode_wna']);
else $KODE_WNA="";

 
if ($_GET['nama_wna']) $NAMA_WNA = addslashes($_GET['nama_wna']);
else if ($_POST['nama_wna']) $NAMA_WNA = addslashes($_POST['nama_wna']);
else $NAMA_WNA="";
 

$smarty->assign ("KODE_WNA", $KODE_WNA);
$smarty->assign ("NAMA_WNA", $NAMA_WNA);
...
// SHOW DATA NEGARA ========================
$sql_data_negara_show = "SELECT  *  FROM tbl_mast_negara order by nama_negara ASC ";
