...
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/data_master/perwakilan');
$FILE_JS  = $JS_MODUL.'/bha';
...
$SES_JENIS_USER		= $_SESSION['JENIS_USER'];
 ...
 IF ($_GET['ERR'] =='5') {
	 $label_error = "KODE BADAN USAHA ASING SUDAH ADA";
 } else {
