...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/data_master/perwakilan/kutap';

#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/data_master');
$FILE_JS  = $JS_MODUL.'/perwakilan/kutap';
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
			...
			$sql  = "select * from tbl_mast_perwakilan left join tbl_mast_negara on tbl_mast_negara.kode_negara =  tbl_mast_perwakilan.kode_negara where 1=1  and kode_jenis_pw=4 ";
