...
global $tbl_name;
global $field_name;
$sql	 = "INSERT INTO tbl_mast_perwakilan_asing (`kode_perwakilan_asing`,`nama_perwakilan`,`alamat`,`tlp`,kode_jenis_pw,fax,email) ";
$sql	.= " VALUES ('".strip_tags($kode_perwakilan_asing)."','".strip_tags($nama_perwakilan)."','".strip_tags($alamat)."','".strip_tags($tlp)."','2','$_POST[fax]','$_POST[email]')";
