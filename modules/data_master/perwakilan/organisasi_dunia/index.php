...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/data_master/perwakilan/organisasi_dunia';

#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/data_master');
$FILE_JS  = $JS_MODUL.'/perwakilan/organisasi_dunia';
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$sql  = "select * from tbl_mast_perwakilan_asing where 1=1  and kode_jenis_pw=2 ";
