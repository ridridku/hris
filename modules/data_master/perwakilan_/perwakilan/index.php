...
$str_completer = "mod_id=".$mod_id."&limit=".$LIMIT."&SORT=".$SORT."&kode_perwakilan=".$KODE_PERWAKILAN."&nm_perwakilan=".$NAMA_PERWAKILAN."&nami=".$NAMI."&kode_negara=".$KODE_NEGARA;
...
if($opt=="1"){
	...
	$edit_nami = $resultSet->fields[nami];
