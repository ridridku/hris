...
function edit_($kode_perwakilan,$nm_perwakilan, $alamat, $kode_negara){
global $mod_id;
global $db;
global $tbl_name;
global $field_name;
...
$sql	.= " VALUES ('".strip_tags($kode_perwakilan)."','".strip_tags($nm_perwakilan)."','".strip_tags($alamat)."','".strip_tags($kode_negara)."')";
