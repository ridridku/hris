...
if($_GET[get_paket]==1) {
	...
	$sql_jns_jln = "SELECT a.id_jns_jln,b.id_fjl_05_detail,b.nama_paket FROM tbl_form_jl_05_main a LEFT JOIN tbl_form_jl_05_detail b ON 					
	a.id_fjl_05_main=b.id_fjl_05_main WHERE b.nama_paket='".$isi_paket."' AND b.id_fjl_05_detail IS NOT NULL";
