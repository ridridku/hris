...
$opt = $_GET[opt];
$id_form_ur_02_jp_main = $_GET[id_form_ur_02_jp_main];
$id_form_ur_02_jp_detail = $_GET[id_form_ur_02_jp_detail];
$ed = 0;

if ($opt=="1" AND $id_form_ur_02_jp_main<>'' AND $id_form_ur_02_jp_detail<>'') {

$sql = "SELECT * 
		FROM ".$tbl_name_detail." a LEFT JOIN ".$tbl_name_main." b ON a.id_form_ur_02_jp_main=b.id_form_ur_02_jp_main  
		WHERE 1=1 AND a.id_form_ur_02_jp_main='".$id_form_ur_02_jp_main."' AND a.id_form_ur_02_jp_detail='".$id_form_ur_02_jp_detail."' ";
$recordSet_Edit = $db->execute($sql);

$edit = 1;	

$smarty->assign ("OPT", $opt);					
$smarty->assign ("ID_FORM_UR_02_JP_MAIN", $recordSet_Edit->fields[id_form_ur_02_jp_main]);
$smarty->assign ("ID_FORM_UR_02_JP_DETAIL", $recordSet_Edit->fields[id_form_ur_02_jp_detail]);
...
$sql_ur1 = "SELECT b.id_form_ur_01_jp_detail,b.kode_proyek FROM tbl_form_ur_01_jp_main a LEFT JOIN tbl_form_ur_01_jp_detail b ON a.id_form_ur_01_jp_main=b.id_form_ur_01_jp_main WHERE a.no_propinsi='".$_GET[no_propinsi]."' and YEAR(a.tanggal)='".$_GET[Date_Year]."' ORDER BY b.kode_proyek ASC";
$recordSet_ur1 = $db->Execute($sql_ur1);

$initSet = array();
$data_ur1 = array();
$z=0;
while ($arr=$recordSet_ur1->FetchRow()) {
	array_push($data_ur1, $arr);
	array_push($initSet, $z);
	$z++;
}
$smarty->assign ("DATA_UR1", $data_ur1);
...
if ($_GET[get_kode] == 1)
{
	...
	$_tahun = $_GET[tahun];
			...
			if($_no_propinsi!='' && $_tahun!=''){	
					$sql_kode 	  = "SELECT b.id_form_ur_01_jp_detail,b.kode_proyek FROM tbl_form_ur_01_jp_main a LEFT JOIN tbl_form_ur_01_jp_detail b ON a.id_form_ur_01_jp_main=b.id_form_ur_01_jp_main WHERE a.no_propinsi='".$_no_propinsi."' and YEAR(a.tanggal)='".$_tahun."' ORDER BY b.kode_proyek ASC";
...
if ($_GET[get_proyek] == 1)
{
	...
	$_kode_proyek = $_GET[kode_proyek];
			...
			if($_no_propinsi!='' && $_tahun!='' && $_kode_proyek!=''){	
					$sql_proyek 	  = "SELECT b.* FROM tbl_form_ur_01_jp_main a LEFT JOIN tbl_form_ur_01_jp_detail b ON a.id_form_ur_01_jp_main=b.id_form_ur_01_jp_main WHERE a.no_propinsi='".$_no_propinsi."' and YEAR(a.tanggal)='".$_tahun."' and b.kode_proyek='".$_kode_proyek."'";
					...
					$input_du_dpp = $result_proyek->fields[du_dpp];
					$input_pjp_dpp = $result_proyek->fields[pjp_dpp];
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				$sql = "SELECT a.id_form_ur_02_jp_main,a.id_form_ur_02_jp_detail,a.kode_proyek,c.nama_prop_jenis_penanganan,a.jumlah_proyek 
				FROM ".$tbl_name_detail." a LEFT JOIN ".$tbl_name_main." b ON a.id_form_ur_02_jp_main=b.id_form_ur_02_jp_main 
...
$smarty->assign ("TABLE_CAPTION", _CAPTION_TABLE_UR_2_JP);
$smarty->assign ("TABLE_NAME", _NAMA_TABLE_UR_2_JP);
...
$smarty->assign ("TITLE", _TITLE_FORM_UR_2_JP);
$smarty->assign ("HEAD_TITLE", _HEAD_TITLE_FORM_UR_2_JP);
...
$smarty->assign ("LIST_ME", _LIST_FORM_UR_2_JP);
