...
require_once($DIR_HOME.'/laporan_excell/inc.jl_09.php');
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/report_laporan/kabupaten/lap_jl_09';

#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/report_laporan');
$FILE_JS  = $JS_MODUL.'/kabupaten/lap_jl_09';
	...
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				***/
				...
				if($no_propinsi!='' AND $no_kabupaten!='' AND $jns_jln!=''){
					$sql .= " AND b.no_propinsi='".$no_propinsi."' AND b.no_kabupaten='".$no_kabupaten."' AND b.triwulan='".$triwulan_search."' AND YEAR(b.tanggal)='".$Search_Year."' AND a.id_jns_jln='".$jns_jln."' ";
				}
				***/
				if($no_propinsi!='' AND $no_kabupaten!='' AND $Search_Year!='' AND $triwulan_search!='' AND $jns_jln==''){
					...
					$sql .= "AND (b.no_propinsi='".$no_propinsi."' $f_no_propinsi) AND (b.no_kabupaten='".$no_kabupaten."' $f_no_kabupaten) AND (a.id_jns_jln='".$jns_jln."' $f_id_jns_jln) AND b.triwulan='".$triwulan_search."' AND YEAR(b.tanggal)='".$Search_Year."' ";
				} else {
				...
				while ($arr=$recordSet->FetchRow()) {
					...
					$content_data .= print_content($z+1,$arr[nama_paket],$arr[tujuan],$arr[manfaat],$arr[keterangan]);
				...
				$file= $DIR_HOME."/files/jl_09_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/jl_09_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
}
...
$smarty->assign ("TITLE", _PRINT_TITLE_JL_09_MAIN);
$smarty->assign ("HEAD_TITLE", _PRINT_HEAD_TITLE_JL_09_MAIN);
...
$smarty->assign ("LIST_ME", _PRINT_LIST_JL_09_MAIN);
