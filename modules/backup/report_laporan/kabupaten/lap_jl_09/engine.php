...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/form_isian/kabupaten/lap_jl_09';


#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/lap_isian');
...
$sql = "update `".$tbl_name_detail."` set `nama_paket`=" .sqlvalue(@$_POST["nama_paket"], true) .", 
		`tujuan`=" .sqlvalue(@$_POST["tujuan"], true) .", `manfaat`=" .sqlvalue(@$_POST["manfaat"], true) .", 
		`keterangan`=" .sqlvalue(@$_POST["keterangan"], true) ." 
		where " ."(`id_fjl_09_detail`=" .sqlvalue(@$_POST["xid_form_jl_09_detail"], false) .")";
...
$sql = "insert into `".$tbl_name_detail."` (`id_fjl_09_main`, `nama_paket`, `tujuan`, `manfaat`, `keterangan`) values (
		(SELECT MAX(id_fjl_09_main) FROM ".$tbl_name_main."), 
		" .sqlvalue(@$_POST["nama_paket"], true) .", 
		" .sqlvalue(@$_POST["tujuan"], true) .", 
		" .sqlvalue(@$_POST["manfaat"], true) .", 
