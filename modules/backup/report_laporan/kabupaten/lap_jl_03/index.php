...
require_once($DIR_HOME.'/laporan_excell/inc.jl_03.php');
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/report_laporan/kabupaten/lap_jl_03';


#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/report_laporan');
$FILE_JS  = $JS_MODUL.'/kabupaten/lap_jl_03';
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				***/
				...
				$sql = "SELECT *,IF(a.rd_dak='1','Ada','Tidak Ada') as rd_dak, if(a.rd='1','Ada','Tidak Ada') as rd,
				if(kelengkapan_gambar='1','Ada','Tidak Ada') as kelengkapan_gambar,
				if(kelengkapan_spesifik='1','Ada','Tidak Ada') as kelengkapan_spesifik,
				if(kelengkapan_rab='1','Ada','Tidak Ada') as kelengkapan_rab
				...
				***/
				...
				while ($arr=$recordSet->FetchRow()) {
					$content_data .= print_content($z+1,$arr[nama_ruas],$arr[kecamatan_yg_dilalui],$arr[rd_dak],$arr[rd],$arr[alasan],$arr[kelengkapan_gambar],$arr[kelengkapan_spesifik],$arr[kelengkapan_rab],$arr[keterangan]);
				...
				$file= $DIR_HOME."/files/jl_03_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/jl_03_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
}
...
$smarty->assign ("TITLE", _PRINT_TITLE_JL_03_MAIN);
$smarty->assign ("HEAD_TITLE", _PRINT_HEAD_TITLE_JL_03_MAIN);
...
$smarty->assign ("TB_KESESUAIAN_RD_DAK", _KESESUAIAN_RD_DAK2);
$smarty->assign ("TB_KESESUAIAN_RD", _KESESUAIAN_RD2);
$smarty->assign ("TB_ALASAN", _ALASAN);
$smarty->assign ("TB_KELENGKAPAN_DOKUMEN", _KELENGKAPAN_DOKUMEN);
$smarty->assign ("TB_GAMBAR", _GAMBAR);
$smarty->assign ("TB_SPESIFIKASI", _SPESIFIKASI);
$smarty->assign ("TB_RAB", _RAB);
$smarty->assign ("TB_KETERANGAN", _KETERANGAN);
$smarty->assign ("SUBMIT", _SUBMIT);
$smarty->assign ("RESET", _RESET);
$smarty->assign ("LIST_ME", _PRINT_LIST_JL_03_MAIN);
