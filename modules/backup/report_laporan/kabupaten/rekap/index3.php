...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				***/
				...
				if ($jns_jln=='1')
				{
				$sql_data_wilayah = "SELECT nama_propinsi FROM tbl_mast_wil_propinsi WHERE no_propinsi='".$no_propinsi."'";
				}
				else
				{				
				...
				{
				$sql="select b.no_kabupaten,c.nama_kabupaten as nama_kabupaten,b.no_propinsi,b.id_jns_jln,a.no_ruas,a.panjang_km as panjang_ruas,a.kondisi_baik as_kon_baik,a.kondisi_sedang as kon_sedang,a.kondisi_rusak as kon_rusak,a.kondisi_rusak_berat as kon_rusak_berat
...
where b.no_propinsi='".$no_propinsi."' and year(tanggal)='".$Search_Year."' and  b.id_jns_jln ='".$jns_jln."' ";				
				}
				else if ($no_propinsi !='' AND $no_kabupaten =='' AND $jns_jln==1)
				{
				$sql="select b.no_kabupaten,c.nama_kabupaten as nama_kabupaten,b.no_propinsi,b.id_jns_jln,a.no_ruas,a.panjang_km as panjang_ruas,a.kondisi_baik as_kon_baik,a.kondisi_sedang as kon_sedang,a.kondisi_rusak as kon_rusak,a.kondisi_rusak_berat as kon_rusak_berat
from tbl_form_jl_02_detail  a join tbl_form_jl_02_main b 
on a.id_fjl_02_main = b.id_fjl_02_main join tbl_mast_wil_kabupaten c on c.no_kabupaten =b.no_kabupaten and c.no_propinsi=b.no_propinsi
where b.no_propinsi='".$no_propinsi."' and year(tanggal)='".$Search_Year."' and  b.id_jns_jln =1 ";			
				}
				else
				{
				$sql="select b.no_kabupaten,c.nama_kabupaten as nama_kabupaten,b.no_propinsi,b.id_jns_jln,a.no_ruas,a.panjang_km as panjang_ruas,a.kondisi_baik as_kon_baik,a.kondisi_sedang as kon_sedang,a.kondisi_rusak as kon_rusak,a.kondisi_rusak_berat as kon_rusak_berat
from tbl_form_jl_02_detail  a join tbl_form_jl_02_main b 
on a.id_fjl_02_main = b.id_fjl_02_main join tbl_mast_wil_kabupaten c on c.no_kabupaten =b.no_kabupaten and c.no_propinsi=b.no_propinsi
where b.no_propinsi='".$no_propinsi."' and year(tanggal)='".$Search_Year."' and  b.id_jns_jln =2 ";				
				}
				//
				...
				while ($arr=$recordSet->FetchRow()) {
					$nama_kabupaten = $arr[nama_kabupaten];
					$panjang_ruas = $arr[panjang_ruas];
					$kon_baik = $arr[kon_baik];
					$kon_sedang = $arr[kon_sedang];
					$kon_rusak = $arr[kon_rusak];
					$kon_rusak_berat = $arr[kon_rusak_berat];
					
					$tot_panjang_ruas = $arr[panjang_ruas]+$tot_panjang_ruas ;
		
					$kon_baik=$arr[kon_baik];
					$baikpersen=number_format(($kon_baik/$arr[panjang_ruas])*100,0);
					//tambahan tuti
					$tot_baik = $kon_baik+$tot_baik ;
					$totbaikpersen=number_format(($tot_baik/$tot_panjang_ruas)*100,0);
					//end tambahan tuti
					
					$kon_sedang=$arr[kon_sedang];
					$sedangpersen=number_format(($kon_sedang/$arr[panjang_ruas])*100,0);
					//tambahan tuti
					$tot_sedang = $kon_sedang+$tot_sedang ;
					$totsedangpersen=number_format(($tot_sedang/$tot_panjang_ruas)*100,0);
					//end tambahan tuti
					
					$kon_rusak=$arr[kon_rusak];
					$rusakpersen=number_format(($kon_rusak/$arr[panjang_ruas])*100,0);
					//tambahan tuti
					$tot_rusak = $kon_rusak+$tot_rusak ;
					$totringanpersen=number_format(($tot_rusak/$tot_panjang_ruas)*100,0);
					//end tambahan tuti
					
					$kon_rusak_berat=$arr[kon_rusak_berat];
					$rbpersen=number_format(($kon_rusak_berat/$arr[panjang_ruas])*100,0);
					//tambahan tuti
					$tot_rusak_berat = $kon_rusak_berat+$tot_rusak_berat ;
					$totberatpersen=number_format(($tot_rusak_berat/$tot_panjang_ruas)*100,0);
					//end tambahan tuti
					
					
					$content_data .= print_content($arr[nama_kabupaten],$arr[panjang_ruas],
					$arr[kon_baik]."(".$baikpersen."%)",
					$arr[kon_sedang]."(".$sedangpersen."%)",
					$arr[kon_rusak]."(".$rusakpersen."%)",
					$arr[kon_rusak_berat]."(".$rbpersen."%)",
					$tot_panjang_ruas,
					$tot_baik."(".$totbaikpersen."%)",$tot_sedang."(".$totsedangpersen."%)",$tot_rusak."(".$totringanpersen."%)",$tot_rusak_berat."(".$totberatpersen."%)");
				...
				if ($jns_jln=='1')
				{
				$file= $DIR_HOME."/files/rekap_".$no_propinsi."_propinsi_".$jns_jln."_".$Search_Year.".xls";
				}
				else
				{
				$file= $DIR_HOME."/files/rekap_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
				}
				...
				if ($jns_jln=='1')
				{
				$file_2= $HREF_HOME."/files/rekap_".$no_propinsi."_propinsi_".$jns_jln."_".$Search_Year.".xls";
				}
				else
				{
				$file_2= $HREF_HOME."/files/rekap_".$no_propinsi."_".$no_kabupaten."_".$jns_jln."_".$Search_Year.".xls";
				}
...
$smarty->assign ("DATA_TOT_RINGAN", $tot_rusak);
$smarty->assign ("DATA_TOT_BERAT", $tot_rusak_berat);
