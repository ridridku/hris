...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/report_laporan/kabupaten/lap_jl_02';


#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/report_laporan');
$FILE_JS  = $JS_MODUL.'/kabupaten/lap_jl_02';
...
$smarty->assign ("TB_PANJANG", _PANJANG);
$smarty->assign ("TB_PANJANG_KM", _PANJANG_KM);
$smarty->assign ("TB_PANJANG_M", _PANJANG_M);
$smarty->assign ("TB_PANJANG_TIAP_KONDISI", _PANJANG_TIAP_KONDISI);
$smarty->assign ("TB_PANJANG_BAIK", _PANJANG_BAIK);
$smarty->assign ("TB_PANJANG_SEDANG", _PANJANG_SEDANG);
$smarty->assign ("TB_PANJANG_RUSAK", _PANJANG_RUSAK);
$smarty->assign ("TB_PANJANG_RUSAK_BERAT", _PANJANG_RUSAK_BERAT);
$smarty->assign ("TB_LHR", _LHR);
$smarty->assign ("TB_AKSES_JALAN", _AKSES_JALAN);
$smarty->assign ("TB_JUMLAH_PENDUDUK", _JUMLAH_PENDUDUK);
