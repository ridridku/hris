...
require_once($DIR_HOME.'/laporan_excell/inc.rfk_01.php');
...
if ($_GET[get_tahun_proyek]==1) 
{
	...
	if($no_prop!='')
	{
		$sql_tahun = "SELECT DISTINCT (YEAR(tanggal)) as tahun FROM tbl_form_rfk_01_jp_main WHERE no_propinsi='".$no_prop."' ORDER BY YEAR(tanggal) ASC";
...
if ($_GET['search'] == '1')
{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				while ($arr=$recordSet->FetchRow()) {
					$content_data .= print_content($arr[no_ruas],$arr[nama_program],$arr[target_total_fisik_jalan],$arr[target_total_fisik_jembatan],$arr[target_total_biaya],$arr[biaya_pad1],$arr[persen_fisik_pad1_bulan_ini],$arr[nilai_fisik_pad1_bulan_ini],$arr[persen_keuangan_pad1_bulan_ini],$arr[nilai_keuangan_pad1_bulan_ini],$arr[biaya_du_dpp],$arr[persen_fisik_du_dpp_bulan_ini],$arr[nilai_fisik_du_dpp_bulan_ini],$arr[persen_keuangan_du_dpp_bulan_ini],$arr[nilai_keuangan_du_dpp_bulan_ini],$arr[biaya_pjp_dpp],$arr[persen_fisik_pjp_dpp_bulan_ini],$arr[nilai_fisik_pjp_dpp_bulan_ini],$arr[persen_keuangan_pjp_dpp_bulan_ini],$arr[nilai_keuangan_pjp_dpp_bulan_ini],$arr[jumlah_loan_phln],$arr[jenis_loan_phln],$arr[persen_fisik_phln_bulan_ini],$arr[nilai_fisik_phln_bulan_ini],$arr[persen_keuangan_phln_bulan_ini],$arr[nilai_keuangan_phln_bulan_ini],$arr[jumlah_sumber_dana_lain],$arr[jenis_sumber_dana_lain],$arr[persen_fisik_sumber_lain_bulan_ini],$arr[nilai_fisik_sumber_lain_bulan_ini],$arr[persen_keuangan_sumber_lain_bulan_ini],$arr[nilai_keuangan_sumber_lain_bulan_ini],$arr[klarsifikasi_masalah]);
				...
				$file= $DIR_HOME."/files/rfk_01_".$no_propinsi."_".$no_kabupaten."_".$tahun.".xls";
				...
				fwrite($fp,$content);
				fclose($fp);
				$file_2= $HREF_HOME."/files/rfk_01_".$no_propinsi."_".$no_kabupaten."_".$tahun.".xls";
}
