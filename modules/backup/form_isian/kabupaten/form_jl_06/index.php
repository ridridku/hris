...
$sql = "SELECT * FROM tbl_form_06_detail a LEFT JOIN tbl_form_06_main b ON a.id_fjl_06_main=b.id_fjl_06_main ";
/*$sql = "SELECT * 
		FROM tbl_form_06_detail a LEFT JOIN tbl_form_06_main b ON a.id_fjl_06_main=b.id_fjl_06_main 
...
$sql1 = "SELECT * FROM tbl_form_jl_05_main a LEFT JOIN tbl_form_jl_05_detail b ON 					
	a.id_fjl_05_main=b.id_fjl_05_main LEFT JOIN tbl_mast_prop_jenis_penanganan c ON c.id_prop_jenis_penanganan=b.nama_jenis_penanganan ";
	
$recordSet_Edit1 = $db->execute($sql1);
$smarty->assign ("NAMA_PENANGANAN", $recorSet_Edit1->fields[nama_prop_jenis_penanganan]);*/
}
...
if($_GET[get_paket]==1) {
	...
	$id_jns_jln		= $result_jns_jln->fields[id_jns_jln]; 
	$jenis_jalan	= $id_jns_jln==1? "Propinsi":"Kabupaten/kota";
	
	$tmp_hidden_jsn_jln = "<input name=\"txt_hidden_jns_jln\" type=\"hidden\" value=\"".$id_jns_jln."\" >";
...
//die($TPL_PATH.'/'.$DOC_SELF_NAME_ONLY."tpl");
