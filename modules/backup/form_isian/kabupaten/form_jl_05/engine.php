...
***/
		...
		$sql_insert2 = " INSERT INTO tbl_form_jl_05_detail (id_fjl_05_main, nama_ruas, 
									...
									biaya_total,sumber_pendanaan,metoda_pelaksanaan,tanggal_spmk,rencana_pho,
									waktu_pelaksanaan,pimpro,kontraktor,pengawas,keterangan) VALUES (  
...
function import_() {
	...
	$get_sql		= " SELECT * FROM tbl_form_jl_05_main where no_propinsi=11" ;
	//print $get_sql;
