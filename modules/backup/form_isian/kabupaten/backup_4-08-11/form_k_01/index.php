...
if ($_GET['search'] == '1')
{
	...
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
				...
				***/
				...
				if($no_propinsi!='' AND $no_kabupaten!='' AND $jns_jln==''){
					$sql .= "AND (b.no_propinsi='".$no_propinsi."' $f_no_propinsi) AND (b.no_kabupaten='".$no_kabupaten."' $f_no_kabupaten) $tahun   ";
				} else if ($no_propinsi!='' AND $no_kabupaten!='' AND $jns_jln!=''){
...
$smarty->assign ("JENIS_JALAN", $jns_jln);
$smarty->assign ("NO_PROPINSI", $no_propinsi);
$smarty->assign ("NO_KABUPATEN", $no_kabupaten);
 $smarty->assign ("TAHUN", $Search_Year);
