...
function import_() {
	...
	$sql_ambil_data = " SELECT * FROM tbl_form_k_01_main  limit 6"; //localhost
	...
	while ($arr=$get_recordSet->FetchRow()) { //simpan di server
		...
		$sql_insert = " INSERT INTO tmp_tbl_form_k_01_main (`tanggal`, `tahun`, `no_propinsi`, `no_kabupaten`, `id_jns_jln`) 
