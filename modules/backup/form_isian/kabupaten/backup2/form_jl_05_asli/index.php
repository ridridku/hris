...
if($prop!='' AND $kab!=''){	
	...
	***/
	...
	$sql_data_paket_jalan = "SELECT b.id_fjl_03_detail,b.nama_ruas,b.kecamatan_yg_dilalui FROM tbl_form_jl_03_main a LEFT JOIN tbl_form_jl_03_detail b ON 					
	a.id_fjl_03_main=b.id_fjl_03_main WHERE ( a.no_propinsi='".$no_propinsi."' $f_no_prov ) AND ( a.no_kabupaten='".$no_kabupaten."' $f_no_kabta ) AND YEAR(a.tanggal)='".$Date_Year."' $f_id_jns_jln ";
