...
function import_() {
	...
	$get_sql		= " SELECT * FROM `".$tmp_tbl_name_main."` ORDER BY id_fjl_02_main ASC ";
	//print $get_sql;
		...
		if($get_recordSet2->RecordCount()>0){
			//while ($arr2=$get_recordSet2->FetchRow()) {
				$sql_insert2 = " INSERT INTO `".$tbl_name_detail."` (`id_fjl_02_main`, `no_ruas`, `nama_ruas`, `panjang_km`, `panjang_m`, 
					...
					`jumlah_penduduk`, `keterangan`) VALUES (
					(SELECT MAX(id_fjl_02_main) FROM ".$tbl_name_main."), 
					".sqlvalue(@$get_recordSet2->fields["no_ruas"], true).", 
					".sqlvalue(@$get_recordSet2->fields["nama_ruas"], true).", 
					".sqlvalue(@$get_recordSet2->fields["panjang_km"], false).", 
					".sqlvalue(@$get_recordSet2->fields["panjang_m"], false).", 
					".sqlvalue(@$get_recordSet2->fields["kondisi_baik"], false).", 
					".sqlvalue(@$get_recordSet2->fields["kondisi_sedang"], false).", 
					".sqlvalue(@$get_recordSet2->fields["kondisi_rusak"], false).", 
					".sqlvalue(@$get_recordSet2->fields["kondisi_rusak_berat"], false).",
					".sqlvalue(@$get_recordSet2->fields["lhr_rata_rata"], false).", 
					".sqlvalue(@$get_recordSet2->fields["akses_jalan"], true).", 
					".sqlvalue(@$get_recordSet2->fields["jumlah_penduduk"], false).", 
					".sqlvalue(@$get_recordSet2->fields["keterangan"], true).")";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_fjl_02_detail='{$get_recordSet2->fields[id_fjl_02_detail]}' ";
