		...
		if($get_recordSet2->RecordCount()>0) {
			while ($arr2=$get_recordSet2->FetchRow()) {
				$sql_insert2 = " INSERT INTO `".$tbl_name_detail."` (`id_fjl_07_main`,`no_paket`,`masalah`,`pemecahan`,`instansi`,`status_perkembangan`,`id_jns_jln`) VALUES (
					...
					" .sqlvalue(@$get_recordSet2->fields["no_paket"], true) .", 
					" .sqlvalue(@$get_recordSet2->fields["masalah"], true) .", 
					" .sqlvalue(@$get_recordSet2->fields["pemecahan"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["instansi"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["status_perkembangan"], false) .", 
