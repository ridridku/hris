...
`jembatan_beton`, 
			...
			***/
			//while ($arr2=$get_recordSet2->FetchRow()) {
				...
				INSERT INTO `".$tbl_name_detail."` (`id_fjl_08_main`, `nama_paket`, `lhr`, `jalan_perkerasan`, `jalan_bahu`, 
						...
						" .sqlvalue(@$get_recordSet2->fields["lhr"], false) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_perkerasan"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_bahu"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_drainase"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_trotoar"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_pengaman"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_talud"], true) .", 
						" .sqlvalue(@$get_recordSet2->fields["jalan_lain"], true) .", 
		...
		//if($sql_exec){
			$sql_del2 = "DELETE FROM `".$tmp_tbl_name_main."` WHERE id_fjl_08_main='$arr[id_fjl_08_main]' ";
