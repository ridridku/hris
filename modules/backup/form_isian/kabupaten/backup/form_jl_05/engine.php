...
/*** Disabled on 07-09-2010
						...
						".sqlvalue(@$get_recordSet2->fields["biaya_dak"], false).", 
						".sqlvalue(@$get_recordSet2->fields["biaya_pendamping"], false).", 
***/
/*** Disabled on 22-09-2010
`target_unit`, 

".sqlvalue(@$get_recordSet2->fields["target_unit"], false).", 
***/
	$z=1;
		...
		if($get_recordSet2->RecordCount()>0){
			//while ($arr2=$get_recordSet2->FetchRow()) {
				...
				INSERT INTO `".$tbl_name_detail."` (`id_fjl_05_main`, 
						...
						VALUES (
						(SELECT MAX(id_fjl_05_main) FROM ".$tbl_name_main."),
						".sqlvalue(@$get_recordSet2->fields["nama_paket"], true).", 
						".sqlvalue(@$get_recordSet2->fields["nama_jenis_penanganan"], false).", 
						'".get_data_kecamatan2($get_recordSet2->fields["jml_kecamatan"])."',
						".sqlvalue(@$get_recordSet2->fields["target_m"], false).", 

						".sqlvalue(@$get_recordSet2->fields["biaya_total"], false).", 
						".sqlvalue(@$get_recordSet2->fields["sumber_pendanaan"], false).",
						".sqlvalue(@$get_recordSet2->fields["metoda_pelaksanaan"], true) .", 
						".sqlvalue(@$get_recordSet2->fields["tanggal_spmk"], true).", 
						".sqlvalue(@$get_recordSet2->fields["rencana_pho"], true).", 
						".sqlvalue(@$get_recordSet2->fields["waktu_pelaksanaan"], false) .", 
						".sqlvalue(@$get_recordSet2->fields["pimpro"], true).", 
						".sqlvalue(@$get_recordSet2->fields["kontraktor"], true).", 
						".sqlvalue(@$get_recordSet2->fields["pengawas"], true).", 
						".sqlvalue(@$get_recordSet2->fields["keterangan"], true).")				
				";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_fjl_05_detail='{$get_recordSet2->fields[id_fjl_05_detail]}' ";
