...
function import_() {
	...
	$get_sql		= " SELECT * FROM `".$tmp_tbl_name_main."` ORDER BY id_fjl_03_main ASC ";
	//print $get_sql;
		...
		if($get_recordSet2->RecordCount()>0){
			//while ($arr2=$get_recordSet2->FetchRow()) {
				$sql_insert2 = " INSERT INTO `".$tbl_name_detail."` (`id_fjl_03_main`, `nama_ruas`, `kecamatan_yg_dilalui`, `rd_dak`, `rd`, 
						...
						'".get_data_kecamatan($get_recordSet2->fields["jml_kecamatan"])."', 
						".sqlvalue(@$get_recordSet2->fields["rd_dak"], true).", 
						".sqlvalue(@$get_recordSet2->fields["rd"], true).", 
						".sqlvalue(@$get_recordSet2->fields["alasan"], true).", 
						".sqlvalue(@$get_recordSet2->fields["kelengkapan_gambar"], true).", 
						".sqlvalue(@$get_recordSet2->fields["kelengkapan_spesifik"], true).", 
						".sqlvalue(@$get_recordSet2->fields["kelengkapan_rab"], true).", 
						".sqlvalue(@$get_recordSet2->fields["keterangan"], true).") ";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_fjl_03_detail='{$get_recordSet2->fields[id_fjl_03_detail]}' ";
