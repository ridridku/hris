		...
		if($get_recordSet2->RecordCount()>0){
			//while ($arr2=$get_recordSet2->FetchRow()) {
				...
				INSERT INTO `".$tbl_name_detail."` (`id_fjl_06_main`, `nama_paket`, `target_km`, `target_m`, `biaya`, 
						...
						".sqlvalue(@$get_recordSet2->fields["target_km"], false).", 
						".sqlvalue(@$get_recordSet2->fields["target_m"], false).", 
						".sqlvalue(@$get_recordSet2->fields["biaya"], false).", 
						".sqlvalue(@$get_recordSet2->fields["rencana_fisik"], false).", 
						".sqlvalue(@$get_recordSet2->fields["rencana_keuangan"], false).", 
						".sqlvalue(@$get_recordSet2->fields["realisasi_fisik"], false).", 
						".sqlvalue(@$get_recordSet2->fields["realisasi_keuangan"], false).", 
						".sqlvalue(@$get_recordSet2->fields["deviasi_fisik"], false).", 
						".sqlvalue(@$get_recordSet2->fields["deviasi_keuangan"], false).", 
						".sqlvalue(@$get_recordSet2->fields["masalah"], true).", 
						".sqlvalue(@$get_recordSet2->fields["jumlah_tenaga"], false).", 
						".sqlvalue(@$get_recordSet2->fields["keterangan"], true).")";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_fjl_06_detail='{$get_recordSet2->fields[id_fjl_06_detail]}' ";
