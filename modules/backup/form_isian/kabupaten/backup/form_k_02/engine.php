...
function import_() {
	...
	$get_sql		= " SELECT * FROM `".$tmp_tbl_name_main."` ORDER BY id_usulan ASC ";
	//print $get_sql;
		...
		if($get_recordSet2->RecordCount()>0) {
			while ($arr2=$get_recordSet2->FetchRow()) {
				$sql_insert2 = " INSERT INTO `".$tbl_name_detail."` (`id_usulan_main`,`kelompok_prioritas`,`no_ruas`,`nama_ruas`,`panjang`,`kondisi`,`lebar`,`lhr_roda_4`,`kota_aktivitas_dilayani`,`id_jns_jln`) VALUES (
					...
					" .sqlvalue(@$get_recordSet2->fields["kelompok_prioritas"], true) .", 
					" .sqlvalue(@$get_recordSet2->fields["no_ruas"], true) .", 
					" .sqlvalue(@$get_recordSet2->fields["nama_ruas"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["panjang"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["kondisi"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["lebar"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["lhr_roda_4"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["kota_aktivitas_dilayani"], false) .", 
					" .sqlvalue(@$get_recordSet2->fields["id_jns_jln"], true) .") ";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_usulan_detail='{$get_recordSet2->fields[id_usulan_detail]}' ";
