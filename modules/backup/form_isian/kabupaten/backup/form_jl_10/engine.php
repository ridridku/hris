			...
			//while ($arr2=$get_recordSet2->FetchRow()) {
				...
				INSERT INTO `".$tbl_name_detail."` (`id_fjl_10_main`, `no_ruas`, `nama_ruas`, `panjang_km`, `panjang_m`, 
						...
						" .sqlvalue(@$get_recordSet2->fields["no_ruas"], true) .", "
						 ...
						 " .sqlvalue(@$get_recordSet2->fields["tahun1_baik"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun1_sedang"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun1_rusak"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun1_rusak_berat"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun2_baik"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun2_sedang"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun2_rusak"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["tahun2_rusak_berat"], false) .", 
						 " .sqlvalue(@$get_recordSet2->fields["keterangan"], true) .")
				";
					
				$sql_exec2 = $tb_import->Execute($sql_insert2);
				$sql_del = "DELETE FROM `".$tmp_tbl_name_detail."` WHERE id_fjl_10_detail='{$get_recordSet2->fields[id_fjl_10_detail]}' ";
