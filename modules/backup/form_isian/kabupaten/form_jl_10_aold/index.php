...
if ($_GET[get_data_ruas]==1) {
	...
	*****/
	...
	//End 0f Tambahan 28-06-2010 -->		
	$tmp_panjang_ruas = "<input type=\"text\" name=\"panjang_km\" value=\"".$result_ruas->fields[panjang_ruas]."\" onChange=\"document.frmCreate.panjang_m.value=this.value*1000\" readonly>";
