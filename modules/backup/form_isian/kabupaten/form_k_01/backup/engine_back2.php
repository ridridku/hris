...
function import_() {
	...
	$sql_ambil_data = " SELECT * FROM tmp_tbl_form_k_01_main  limit 6"; //localhost
	...
	while ($arr=$get_recordSet->FetchRow()) { //simpan di server
		 ...
		 //simpan di tabel tmp server
		$sql_insert = " INSERT INTO tmp_tbl_form_k_01_main (`tanggal`, `tahun`, `no_propinsi`, `no_kabupaten`, `id_jns_jln`,id_k_01_main) 
		...
		$sql_insert = " INSERT INTO tbl_form_k_01_main (`tanggal`, `tahun`, `no_propinsi`, `no_kabupaten`, `id_jns_jln`,id_k_01_main) 
		 VALUES (" .sqlvalue(@$arr["tanggal"], true) .", " .sqlvalue(@$arr["tahun"], true) .", 
		 " .sqlvalue(@$arr["no_propinsi"], false) .", " .sqlvalue(@$arr["no_kabupaten"], false) .", " .sqlvalue(@$arr["id_jns_jln"], false) .", " .sqlvalue(@$arr["id_k_01_main"], false) .")";
		$sqlexec3 = $tb_import->Execute($sql_insert);
		...
		if($get_recordSet2->RecordCount()>0){
			while ($arr2=$get_recordSet2->FetchRow()) {
				...
				//simpan di tabel tmp detail
				$sql_insert2 = " INSERT INTO tmp_tbl_form_k_01_detail (id_form_k_01_main, no_ruas, `nama_pangkal_ruas`, 
				`nama_ujung_ruas`, `titik_pengenal_pangkal`, `titik_pengenal_ujung`, 
				...
				`kondisi_permukaan`, `kondisi`, `hambatan_lalin`, `bln_th_perenc_akhir`, `tipe_thn_pekerj_akhir`, `kondisi_thn_pekerj_akhir`, 
				`kelas_renc_lalin`, `lhr_roda_4`, `lhr_ekivalen_roda_4`, `bln_thn_perubahan_data`) VALUES ( 
				(SELECT MAX(id_k_01_main) FROM  tmp_tbl_form_k_01_main ), 
				...
				// SIMANPAN DI TABEL TMP SERVER
				$sqlinsert3 = " INSERT INTO tmp_tbl_form_kondisi_k_01_detail (`id_form_k_01_main`, `no_ruas`, `kondisi_permukaan`) 
						VALUES ((SELECT MAX(id_k_01_main) FROM tmp_tbl_form_kondisi_k_01), " .sqlvalue(@$arr2["no_ruas"], true) .", 
						" .covt(@$_POST["kondisi_permukaan"]) .")";
				...
				$sqlinsert3 = " INSERT INTO tmp_tbl_form_kondisi_k_01_detail (`id_form_k_01_main`, `no_ruas`, `kondisi_permukaan`) 
						VALUES ((SELECT MAX(id_k_01_main) FROM tbl_form_kondisi_k_01), " .sqlvalue(@$arr2["no_ruas"], true) .", 
						" .covt(@$_POST["kondisi_permukaan"]) .")";
 				 $sqlexec3 = $tb_import->Execute($sqlinsert3);
		...
		//HAPUS TABEL TEMP LOCAL ARTINYA SUDAH DI EKSPORT
		 ...
		 $sql_del2 = "DELETE FROM tmp_tbl_form_k_01 WHERE id_k_01_main='$arr[id_k_01_main]' ";
