...
/* TTD RED $sql_cek_data= " SELECT no_ruas FROM tbl_form_k_01_detail where id_form_k_01_main='$id'";
...
$tmp_sql3  = " DELETE FROM tbl_form_kondisi_k_01_detail WHERE id_form_k_01_main='$id' " ;
$tmp_sql3b  = " DELETE FROM tbl_form_k_01_detail WHERE id_form_k_01_main='$id' " ;
$sql  ="DELETE FROM tbl_form_k_01_main WHERE id_k_01_main = '$id'";

if($db->Execute($tmp_sql3)){
	$db->Execute($tmp_sql3b);
	$db->Execute($sql);
}

//cek dulu data mana JL05
//cek dulu data mana JL04
...
//ngupdate tabel JL03
//cek dulu data mana JL03
$sql_jl03= " SELECT id_fjl_03_detail FROM tbl_form_jl_03_detail where no_ruas='".$no_ruas_induk."'";
$recordSet	= $db->Execute($sql_jl03);
while ($arr_jl03=$recordSet->FetchRow()) {
$sql_edit_jl03 = " UPDATE tbl_form_jl_03_detail SET no_ruas='".$_POST["no_ruas"]."', 
		 nama_ruas='".$_POST["nama_pangkal_ruas"]." - ".$_POST["nama_ujung_ruas"]."',
		 kecamatan_yg_dilalui='".get_data_kecamatan($_POST["jml_kecamatan"])."'
		 WHERE id_fjl_03_detail='".$arr_jl03["id_fjl_03_detail"]."'";		
         $sqlresult_jl03 = $db->Execute($sql_edit_jl03 );
...
//ngupdate tabel k02
//cek dulu data mana k02
$sql_k02= " SELECT id_usulan_detail FROM tbl_form_k_02_detail where no_ruas='".$no_ruas_induk."'";
$recordSet	= $db->Execute($sql_k02);
while ($arr_k02=$recordSet->FetchRow()) {
$sql_edit_k02 = " UPDATE tbl_form_k_02_detail SET no_ruas='".$_POST["no_ruas"]."', 
		 nama_ruas='".$_POST["nama_pangkal_ruas"]." - ".$_POST["nama_ujung_ruas"]."',
		 panjang='".$_POST["panjang_ruas"]."', 
		 kondisi='".$kondisi."', 
		 lebar=".$_POST["lebar"].", 
		 lhr_roda_4=".$_POST["lhr_roda_4"].", 
		 kota_aktivitas_dilayani='".get_data_kecamatan($_POST["jml_kecamatan"])."'
		 WHERE id_usulan_detail='".$arr_k02["id_usulan_detail"]."'";		
         $sqlresult_k02 = $db->Execute($sql_edit_k02 );
...
$recordSet	= $db->Execute($sql_s01);
while ($arr_s01=$recordSet->FetchRow()) {
$sql_edit_s01 = " UPDATE tbl_form_s_01_main SET no_ruas='".$_POST["no_ruas"]."', 
		 nama_ruas_pangkal=" .$_POST["nama_pangkal_ruas"].", 
		 nama_ruas_ujung=".$_POST["nama_ujung_ruas"].", 
		 titik_pengenal_ujung='".$_POST["titik_pengenal_ujung"]."', 
		 titik_pengenal_pangkal='".$_POST["titik_pengenal_pangkal"]."'
		 WHERE id_fs_01_main='".$arr_s01["id_fs_01_main"]."'";		
         $sqlresult_s01 = $db->Execute($sql_edit_s01 );
...
$recordSet	= $db->Execute($sql_s01A);
while ($arr_s01A=$recordSet->FetchRow()) {
$sql_edit_s01A = " UPDATE tbl_form_s_01a_main SET no_ruas='".$_POST["no_ruas"]."', 
		 nama_ruas='".$_POST["nama_pangkal_ruas"]." - ".$_POST["nama_ujung_ruas"]."',
		 awal_km='".$_POST["pal_km_awal"]."', 
		 akhir_km='".$_POST["pal_km_akhir"]."'
		 WHERE id_fs_01A_main='".$arr_s01A["id_fs_01A_main"]."'";		
         $sqlresult_s01A = $db->Execute($sql_edit_s01A );
...
$recordSet	= $db->Execute($sql_jl05);
while ($arr_jl05=$recordSet->FetchRow()) {
$sql_edit_jl05 = " UPDATE tbl_form_jl_05_detail SET nama_ruas='".$_POST["nama_pangkal_ruas"]." - ".$_POST["nama_ujung_ruas"]."',
		 kecamatan_yg_dilalui='" .get_data_kecamatan($_POST["jml_kecamatan"])."',  		 
		 WHERE id_fjl_05_main='".$arr_jl05["id_fjl_05_main"]."'";		
         $sqlresult_jl05 = $db->Execute($sql_edit_jl05 );
...
$recordSet	= $db->Execute($sql_jl06);
while ($arr_jl06=$recordSet->FetchRow()) {
$sql_edit_jl06 = " UPDATE tbl_form_jl_06_detail SET nama_ruas='".$_POST["nama_pangkal_ruas"]." - ".$_POST["nama_ujung_ruas"]."',
		 WHERE id_fjl_06_main='".$arr_jl06["id_fjl_06_main"]."'";		
         $sqlresult_jl06 = $db->Execute($sql_edit_jl06 );
...
$recordSet	= $db->Execute($sql_jl07);
while ($arr_jl07=$recordSet->FetchRow()) {
$sql_edit_jl07 = " UPDATE tbl_form_jl_07_detail SET no_paket='".$_POST["no_ruas"]."',
		 WHERE id_fjl_07_main='".$arr_jl07["id_fjl_07_main"]."'";		
         $sqlresult_jl07 = $db->Execute($sql_edit_jl07 );
