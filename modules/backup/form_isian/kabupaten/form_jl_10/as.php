...
//$smarty->assign ("r", $PANJANG_KM*1000);
//$smarty->assign ("PANJANG_M",$r);
...
if ($_GET[get_data_ruas]==1) {
	...
	*****/
	...
	//$panjang_m=$aaa*1000;
	$tmp_panjang_ruas = "<input type=\"text\" name=\"panjang_km\" value=\"".$result_ruas->fields[panjang_ruas]."\" >";
	//$aaa=$result_ruas->fields[panjang_ruas]*1000;
	//$tmp_panjang_ruas2 = "<input type=\"text\" name=\"panjang_m\" value=\"".$aaa."\" >";
