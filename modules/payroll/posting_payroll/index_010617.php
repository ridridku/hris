...
IF((E.ket_resign=1),ROUND((E.hadir/E.max_hari)*ROUND((E.gapok+E.gaji_makan+E.gaji_transport+E.tunj_jabatan+E.tunj_kemahalan+E.tunj_lain1+E.tunj_lain2)-(E.angsuran+E.potongan_bpjs))),ROUND((E.gapok+E.gaji_makan+E.gaji_transport+E.tunj_jabatan+E.tunj_kemahalan+E.tunj_lain1+E.tunj_lain2)-(E.angsuran+E.potongan_bpjs))) as gaji_netto,
...
)B LEFT JOIN t_rekap_absensi  rkp ON rkp.t_rkp__no_mutasi=B.mutasi and 
...
WHERE E.jml_hadir>0
GROUP BY E. E.r_pnpt__id_pegawai
order BY E.r_pnpt__id_pegawai asc";
...
ON peg_rkp.r_pnpt__no_mutasi=rkp.t_rkp__no_mutasi)mutasi
    ...
    
{
			...
			if($jenis_user=='2'){
                                    ...
                                    $sql = "SELECT 
                                            ...
                                            INNER JOIN r_subcabang ON r_subcabang.r_subcab__id=peg.r_pnpt__subcab
                                            INNER JOIN r_cabang ON r_cabang.r_cabang__id=r_subcabang.r_subcab__cabang
                                            LEFT JOIN t_gaji ON t_gaji.t_gaji__id_peg=peg.r_pnpt__id_pegawai
                                            INNER JOIN r_jabatan ON r_jabatan__id=peg.r_pnpt__jabatan
                                            INNER JOIN r_subdepartement ON peg.r_pnpt__subdept=r_subdepartement.r_subdept__id
                                            INNER JOIN r_departement ON r_departement.r_dept__id=r_subdepartement.r_subdept__dept
                                            GROUP BY peg.r_pnpt__id_pegawai ORDER BY peg.r_pnpt__no_mutasi DESC)A
