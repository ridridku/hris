...
$pdf->SetLeftMargin(75);
$pdf->Cell(160,1,'  No.'.$t_sp__no.'/HRD/TMW/'.$bulan_romawi.'/'.$tahun,0,'C',1);
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
...
$pdf->Ln();
$pdf->Cell(27,4,'Apabila dalam waktu '. $jml_bulan_sp. ' bulan sejak dibuatnya surat keputusan ini karyawan',0,'FJ',1);
$pdf->Ln();
...
$pdf->Cell(40,3.5,'','',0,'C',true);
$pdf->Cell(40,3.5,'','',0,'C',true);
$pdf->Cell(40,3.5,$r_pegawai__nama,'',0,'C',true);

$pdf->SetFont('helvetica','',9);
$pdf->Ln(); //KOLOM 1
$pdf->Cell(40,4,'HGL Manager','',0,'C',true);
$pdf->Cell(40,3.5,'','',0,'C',true);
$pdf->Cell(40,3.5,'','',0,'C',true);
