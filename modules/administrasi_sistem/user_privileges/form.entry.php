...
if ($check_list_menu == 0 && $_GET['child'] != 2 && $_GET['child'] != 3 )
{
		//echo "cantik<br>";
			//=======================================detail dokumen=======================================//
...
{
	//echo " MENU LEVEL 2 UNTUK MENAMPILKAN LEVEL 3 ";

 			 $global_parent_menu = $_GET['menu_parent'];
			//echo "kasep<br>";

			$sql = "SELECT a.* FROM tbl_sys_master_menu as a WHERE a.menu_level = '2' AND a.menu_active = '1' AND a.menu_parent = '$menu_parent_get' ";
			$result_menu_parent = $db->Execute($sql);
			$jumlah_menu_cek_sub_parent = $result_menu_parent->RecordCount();
			$menu_parent = array();
			$initSet = array();
			...
			//for cek list sub parent
			$sql ="SELECT a.*, b.* FROM tbl_sys_master_privileges as a INNER JOIN tbl_sys_master_menu as b ON a.priv_menu_id = b.menu_id WHERE b.menu_level = '2' AND b.menu_parent = '$global_parent_menu' AND b.menu_active = '1' AND priv_user_id = '$user_id'   ";
			$rs_cek_list_sub_parent = $db->execute($sql);
...
if ( $check_list_menu == 0 && $_GET['child'] == '2')
{
			...
			// echo " get sama dengan 2sssssssss<br>";
...
if ( $check_list_menu == 0 && $_GET['child'] == '3')
{

			 //echo " ccccccccccccccccc get sama dengan 2<br>";

			 	// echo " get sama dengan 2<br>";

			//=======================================Detail dokumen=======================================//
			$sql = "SELECT a.* FROM tbl_sys_master_menu as a WHERE a.menu_level = '2' AND a.menu_active = '1' AND a.menu_id = '$menu_parent_get' ";
			$result_menu_parent = $db->Execute($sql);
			$smarty->assign ("MENU_PARENT_ID", $result_menu_parent->fields['menu_id']);
			$menu_parent = array();
			$initSet = array();
			...
			$sql = "SELECT a.* FROM tbl_sys_master_menu as a WHERE a.menu_level = '3' AND a.menu_active = '1' AND a.menu_parent = '$menu_parent_get' ORDER BY a.menu_label ASC ";
			$result_menu_child = $db->Execute($sql);
			$menu_child = array();
			$initSet_child = array();
			$row_class_child = array();
			...
			$sql ="SELECT a.menu_label, count(b.menu_id) as jumlah FROM tbl_sys_master_menu as a LEFT JOIN tbl_sys_master_menu as b ON a.menu_id = b.menu_parent WHERE a.menu_level = '2' AND b.menu_active = '1'  AND b.menu_parent = '$menu_parent_get' GROUP BY a.menu_id ";
			$rs = $db->execute($sql);
			$list_jum_parent = array();
			while($arr=$rs->FetchRow()){
				array_push($list_jum_parent, $arr); 	
			...
			$sql ="SELECT count(b.menu_id) as jumlah FROM tbl_sys_master_menu as a LEFT JOIN tbl_sys_master_menu as b  ON a.menu_id = b.menu_parent WHERE a.menu_level = '2' AND b.menu_active = '1' AND b.menu_parent = '$menu_parent_get'  ";
			$rs_jumlah_child = $db->execute($sql);
			$smarty->assign ("COUNT_CHILD", $rs_jumlah_child->fields['jumlah']);


			//----------------------------------cek list
			$sql ="SELECT a.*, b.* FROM tbl_sys_master_privileges as a INNER JOIN tbl_sys_master_menu as b ON a.priv_menu_id = b.menu_id WHERE b.menu_level = '3' AND b.menu_active = '1' AND priv_user_id = '$user_id' ORDER BY b.menu_label ASC ";
			$rs_priv_anak = $db->execute($sql);
			$cek_lis_priv_anak = array();
			while($arr=$rs_priv_anak->FetchRow()){
				array_push($cek_lis_priv_anak, $arr); 	
			...
			$sql ="SELECT a.*, b.* FROM tbl_sys_master_privileges as a INNER JOIN tbl_sys_master_menu as b ON a.priv_menu_id = b.menu_id WHERE b.menu_level = '2' AND b.menu_active = '1' AND priv_user_id = '$user_id'   ";
			$rs_cek_list_parent = $db->execute($sql);
			...
			$menu_ortu = $_GET['menu_ortu'];
			$sql = "SELECT a.* FROM tbl_sys_master_menu as a WHERE a.menu_level = '1' AND a.menu_active = '1' AND a.menu_id = '$menu_ortu' ";
			$result_menu_label_sub = $db->Execute($sql);
			...
			$sql ="SELECT COUNT(a.priv_menu_id) as jml  FROM tbl_sys_master_privileges as a INNER JOIN tbl_sys_master_menu as b ON a.priv_menu_id = b.menu_id WHERE b.menu_level = '3' AND b.menu_active = '1' AND priv_user_id = '$user_id'  ORDER BY b.menu_label ASC   ";
			$rs_set_disabled = $db->execute($sql);
			$smarty->assign ("SET_DISABLED_ANAK", $rs_set_disabled->fields['jml']);
