...
$smarty->assign ("HREF_FOTO", $HREF_HOME.'/modules/ticketing/ticketing/uploads');
$smarty->assign ("HREF_HOME_PATH_AJAX", $HREF_HOME.'/modules/ticketing/ticketing');
...
$TPL_PATH = base64_decode($_SESSION['THEME']).'/modules/ticketing/ticketing';
#SETTING FILE JS INCLUDE
$JS_MODUL = $DIR_THEME.'/'.(base64_decode($_SESSION['THEME']).'/javascripts/modules/ticketing');
$FILE_JS  = $JS_MODUL.'/ticketing';
