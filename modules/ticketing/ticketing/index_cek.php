...
if ($_GET['t_sp__nip']) $t_sp__nip = $_GET['t_sp__nip'];
else if ($_POST['t_sp__nip']) $t_sp__nip = $_POST['t_sp__nip'];
else $t_sp__nip="";


 

$str_completer = "mod_id=".$mod_id."&limit=".$LIMIT."&SORT=".$SORT."&t_sp__nip=".$t_sp__nip;
...
$SES_JENIS_USER		= $_SESSION['JENIS_USER'];
 ...
 IF ($_GET['ERR'] =='5') {
	 $label_error =  "Data Tidak Bisa Diubah / Karyawan Masih Aktif";
 } else {
