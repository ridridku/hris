        ...
        for ($i=2; $i<=$hasildata; $i++)
            {
                        ...
                        $result_tgl2 = $date1->format('Y-m-d H:i:s');
                        ...
                        IF($t_abs__jam_keluar!='')
                            {
                                ...
                                $secs = floor(($diff-(($hours*60*60)+($mins*60))));
                                $result = $hours.":".$mins.":".$secs;
                                $t_abs__jam_keluar2 = $result;
                            }  else {
                                $t_abs__jam_keluar2 = (-1);
                            }
                       
                            
                          
                           //   var_dump($t_abs__jam_masuk2)or die();
                      IF($t_abs__jam_keluar2!='' && $t_abs__jam_masuk2!='' &&$t_abs__jam_keluar2>0 && $t_abs__jam_masuk2>0)   
                      {
                           $t1=$t_abs__jam_masuk2;
