...
//          $d1 = new DateTime($oldest_datetime_res2, new DateTimeZone('Asia/Jakarta'));
...
//             $a2 = strtotime("$result_date1");
      $sql_cek_old="SELECT t_abs__tgl as cek_day,t_abs__jam_keluar as cek_jam from t_absensi
          ...
          //  var_dump($oldest_datetime_res==null)or die();
 ...
 {    
  //   if (($date>=$periode_awal and $date<=$periode_akhir)AND($tgl_cek=='')AND ($oldest_datetime_res2=='')&& ($time>=$rule_jam_masuk))  
 IF ($time!='' )  
     {
 ...
 //        elseif(($date>=$periode_awal and $date<=$periode_akhir) && ($diff_in_hrs<=15)&&($time>='04:00:00' && $time<='09:00:00'))
//        {
//   
//
//              //EARLY
