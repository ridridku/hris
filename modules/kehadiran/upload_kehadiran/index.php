...
//var_dump($kode_pw_ses) or die; "JENIS USER".$_SESSION['SESSION_JNS_USER'];
...
//{
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
		  ...
		  if($jenis_user=='1'){
            ...
            $sql  = " SELECT  id,nama_file,tanggal_upload,kode_cabang FROM tbl_file_kehadiran  ";
     ...
     if($jenis_user=='2'){
            ...
            $sql  = " SELECT  id,nama_file,tanggal_upload,kode_cabang FROM tbl_file_kehadiran where A.kode_cabang= '".$kode_pw_ses."'";
			}
			...
			if($kode_perwakilan_cari !=''){
			 	...
			 	$sql .= " ORDER BY  trim(nama_file) asc ";
