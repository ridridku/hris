...
if ($_GET['nip_karyawan']) $nip_karyawan = $_GET['nip_karyawan'];
else if ($_POST['nip_karyawan']) $nip_karyawan = $_POST['nip_karyawan'];
else $nip_karyawan="";

 
 

$str_completer = "mod_id=".$mod_id."&limit=".$LIMIT."&SORT=".$SORT."&nip_karyawan=".$nip_karyawan;
...
$SES_JENIS_USER		= $_SESSION['JENIS_USER'];
 ...
 IF ($_GET['ERR'] =='5') {
	 $label_error = "Data Tidak Bisa Diubah / Tidak Tersimpan";
 } else {
	 $label_error = $nip_karyawan."NIP  SUDAH ADA";	
 }
