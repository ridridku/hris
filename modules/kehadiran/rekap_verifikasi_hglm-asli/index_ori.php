	...
	if (Privi($mod_id, $user_id, 'search') != 'no')
	{
		  ...
		  if($jenis_user=='2'){
                                                  $sql  = "SELECT peg.r_pegawai__nama,peg.r_pnpt__finger_print,
                                                          ...
                                                          . " AND t_rkp__awal>='$periode_awal' and  t_rkp__akhir<='$periode_akhir' ";
		...
		//echo "<br><br><br><br><br><br><br><br><br><br>dddddddddkode_perwakilan_cari ===".$kode_perwakilan_cari;
				...
				if($bulan_cari!=''){
					$sql .= "AND  ra.t_rkp__awal = '$bulan_cari' ";
				} 
                                
                                if($tahun_cari!=''){
					$sql .= "AND  ra.t_rkp__akhir = '$tahun_cari' ";
    ...
    
{
			...
			if($jenis_user=='2'){
                                                ...
                                                $sql  = "SELECT peg.r_pegawai__nama,peg.r_pnpt__finger_print,
                                                            ...
                                                            LEFT JOIN v_pegawai peg ON ra.t_rkp__no_mutasi=peg.r_pnpt__no_mutasi 
                                                            WHERE  peg.r_cabang__id= '".$kode_pw_ses."' AND t_rkp__awal>='$periode_awal' and  t_rkp__akhir<='$periode_akhir' ";
