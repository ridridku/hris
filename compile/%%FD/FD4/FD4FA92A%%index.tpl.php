<?php /* Smarty version 2.6.18, created on 2016-10-20 06:53:46
         compiled from defaults/modules/pelaporan/lap_manfaat/data_rekap_manfaat/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'defaults/modules/pelaporan/lap_manfaat/data_rekap_manfaat/index.tpl', 276, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
/button/blank.gif" align="absmiddle"> <?php echo $this->_tpl_vars['RESET']; ?>
		...
		<tr><td class="tcat">LAPORAN PINJAMAN PEGAWAI </td></tr>
		</table>
...
.</TD>  
											...
											<TD class="tdatacontent"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_dept__ket']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent">Rp.<?php echo ((is_array($_tmp=$this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_ang__nilai_angsuran'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</TD>
                                                                                        <TD class="tdatacontent"> Sudah <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_ang__angsuran_ke']; ?>
 Kali Angsuran</TD>
                                                                                       <TD class="tdatacontent">
                                                                                               <?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_pjm__approval'] ) == 1): ?>
                                                                                                         <font color="#F24458">Belum Lunas</font>              
                                                                                                <?php elseif (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_pjm__approval'] ) == 2): ?>  
