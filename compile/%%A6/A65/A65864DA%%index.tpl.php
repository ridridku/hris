<?php /* Smarty version 2.6.18, created on 2016-10-21 11:54:47
         compiled from defaults/modules/kpi/kpi_upload//index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'defaults/modules/kpi/kpi_upload//index.tpl', 263, false),array('modifier', 'date_format', 'defaults/modules/kpi/kpi_upload//index.tpl', 268, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
/icon/details.gif" align="absmiddle">Upload KPI </span></a>
...
<DIV ID="_menuEntry1_1" style="top:10px;width:100%;display:none;position:absolute;">
		...
		<tr><td class="tcat"> Posting KPI</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/form.gif" align="absmiddle" border="0"> Form Upload KPI</td></tr>
...
/icon/blank.gif" align="absmiddle">Upload Data</span></a>
...
<!--form_cari--> 			
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="CENTER" style="border-bottom-width:0px">
		<tr><td class="tcat">Data upload KPI</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="CENTER">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0">Data KPI Terbaru</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											<th class="tdatahead" align="left">NO</TH>
											<th class="tdatahead" align="left" width="10%">NAMA FILE</TH>
                                                                                        <th class="tdatahead" align="left" width="10%">DEPARTEMEN</TH>
											<th class="tdatahead" align="left" width="10%">USER </TH>
...
.</TD>
											<TD class="tdatacontent"> <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_uploadkpi__filename']; ?>
 </TD>
                                                                                        ...
                                                                                        <TD class="tdatacontent"> <?php echo ((is_array($_tmp=$this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_uploadkpi__date_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%B-%Y %H:%I:%S") : smarty_modifier_date_format($_tmp, "%d-%B-%Y %H:%I:%S")); ?>
 </TD>
