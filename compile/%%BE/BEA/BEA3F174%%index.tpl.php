<?php /* Smarty version 2.6.18, created on 2016-10-20 04:02:32
         compiled from defaults/modules/kehadiran/surat_cuti_verifikasi//index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'defaults/modules/kehadiran/surat_cuti_verifikasi//index.tpl', 498, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
" size="35" readOnly class="text_disabled">
					<?php endif; ?>
             <TR>
                    <TD>No Surat Cuti <font color="#ff0000">*</font></TD>
                    <TD><INPUT TYPE="text"  readonly="" name="cuti__no" size="35" value="<?php echo $this->_tpl_vars['EDIT_T_CUTI__NO']; ?>
"></TD>
             </TR>
            <TR>
                    <TD>Cabang <font color="#ff0000">*</font>
                                                           ...
                                                           <TD><?php if (( $this->_tpl_vars['JENIS_USER_SES'] == 1 )): ?>
                                                               ...
                                                               <select name="kode_cabang" disabled="" onchange="cari_subcab(this.value);"> 
...
">
                             NIP   <INPUT TYPE="text" NAME="karyawan_nip" readonly id="r_pnpt__nip" size="35" value="<?php echo $this->_tpl_vars['EDIT_T_LEMBUR__PEGAWAI_NIP']; ?>
" >
                                
                             <INPUT disabled="" name="ButtonDepartemen" type="button" class="button" style="cursor: hand;" onclick="goCarikaryawan()" value=" ... " />
                            </TD>
                    ...
                    <TR>
                            ...
                            <TD><INPUT TYPE="text" NAME="atasan__nama" readonly  id="r_pegawai__nama2"  size="35" value="<?php echo $this->_tpl_vars['EDIT_T_CUTI__ATASAN_NAMA']; ?>
">
                              NIP  <INPUT TYPE="text" NAME="atasan__nip" readonly id="r_pnpt__nip2" size="35" value="<?php echo $this->_tpl_vars['EDIT_T_CUTI__ATASAN_NIP']; ?>
" >
                                
                                <INPUT disabled="" name="ButtonDepartemen" type="button" class="button" style="cursor: hand;" onclick="goCarikaryawan2()" value=" ... " />
                            </TD>
				...
				<TD>Tanggal Awal Cuti</TD>
                                ...
                                <TD>
                                    ...
                                    <input readonly="" type="text" NAME="tgl_awal"  value="<?php echo $this->_tpl_vars['EDIT_T_CUTI__TGL_AWAL']; ?>
">
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
...
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_awal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
				...
				<TD>Tanggal Akhir Cuti</TD>
                                <TD>              
                                 <?php if ($this->_tpl_vars['EDIT_VAL'] == 0): ?>
							 <input readonly=""  type="text" NAME="tgl_akhir"  value="<?php echo $this->_tpl_vars['EDIT_T_CUTI__TGL__AKHIR']; ?>
">
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
...
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.tgl_akhir,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php endif; ?> 
                        ...
                        <TR>
							...
							<OPTION value="2" <?php if ($this->_tpl_vars['EDIT_T_CUTI__JENIS'] == '2'): ?>selected<?php endif; ?>>Cuti Besar</OPTION>
						</SELECT>
                                </TD>
                        </TR>
					...
					<TD><SELECT name="approval">
							...
							<OPTION value="1" <?php if ($this->_tpl_vars['EDIT_T_CUTI__APPROVAL'] == '1'): ?>selected<?php endif; ?>>Menunggau Konfirmasi</OPTION>
							<OPTION value="2" <?php if ($this->_tpl_vars['EDIT_T_CUTI__APPROVAL'] == '2'): ?>selected<?php endif; ?>> Disetujui BOM</OPTION>  
                                                        <OPTION value="0" <?php if ($this->_tpl_vars['EDIT_T_CUTI__APPROVAL'] == '0'): ?>selected<?php endif; ?>>Tidak Disetujui BOM</OPTION>
						</SELECT>
                                        </TD>
                    </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat"> Verifikasi Pengajuan Cuti </td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0"> Verifikasi Pengajuan Cuti </td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
											...
											<th class="tdatahead" align="left">TGL AWAL CUTI</TH>
                                                                                        <th class="tdatahead" align="left">TGL AHIR CUTI</TH>
											<th class="tdatahead" align="left" >LAMA HARI CUTI</TH>
...
.</TD>
											...
											<TD class="tdatacontent"> <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_cuti__tgl_awal']; ?>
</TD>
											<TD class="tdatacontent"> <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_cuti__tgl_akhir']; ?>
</TD>
											<TD class="tdatacontent"> <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_cuti__lama_hari']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent">                                                                                            
                                                                                             <?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_cuti__approval'] ) == 0): ?>
                                                                                                       Tidak disetujui HRD
                                                                                           <?php elseif (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_cuti__approval'] ) == 1): ?>
