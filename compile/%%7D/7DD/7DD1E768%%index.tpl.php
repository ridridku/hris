<?php /* Smarty version 2.6.18, created on 2017-06-07 09:37:37
         compiled from defaults/modules/master/jabatan/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'defaults/modules/master/jabatan/index.tpl', 255, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
" size="35" readOnly class="text_disabled">
                ...
                <INPUT   TYPE="hidden" name="r_jabatan__id" size="35" value="<?php echo $this->_tpl_vars['EDIT_JABATAN__ID']; ?>
"  >
                <TR>
                    <TD>Jenis Level</TD>
                    <TD>
...
?>
                                            <?php if (trim ( $this->_tpl_vars['DATA_LEVEL'][$this->_sections['x']['index']]['r_level__id'] ) == $this->_tpl_vars['EDIT_JABATAN__LEVEL']): ?>
...
"  > <?php echo $this->_tpl_vars['DATA_LEVEL'][$this->_sections['x']['index']]['r_level__ket']; ?>
                 ...
                 <TR>
                            ...
                            <TD>                          
                                <input  type="text" NAME="nama_jabatan" value="<?php echo $this->_tpl_vars['EDIT_JABATAN__KET']; ?>
" size="35">
                            </TD>
                    </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0">Daftar Master Jabatan</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
                <THEAD>
...
?opt=1&id=<?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_jabatan__id']; ?>
...
" onclick="return checkDelete('engine.php?op=2&id=<?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_jabatan__id']; ?>
 &mod_id=<?php echo $this->_tpl_vars['MOD_ID']; ?>
&<?php echo $this->_tpl_vars['STR_COMPLETER_']; ?>
');" class="imgLink"></TD>
										</TR>
