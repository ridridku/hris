...
/button/blank.gif" align="absmiddle"> <?php echo $this->_tpl_vars['RESET']; ?>
		...
		<tr><td class="tcat">LAPORAN PEGAWAI KELUAR</td></tr>
		</table>
									...
									<TD COLSPAN="2">
										...
										<TR>
											...
											<TH class="tdatahead" align="left">DEPARTEMEN</TH>
                                                                                        ...
                                                                                        <TH class="tdatahead" align="left">TGL RESIGN </TH>
...
.</TD>  
											...
											<TD class="tdatacontent"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_dept__ket']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent" >  <?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_resign__approval'] ) == 1): ?>
                                                                                                  Disetujui
                                                                                                <?php elseif (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_resign__approval'] ) == 'Disetujui'): ?>  
