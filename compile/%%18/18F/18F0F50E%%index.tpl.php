...
" size="35" readOnly class="text_disabled">
                <?php endif; ?>
                <INPUT   TYPE="hidden" name="r_shift__id" size="35" value="<?php echo $this->_tpl_vars['EDIT_R_SHIFT__ID']; ?>
"  >          
                        <TD>Nama Shift<font color="#ff0000">*</font></TD>
                        <TD><INPUT   TYPE="text" name="r_shift__ket" size="35" value="<?php echo $this->_tpl_vars['EDIT_R_SHIFT__KET']; ?>
"  >
                        </TD>
            </TR>
             <TR>
                        <TD>Jam Masuk<font color="#ff0000">*</font></TD>
                        <TD><INPUT    type="time" name="r_shift__jam_masuk" size="35" value="<?php echo $this->_tpl_vars['EDIT_R_SHIFT__JAM_MASUK']; ?>
"  >
                        </TD>
            </TR>
            ...
            <TR>
                        ...
                        <TD><INPUT    type="time" name="r_shift__jam_pulang" size="35" value="<?php echo $this->_tpl_vars['EDIT_R_SHIFT__JAM_PULANG']; ?>
"  >
                        </TD>
            </TR>
            ...
            <TR>
                        ...
                        <TD><INPUT    type="time" name="r_shift__jml_jam" size="35" value="<?php echo $this->_tpl_vars['EDIT_R_SHIFT__JML_JAM']; ?>
"   >
                        </TD>
            </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0">Daftar Data Shihft</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
                <THEAD>   
											...
											<TH class="tdatahead" align="left" >TOTAL JAM KERJA</TH>                                                                                                  								<TH class="tdatahead" COLSPAN="2" ><?php echo $this->_tpl_vars['ACTION']; ?>
</TH>
		</THEAD>		
...
.</TD>
											...
											<TD class="tdatacontent"> <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_shift__jml_jam']; ?>
</TD>                                                                                   
...
?opt=1&id=<?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_shift__id']; ?>
...
" onclick="return checkDelete('engine.php?op=2&id=<?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_shift__id']; ?>
 &mod_id=<?php echo $this->_tpl_vars['MOD_ID']; ?>
&<?php echo $this->_tpl_vars['STR_COMPLETER_']; ?>
');" class="imgLink"></TD>
										</TR>
