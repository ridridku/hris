<?php /* Smarty version 2.6.18, created on 2017-06-02 09:39:13
         compiled from defaults/modules/payroll/closing_payroll/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'defaults/modules/payroll/closing_payroll/index.tpl', 219, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
/icon/details.gif" align="absmiddle">Closing Rekap</span></a>
...
<DIV ID="_menuEntry1_1" style="top:10px;width:100%;display:none;position:absolute;">
		...
		<tr><td class="tcat">Closing Rekap Absen</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/form.gif" align="absmiddle" border="0"> Anda akan closing periode <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AWAL'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
 s/d <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AKHIR'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
 </td></tr>
...
" size="35" readOnly class="text_disabled">
					<?php endif; ?>
                        ...
                        <TR>
				<TD>Periode Aktif Berikutnya<font color="#ff0000">*</font></TD>
                                <TD>:
                                <?php if ($this->_tpl_vars['EDIT_VAL'] == 0): ?>
                                    <input type="text" readonly="" NAME="periode_awal" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['START_NEXT'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
">
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.periode_awal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php else: ?>
                                        <input readonly="" type="text" name="periode_awal" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['START_NEXT'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
" >
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.periode_awal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php endif; ?>
                                ...
                                <TD>: 
                                <?php if ($this->_tpl_vars['EDIT_VAL'] == 0): ?>
                                    <input type="text" readonly="" NAME="periode_akhir" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['END_NEXT'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
">
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.periode_akhir,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php else: ?>
                                        <input readonly="" type="text" name="periode_akhir" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['END_NEXT'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
" >
							 <img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.periode_akhir,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php endif; ?>
...
<!--form_cari--> 			
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" style="border-bottom-width:0px">
		<tr><td class="tcat">Closing Rekap Absensi</td></tr>
		</table>
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center" >
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0"> Periode aktif  Mulai : <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AWAL'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
 s/d <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AKHIR'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
 </td></tr>
		<tr><td class="alt2" style="padding:0px;">
		...
		<tr>
			...
			<tr>
			  <th width="13%" align="left" class="alt2" >
                              ...
                              <?php echo ((is_array($_tmp=$this->_tpl_vars['AWAL_CARI'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>

                            <?php else: ?> 
                            <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AWAL_AKTIF'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>

                                 <?php endif; ?></TH>
                            <th width="13%" align="left" class="alt2" > 
                                <?php if (( $this->_tpl_vars['AWAL_CARI'] ) != ''): ?> 
                              <?php echo ((is_array($_tmp=$this->_tpl_vars['AKHIR_CARI'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>

                            <?php else: ?> 
                            <?php echo ((is_array($_tmp=$this->_tpl_vars['PERIODE_AKHIR_AKTIF'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>

                                 <?php endif; ?></TH>
                            <th width="11%" align="left" class="alt2" ><div align="left"> JML AWAL PEG </div></TH>
                            <th width="11%" align="left" class="alt2" ><div align="left">JML RESIGN </div></TH>
                            <th width="11%" align="left" class="alt2" ><div align="left"> JML AKTIF </div></TH>
...
.</TD>
                        ...
                        <TD align="center"> <?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['rkp_closing'] ) >= 4): ?> <font color="#1117bf"> Closing</font> 
                        <?php else: ?> <font color="#ff0000"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_rkp__awal']; ?>
</font> 
                        <?php endif; ?> </TD>
                        <TD align="center"><?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['rkp_closing'] ) >= 4): ?>  <font color="#1117bf"> Closing</font> 
                        <?php else: ?> <font color="#ff0000"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_rkp__akhir']; ?>
</font> 
                        <?php endif; ?> </TD>
			...
			<TD> <font color="#0c49f2"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['rkp_peg_aktif']; ?>
                        ...
                        <TD align="center"><font color="#f7ba13"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['rkp_hrd']; ?>
</font> </TD>
