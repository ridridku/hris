<?php /* Smarty version 2.6.18, created on 2017-06-07 13:34:15
         compiled from defaults/modules/pelaporan/lap_absen/rekap_absen_harian/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'defaults/modules/pelaporan/lap_absen/rekap_absen_harian/index.tpl', 356, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
.</TD>    
											...
											<TD class="tdatacontent"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_dept__ket']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent" align="left" ><?php echo ((is_array($_tmp=$this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__tgl'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%A,%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%A,%d/%m/%Y")); ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__jam_masuk']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__jam_keluar']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__early']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__lately']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__worktime']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__lesstime']; ?>
</TD>
                                                                                        <TD class="tdatacontent" align="left" ><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_abs__overtime']; ?>
</TD>
										...
										<TD class="tdatahead"   align="center" > <?php echo $this->_tpl_vars['SUM_EARLY']; ?>
</TD>	
                                                                                <TD class="tdatahead"    align="center" ><?php echo $this->_tpl_vars['SUM_LATELY']; ?>
 </TD>
                                                                                <TD class="tdatahead"    align="center" ><?php echo $this->_tpl_vars['SUM_WORKTIME']; ?>
</TD>
                                                                                <TD class="tdatahead"    align="center" ><?php echo $this->_tpl_vars['SUM_LESSTIME']; ?>
 </TD>
                                                                                <TD class="tdatahead"    align="center" ><?php echo $this->_tpl_vars['SUM_OVERTIME']; ?>
 </TD>
										</TR>
									</TABLE></TD> 
