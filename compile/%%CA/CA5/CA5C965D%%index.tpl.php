<?php /* Smarty version 2.6.18, created on 2016-10-20 05:31:04
         compiled from defaults/modules/kehadiran/surat_lembur_verifikasi//index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'defaults/modules/kehadiran/surat_lembur_verifikasi//index.tpl', 490, false),)), $this); ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
...
" size="35" readOnly class="text_disabled">
             ...
             <TR>
                        ...
                        <TD><INPUT TYPE="text" readonly="" name="lembur__no" size="35" value="<?php echo $this->_tpl_vars['EDIT_T_LEMBUR__NO']; ?>
"></TD>
             </TR>
            <TR>
...
/icon/calendar.png"  onclick="displayCalendar(document.frmCreate.lembur_tanggal,'yyyy-mm-dd',this)"  class="imgLink" align="absmiddle" title="Show Calendar List">
					<?php endif; ?>                                    
                        ...
                        <TD>Durasi Jam Lembur  <font color="#ff0000">*</font> </TD>
                            <TD> 
                                <INPUT readonly="" TYPE="text" name="lembur_durasi" value="<?php echo $this->_tpl_vars['EDIT_T_LEMBUR__DURASI']; ?>
" size="10">  
...
" size="10"> 
                     ...
                     <TR>
                                ...
                                <TD><textarea rows="5" cols="20" NAME="lembur_deskripsi"  size="12" readonly=""><?php echo $this->_tpl_vars['EDIT_T_LEMBUR__JOB_DESCRIPTION']; ?>
</textarea></TD>
                    </TR>
                     <TR>
                                <TD>Hasil Evaluasi Atasan <font color="#ff0000">*</font></TD> 
			
                                <TD><textarea rows="5" cols="20" NAME="lembur_evaluasi"  size="12" readonly=""><?php echo $this->_tpl_vars['EDIT_T_LEMBUR__JOB_EVALUASI']; ?>
</textarea></TD>
                    </TR>
					...
					<TD><SELECT name="approval">
							...
							<OPTION value="2" <?php if ($this->_tpl_vars['EDIT_T_LEMBUR__APPROVAL'] == '2'): ?>selected<?php endif; ?>>Disetujui BOM</OPTION>
							<OPTION value="1" <?php if ($this->_tpl_vars['EDIT_T_LEMBUR__APPROVAL'] == '1'): ?>selected<?php endif; ?>>Tidak Disetujui BOM</OPTION>       
						</SELECT>
                                        </TD>
                    </TR>
...
<!--form_cari-->
		...
		<table class="tborder" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
		<tr><td class="thead"><img src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/layout/columns.gif" align="absmiddle" border="0"> Verifikasi Pengajuan Lembur Oleh BOM</td></tr>
		<tr><td class="alt2" style="padding:0px;">
		<table width="100%">
		<tr>
 ...
 Jam</TD>
											<TD class="tdatacontent">Rp. <?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_lembur__total']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent">
                                                                                            <?php if (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_lembur__approval'] ) == 2): ?>
