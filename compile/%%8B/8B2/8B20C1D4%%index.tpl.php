<?php /* Smarty version 2.6.18, created on 2016-10-20 04:02:26
         compiled from defaults/modules/pelaporan/lap_absen/rekap_absen_hglm/index.tpl */ ?>
<HTML>
<HEAD>
<!-- #BeginEditable "TITLE" -->
				 ...
				 <TR>
							...
							<SELECT name="bulan"   > 
								<OPTION VALUE="" selected>[Pilih Bulan]</OPTION>
                                                                <OPTION value="01" <?php if ($this->_tpl_vars['BULAN_SESSION'] == 01): ?>selected<?php endif; ?>>Januari</OPTION>
								<OPTION VALUE="02"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 02): ?>selected<?php endif; ?>  >Februari</OPTION>
								<OPTION VALUE="03"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 03): ?>selected<?php endif; ?>  >Maret</OPTION>
								<OPTION VALUE="04"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 04): ?>selected<?php endif; ?>  >April</OPTION>
								<OPTION VALUE="05"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 05): ?>selected<?php endif; ?> >Mei</OPTION>
								<OPTION VALUE="06"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 06): ?>selected<?php endif; ?>  >Juni</OPTION>
								<OPTION VALUE="07"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 07): ?>selected<?php endif; ?>  >Juli</OPTION>
								<OPTION VALUE="08"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 08): ?>selected<?php endif; ?>  >Agustus</OPTION>
								<OPTION VALUE="09"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 09): ?>selected<?php endif; ?>  >September</OPTION>
								<OPTION VALUE="10"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 10): ?>selected<?php endif; ?>  >Oktober</OPTION>
								<OPTION VALUE="11"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 11): ?>selected<?php endif; ?>  >November</OPTION>
								<OPTION VALUE="12"<?php if ($this->_tpl_vars['BULAN_SESSION'] == 12): ?>selected<?php endif; ?>  >Desember</OPTION>				 
                                                        </SELECT> 	
									...
									<TD COLSPAN="2">
										...
										<TR>
                                                                                    <TH class="tdatahead" align="left">No </TH>
                                                                                        ...
                                                                                        <TH class="tdatahead" align="left">DINAS LUAR</TH>
                                                                                        <TH class="tdatahead" align="left">ALFA</TH>
											...
											<TD class="tdatacontent"><?php echo $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['r_dept__ket']; ?>
                                                                                        ...
                                                                                        <TD class="tdatacontent" >
                                                                                           ...
                                                                                           <?php elseif (( $this->_tpl_vars['DATA_TB'][$this->_sections['x']['index']]['t_rkp__approval'] ) == 2): ?>
                                                                                            ...
                                                                                            <?php else: ?>  
                                                                                                         <font color="green">Telah disetujui HGLM</font>
                                                                                            <?php endif; ?> 
...
?>
										<Td class="tdatahead" colspan="12" align="right" ><b>JML Karyawan : </b></td>	
										<Td class="tdatahead"   align=" " > <?php echo $this->_tpl_vars['DATA_TB4'][$this->_sections['y']['index']]['total_orang']; ?>
 Orang </td>	
		<?php endfor; endif; ?>
												</TR>
									</TABLE></TD> 
