...
/common/header_btm_sip_pjp.jpg); background-repeat:repeat-x; height:25px" align="center"><A HREF="javascript:checkFrame('FrameImg');" TITLE="Show/Hide Header"><img ID="FrameImg" NAME="FrameImg" src="<?php echo $this->_tpl_vars['HREF_IMG_PATH']; ?>
/common/top_arrow_sip_pjp_2.jpg" BORDER="0"></A></div>
</body>
</html>
